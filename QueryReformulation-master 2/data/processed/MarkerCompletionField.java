...
*/
        ...
        protected Object getValue(Object element) {
            return Boolean.valueOf(((MarkerEntry) element).getAttributeValue(IMarker.DONE, false));
        }
    ...
    //$NON-NLS-1$
    static final String COMPLETE_IMAGE_PATH = "$nl$/icons/full/obj16/complete_tsk.png";

    //$NON-NLS-1$
    static final String INCOMPLETE_IMAGE_PATH = "$nl$/icons/full/obj16/incomplete_tsk.png";
...
*/
    private int getDoneConstant(MarkerItem item) {
        int done = UNDEFINED;
        if (item.getMarker() != null && item.getAttributeValue(IMarker.USER_EDITABLE, true)) {
            done = NOT_DONE;
