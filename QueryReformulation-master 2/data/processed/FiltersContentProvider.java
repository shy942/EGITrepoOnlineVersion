...
*/
@Deprecated
class FiltersContentProvider implements /* package */
...
*/
    private static void readFilters() {
        ...
        IExtensionPoint extension = Platform.getExtensionRegistry().getExtensionPoint(IDEWorkbenchPlugin.IDE_WORKBENCH + '.' + ResourcePatternFilter.FILTERS_TAG);
        if (extension != null) {
            ...
            for (int i = 0; i < extensions.length; i++) {
                ...
                for (int j = 0; j < configElements.length; j++) {
                    ...
                    String selected = configElements[j].getAttribute(//$NON-NLS-1$
                    "selected");
