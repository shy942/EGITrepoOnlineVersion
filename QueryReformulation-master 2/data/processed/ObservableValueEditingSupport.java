...
*/
    ...
    protected final void initializeCellEditorValue(CellEditor cellEditor, ViewerCell cell) {
        ...
        Assert.isNotNull(target, //$NON-NLS-1$
        "doCreateCellEditorObservable(...) did not return an observable");
        IObservableValue model = doCreateElementObservable(cell.getElement(), cell);
        Assert.isNotNull(model, //$NON-NLS-1$
        "doCreateElementObservable(...) did not return an observable");
        dirty = false;
