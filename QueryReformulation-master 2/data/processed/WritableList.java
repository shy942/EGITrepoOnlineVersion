...
*/
    ...
    public E set(int index, E element) {
        ...
        fireListChange(Diffs.createListDiff(Diffs.createListDiffEntry(index, false, oldElement), Diffs.createListDiffEntry(index, true, element)));
        return oldElement;
    }
...
*/
    ...
    public E move(int oldIndex, int newIndex) {
        ...
        fireListChange(Diffs.createListDiff(Diffs.createListDiffEntry(oldIndex, false, element), Diffs.createListDiffEntry(newIndex, true, element)));
        return element;
    }
    ...
    public boolean remove(Object o) {
        ...
        fireListChange(Diffs.createListDiff(Diffs.createListDiffEntry(index, false, typedO)));
        return true;
    }
    ...
    public void clear() {
        ...
        List<ListDiffEntry<E>> entries = new ArrayList<ListDiffEntry<E>>(wrappedList.size());
