...
*/
    ...
    public void testCreateWorkingSetFromMemento() throws Throwable {
        IWorkingSet workingSet2 = fWorkingSetManager.createWorkingSet(WORKING_SET_NAME_2, new IAdaptable[] { fWorkspace.getRoot() });
        //$NON-NLS-1$
        IMemento memento = XMLMemento.createWriteRoot("savedState");
    ...
    public void testRecentWorkingSetsLength() throws Throwable {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                IWorkingSet workingSet = fWorkingSetManager.createWorkingSet("ws_" + Integer.toString(i + 1), new IAdaptable[] { fWorkspace.getRoot() });
            ...
            for (int i = 7; i < 9; i++) {
                IWorkingSet workingSet = fWorkingSetManager.createWorkingSet("ws_addded_" + Integer.toString(i + 1), new IAdaptable[] { fWorkspace.getRoot() });
                fWorkingSetManager.addRecentWorkingSet(workingSet);
                fWorkingSetManager.addWorkingSet(workingSet);
    ...
    public void testGetWorkingSets() throws Throwable {
        ...
        // reset the label - it
        workingSet3.setLabel(WORKING_SET_NAME_2);
        ...
        IWorkingSet workingSet3a = fWorkingSetManager.createWorkingSet(WORKING_SET_NAME_2 + "?", new IAdaptable[] { fWorkspace.getRoot() });
        // reset the label - it
        workingSet3.setLabel(WORKING_SET_NAME_2);
    ...
    public void testRemoveWorkingSetAfterRename() throws Throwable {
        ...
        if (!ArrayUtil.equals(new IWorkingSet[] {}, workingSetManager.getWorkingSets())) {
...
*/
    public void testListenerSafety() throws Throwable {
        ...
        try {
            IWorkingSet set = fWorkingSetManager.createWorkingSet("foo", new IAdaptable[0]);
