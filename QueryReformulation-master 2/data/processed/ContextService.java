...
*/
    ...
    public  ContextService(final ContextManager contextManager) {
        if (contextManager == null) {
            ...
            "Cannot create a context service with a null manager");
        }
        ...
        public boolean changed(IEclipseContext context) {
            ...
            try {
                if (updating) {
                    ...
                    if (cached != null && (cached == result || (cached != EvaluationResult.FALSE && result != EvaluationResult.FALSE))) {
                        return updating;
                    }
                ...
                WorkbenchPlugin.log("Failed to update " + contextId, e);
            }
            return updating;
        }
    }
    ...
    @Override
    public final IContextActivation activateContext(final String contextId, final Expression expression) {
    ...
    @Override
    public final IContextActivation activateContext(final String contextId, final Expression expression, final int sourcePriority) {
        return activateContext(contextId, expression);
    }
