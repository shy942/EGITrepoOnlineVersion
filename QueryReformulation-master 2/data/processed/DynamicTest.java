...
*/
    public void testActivityPatternBindings() {
        IActivity first_activity = activityManager.getActivity((String) activityManager.getDefinedActivityIds().toArray()[0]);
        Set initialPatternBindings = first_activity.getActivityPatternBindings();
        // Add pattern binding
        //$NON-NLS-1$
        String pattern = "org\\.eclipse\\.ui\\.myPattern/.*";
        fixedModelRegistry.addActivityPatternBinding(first_activity.getId(), pattern);
        assertFalse(initialPatternBindings.size() == first_activity.getActivityPatternBindings().size());
        // Remove pattern binding
        fixedModelRegistry.removeActivityPatternBinding(pattern);
        assertTrue(initialPatternBindings.size() == first_activity.getActivityPatternBindings().size());
    }
...
*/
    public void testIdentifiersListener() {
        final IIdentifier enabledIdentifier = activityManager.getIdentifier(//$NON-NLS-1$
        "org.eclipse.pattern3");
        ...
        IIdentifier activitiesIdentifier = activityManager.getIdentifier(//$NON-NLS-1$
        "org.eclipse.pattern4");
        //$NON-NLS-1$
        Set identifiedActivities = activitiesIdentifier.getActivityIds();
        assertTrue(identifiedActivities.size() == 1);
        assertTrue(((String) identifiedActivities.toArray()[0]).equals(//$NON-NLS-1$
        "org.eclipse.activity4"));
        ...
        listenerType = 0;
        //$NON-NLS-1$
        copySet.add("org.eclipse.activity3");
        activityManager.setEnabledActivityIds(copySet);
        assertTrue(listenerType == -1);
        // Add pattern binding
        listenerType = 1;
        //$NON-NLS-1$
        fixedModelRegistry.addActivityPatternBinding(//$NON-NLS-1$
        "org.eclipse.activity1", //$NON-NLS-1$ //$NON-NLS-2$
        "org.eclipse.pattern3");
        assertTrue(listenerType == -1);
        // Test correctenesss of identifier
        Set manipulatedIdentifiers = activityManager.getIdentifier(//$NON-NLS-1$
        "org.eclipse.pattern3").getActivityIds();
        assertTrue(manipulatedIdentifiers.size() == 2);
        // Remove pattern binding
        listenerType = 1;
        //$NON-NLS-1$
        fixedModelRegistry.removeActivityPatternBinding("org.eclipse.pattern3");
        assertTrue(listenerType == -1);
        manipulatedIdentifiers = activityManager.getIdentifier(//$NON-NLS-1$
        "org.eclipse.pattern3").getActivityIds();
...
*/
    public void testActivityManagerListener() {
        activityManager.addActivityManagerListener(new IActivityManagerListener() {
        ...
        //$NON-NLS-1$
        enabledSet.add("org.eclipse.activity19");
        activityManager.setEnabledActivityIds(enabledSet);
        assertTrue(listenerType == -1);
        // Remove an enabled activity
        listenerType = 2;
        //$NON-NLS-1$
        enabledSet.remove("org.eclipse.activity19");
        activityManager.setEnabledActivityIds(enabledSet);
        assertTrue(listenerType == -1);
        // Add categroy
        listenerType = 3;
        //$NON-NLS-1$ //$NON-NLS-2$
        fixedModelRegistry.addCategory("org.eclipse.category7", "Category 7");
        assertTrue(listenerType == -1);
        // Remove category
        listenerType = 3;
        //$NON-NLS-1$
        fixedModelRegistry.removeCategory(//$NON-NLS-1$
        "org.eclipse.category7", //$NON-NLS-1$ //$NON-NLS-2$
        "Category 7");
        assertTrue(listenerType == -1);
        // Add activity
        listenerType = 4;
        //$NON-NLS-1$ //$NON-NLS-2$
        fixedModelRegistry.addActivity("org.eclipse.activity19", "Activity 19");
        assertTrue(listenerType == -1);
        // Remove activity
        listenerType = 4;
        //$NON-NLS-1$
        fixedModelRegistry.removeActivity(//$NON-NLS-1$
        "org.eclipse.activity19", //$NON-NLS-1$ //$NON-NLS-2$
        "Activity 19");
        assertTrue(listenerType == -1);
    }
...
*/
    public void testActivityListener() {
        //$NON-NLS-1$
        final String activity_to_listen_name = "Activity 18";
        final IActivity activity_to_listen = activityManager.getActivity(//$NON-NLS-1$
        "org.eclipse.activity18");
        ...
        fixedModelRegistry.removeActivity(activity_to_listen.getId(), activity_to_listen_name);
        assertTrue(listenerType == -1);
        // Add activity
        listenerType = 5;
        fixedModelRegistry.addActivity(activity_to_listen.getId(), activity_to_listen_name);
        assertTrue(listenerType == -1);
        ...
        //$NON-NLS-1$
        fixedModelRegistry.addActivityPatternBinding(//$NON-NLS-1$
        "org.eclipse.activity18", //$NON-NLS-1$ //$NON-NLS-2$
        "org.eclipse.pattern3");
        assertTrue(listenerType == -1);
        // Remove pattern binding
        listenerType = 8;
        ...
        listenerType = 9;
        fixedModelRegistry.addActivityRequirementBinding(//$NON-NLS-1$
        "org.eclipse.activity9", //$NON-NLS-1$
        activity_to_listen.getId());
        assertTrue(listenerType == -1);
        // Remove activity activity binding as parent
        listenerType = 9;
        fixedModelRegistry.removeActivityRequirementBinding("org.eclipse.activity9", //$NON-NLS-1$
        activity_to_listen.getId());
        assertTrue(listenerType == -1);
        //		 Update activity name
        listenerType = 7;
        fixedModelRegistry.updateActivityName(activity_to_listen.getId(), //$NON-NLS-1$
        "name_change");
        assertTrue(listenerType == -1);
        // Update activity description
        listenerType = 10;
        fixedModelRegistry.updateActivityDescription(activity_to_listen.getId(), //$NON-NLS-1$
        "description_change");
        assertTrue(listenerType == -1);
...
*/
    public void testCategoryListener() {
        final ICategory category_to_listen = activityManager.getCategory((String) activityManager.getDefinedCategoryIds().toArray()[0]);
        ...
        try {
            fixedModelRegistry.removeCategory(category_to_listen.getId(), //$NON-NLS-1$
        ...
        // Add category
        listenerType = 5;
        fixedModelRegistry.addCategory(category_to_listen.getId(), //$NON-NLS-1$ //$NON-NLS-2$
        "Category 6");
        assertTrue(listenerType == -1);
        // Add category activity binding
        listenerType = 8;
        fixedModelRegistry.addCategoryActivityBinding((String) activityManager.getDefinedActivityIds().toArray()[4], category_to_listen.getId());
        //$NON-NLS-1$
        assertTrue(listenerType == -1);
        // Remove activity activity binding
        listenerType = 8;
        fixedModelRegistry.removeCategoryActivityBinding((String) activityManager.getDefinedActivityIds().toArray()[4], //$NON-NLS-1$
        category_to_listen.getId());
        // Change category description
        listenerType = 10;
        fixedModelRegistry.updateCategoryDescription(category_to_listen.getId(), //$NON-NLS-1$
        "description_change");
        try {
            assertTrue(category_to_listen.getDescription().equals(//$NON-NLS-1$
            "description_change"));
        } catch (NotDefinedException e) {
            e.printStackTrace(System.err);
        }
        ...
        listenerType = 7;
        fixedModelRegistry.updateCategoryName(category_to_listen.getId(), //$NON-NLS-1$
        "name_change");
        try {
            //$NON-NLS-1$
            assertTrue(category_to_listen.getName().equals("name_change"));
        } catch (NotDefinedException e) {
            e.printStackTrace(System.err);
        }
        assertTrue(listenerType == -1);
...
*/
    public void testDynamicRegistry() {
        ...
        IActivity activity = was.getActivityManager().getActivity("dynamic.activity");
        ICategory category = was.getActivityManager().getCategory("dynamic.category");
        ...
        try {
            String ACTIVITY = "<plugin><extension point=\"org.eclipse.ui.activities\">" + "<category id=\"dynamic.category\" name=\"Dynamic Activity Category\"/>" + "<activity id=\"dynamic.activity\" name=\"Dynamic Activity\"/>" + "<activity id=\"dynamic.parent\" name=\"Dynamic Parent Activity\"/>" + "<activityRequirementBinding requiredActivityId = \"dynamic.parent\" activityId = \"dynamic.activity\" />" + "<categoryActivityBinding categoryId = \"dynamic.category\" activityId = \"dynamic.activity\" />" + "<activityPatternBinding activityId=\"dynamic.activity\"  pattern=\"dynamic.activity/.*\"/>" + "<defaultEnablement id=\"dynamic.activity\"/>" + "</extension></plugin>";
        ...
        while (!(registryChanged[0] && registryChanged[1]) && System.currentTimeMillis() < endTime) {
        ...
        IActivityPatternBinding patternBinding = (IActivityPatternBinding) patternBindings.iterator().next();
        assertEquals("dynamic.activity/.*", patternBinding.getPattern().pattern());
        ...
        IActivityRequirementBinding requirementBinding = (IActivityRequirementBinding) requirementBindings.iterator().next();
        assertEquals("dynamic.parent", requirementBinding.getRequiredActivityId());
        ...
        ICategoryActivityBinding categoryBinding = (ICategoryActivityBinding) categoryBindings.iterator().next();
