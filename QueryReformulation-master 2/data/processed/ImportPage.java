...
public class ImportPage extends ImportExportPage {
    ...
    private static final String STORE_SELECTED_IMPORT_WIZARD_ID = DIALOG_SETTING_SECTION_NAME + //$NON-NLS-1$
    "STORE_SELECTED_IMPORT_WIZARD_ID";

    private static final String STORE_EXPANDED_IMPORT_CATEGORIES = DIALOG_SETTING_SECTION_NAME + //$NON-NLS-1$
    "STORE_EXPANDED_IMPORT_CATEGORIES";
