        ...
        try {
            ...
            for (int i = 0; i < delta.length; i++) {
                ...
                if (delta[i].getKind() == IExtensionDelta.ADDED) {
                    ...
                    } else if (!id.equals(IWorkbenchRegistryConstants.PL_PERSPECTIVES) && !id.equals(IWorkbenchRegistryConstants.PL_VIEWS) && !id.equals(IWorkbenchRegistryConstants.PL_ACTION_SETS)) {
...
*/
    private void loadFontDefinitions(IExtension ext) {
        ...
        ThemeElementHelper.populateRegistry(workbench.getThemeManager().getTheme(IThemeManager.DEFAULT_THEME), fontDefs, PrefUtil.getInternalPreferenceStore());
    }
    ...
    private void resetCurrentPerspective(Display display) {
        ...
        display.asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                if (MessageDialog.openQuestion(parentShell, ExtensionEventHandlerMessages.ExtensionEventHandler_reset_perspective, message.toString())) {
