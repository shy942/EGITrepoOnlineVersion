...
*/
    public void extendLayout(IExtensionTracker extensionTracker, String id, ModeledPageLayout out) {
        ...
        targetID = id;
        pageLayout = out;
        readRegistry(Platform.getExtensionRegistry(), PlatformUI.PLUGIN_ID, IWorkbenchRegistryConstants.PL_PERSPECTIVE_EXTENSIONS);
    }
        ...
        for (int nX = 0; nX < children.length; nX++) {
            ...
            if (includeTag(type)) {
                ...
                if (!result) {
                    ...
                    "Unable to process element: " + type + //$NON-NLS-1$
                    " in perspective extension: " + element.getDeclaringExtension().getUniqueIdentifier());
                }
            }
        }
        return true;
