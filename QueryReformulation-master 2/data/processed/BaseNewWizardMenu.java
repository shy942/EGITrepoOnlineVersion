...
*/
    private IAction getAction(String id) {
        ...
        if (action == null) {
            ...
            if (wizardDesc != null) {
                ...
                if (element != null) {
                    workbenchWindow.getExtensionTracker().registerObject(element.getDeclaringExtension(), action, IExtensionTracker.REF_WEAK);
                }
            }
        }
        return action;
    ...
    protected IContributionItem[] getContributionItems() {
        ...
        if (workbenchWindow != null && workbenchWindow.getActivePage() != null && workbenchWindow.getActivePage().getPerspective() != null) {
            addItems(list);
        } else {
