    ...
    public static void main(String[] args) {
        ...
        Realm.runWithDefault(DisplayRealm.getRealm(display), new Runnable() {
            ...
            public void run() {
                ...
                // observable.
                dbc.bindValue(WidgetProperties.text(SWT.None).observe(ui.formattedName), formattedName, new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), null);
                shell.pack();
                shell.open();
