...
*/
    ...
    public void requestEvaluation(String propertyName) {
        ...
        //$NON-NLS-1$
        String pokeVar = propertyName + ".evaluationServiceLink";
        context.remove(pokeVar);
        //$NON-NLS-1$
        context.set(pokeVar, "link");
        ...
        for (int i = 0; i < listeners.length; i++) {
            ...
            SafeRunner.run(new ISafeRunnable() {
                ...
                public void run() throws Exception {
                    listener.propertyChange(new PropertyChangeEvent(EvaluationService.this, property, oldValue, newValue));
                }
            });
        }
    }
