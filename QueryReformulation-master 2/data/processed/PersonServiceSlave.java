...
public class PersonServiceSlave implements IPersonService, IDisposable {
    ...
    private ListenerList<IPropertyChangeListener> localListeners = new ListenerList(ListenerList.IDENTITY);
    ...
    public void dispose() {
        ...
        for (int i = 0; i < array.length; i++) {
            parentService.removePersonChangeListener((IPropertyChangeListener) array[i]);
        }
        serviceLocator = null;
        parentService = null;
    }
