...
public class SWTDelayedObservableValueDecoratorTest extends AbstractDefaultRealmTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        target = new SWTObservableValueDecorator(new WritableValue(DisplayRealm.getRealm(display)), shell);
        oldValue = new Object();
        newValue = new Object();
    ...
    static class Delegate extends AbstractObservableValueContractDelegate {
        ...
        public IObservableValue createObservableValue(Realm realm) {
            return SWTObservables.observeDelayedValue(0, new SWTObservableValueDecorator(new WritableValue(realm, null, Object.class), shell));
        }
