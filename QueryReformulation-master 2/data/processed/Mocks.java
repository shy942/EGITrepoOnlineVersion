    ...
    private static final class MockInvocationHandler implements InvocationHandler {
        ...
        private class MethodCall {
            ...
            public boolean equals(Object obj) {
                ...
                if (other.method != method || (other.args == null && args != null) || (other.args != null && args == null) || (args != null && other.args.length != args.length)) {
                    return false;
                }
                if (args != null) {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (previousCallHistory != null) {
                ...
                if (indexOfMethodCall != -1) {
                    ...
                    methodCall.setReturnValue(previousCallHistory.get(indexOfMethodCall).getReturnValue());
                } else {
                ...
                if (ordered) {
                    ...
                    MethodCall previousCall = previousCallHistory.get(currentCallHistory.size());
            ...
            if (returnType.isPrimitive() && void.class != returnType) {
                ...
                if (returnType == boolean.class) {
                    ...
                    result = (returnValue != null) ? (Byte) returnValue : new Byte((byte) 0);
                } else if (returnType == char.class) {
                    result = (returnValue != null) ? (Character) returnValue : new Character((char) 0);
                } else if (returnType == short.class) {
                    result = (returnValue != null) ? (Short) returnValue : new Short((short) 0);
                } else if (returnType == int.class) {
                    result = (returnValue != null) ? (Integer) returnValue : Integer.valueOf(0);
                } else if (returnType == long.class) {
                    result = (returnValue != null) ? (Long) returnValue : new Long(0);
                } else if (returnType == float.class) {
                    result = (returnValue != null) ? (Float) returnValue : new Float(0);
                } else if (returnType == double.class) {
                    result = (returnValue != null) ? (Double) returnValue : new Double(0);
                }
                return result;
            }
        ...
        public void verify() {
            ...
            if (ordered) {
                int numMissingCalls = previousCallHistory.size() - currentCallHistory.size();
                if (numMissingCalls > 0) {
                    throw new AssertionFailedError("missing method calls (" + numMissingCalls + ", first is: " + previousCallHistory.get(currentCallHistory.size()) + ")");
                }
                for (int i = 0; i < previousCallHistory.size(); i++) {
                    if (!previousCallHistory.get(i).equals(currentCallHistory.get(i))) {
                        throw new AssertionFailedError("method call did not match (" + i + " of " + currentCallHistory.size() + ")");
                    }
                }
            } else {
        ...
        public void setLastReturnValue(Object object) {
            MethodCall methodCall = currentCallHistory.get(currentCallHistory.size() - 1);
...
*/
    ...
    private static <T> Object createMock(Class<T> interfaceType, boolean ordered, EqualityComparator equalityComparator) {
        ...
        Object newProxyInstance = Proxy.newProxyInstance(Mocks.class.getClassLoader(), new Class[] { interfaceType, Mock.class }, mockInvocationHandler);
