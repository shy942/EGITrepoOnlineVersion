...
*/
    protected void initialize(Layout layout, int progressIndicatorHeight) {
        ...
        if (fHasStopButton) {
            ...
            final Image stopImage = ImageDescriptor.createFromFile(ProgressMonitorPart.class, "images/stop.png").createImage(//$NON-NLS-1$
            getDisplay());
            ...
            fStopButton.setEnabled(false);
            //$NON-NLS-1$
            fStopButton.setToolTipText(JFaceResources.getString("ProgressMonitorPart.cancelToolTip"));
        }
    }
...
*/
    private String taskLabel() {
        ...
        if (hasTask) {
            if (hasSubtask)
                //$NON-NLS-1$
                return escapeMetaCharacters(JFaceResources.format("Set_SubTask", fTaskName, fSubTaskName));
