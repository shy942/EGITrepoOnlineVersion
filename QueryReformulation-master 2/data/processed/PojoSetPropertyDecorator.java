...
*
*/
public class PojoSetPropertyDecorator extends SetProperty implements IBeanSetProperty {
...
*/
    public  PojoSetPropertyDecorator(ISetProperty delegate, PropertyDescriptor propertyDescriptor) {
