...
*/
    private void testMethodName(String methodName) {
        ...
        for (Method method : methods) if (method.getName().equals(methodName))
            return;
        throw new IllegalArgumentException("Target class (" + classType.getName() + ") does not contain method: " + methodName);
    }
...
*/
    public void printToConsole() {
        for (String methodName : methodList) System.out.println(methodName);
    }
}
