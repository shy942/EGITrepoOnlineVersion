...
public class TextSegment extends ParagraphSegment {
    ...
    protected void paint(GC gc, boolean hover, Hashtable<String, Object> resourceTable, boolean selected, boolean rollover, SelectionData selData, Rectangle repaintRegion) {
        Font oldFont = null;
        Color oldColor = null;
        Color oldBg = null;
    ...
    private void paintString(GC gc, String s, int swidth, int x, int y, int lineY, SelectionData selData, Rectangle bounds, boolean hover, boolean rolloverMode, Rectangle repaintRegion) {
    ...
    private void paintStringSegment(GC gc, String s, int swidth, int x, int y, int lineY, boolean hover, boolean rolloverMode, Rectangle repaintRegion) {
    ...
    private void drawUnderline(GC gc, int swidth, int x, int y, boolean hover, boolean rolloverMode) {
            ...
            for (int i = 0; i < textFragments.length; i++) {
                ...
                if ((i != 0 || locator.x > locator.getStartX() + (isSelectable() ? 1 : 0)) && locator.x + lineExtent.x + fragment.length > rightEdge) {
                    ...
                    if (i != 0) {
                        ...
                        Rectangle br = new Rectangle(isSelectable() ? locator.x - 1 : locator.x, ly, isSelectable() ? lineExtent.x + 1 : lineExtent.x, lineHeight - descent + 3);
