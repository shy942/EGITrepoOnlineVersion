...
*/
    protected void setContentAndLabelProviders(TreeViewer treeViewer) {
        ...
        IContributionService cs = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getService(IContributionService.class);
    ...
    protected void okPressed() {
        ...
        if (workingCopyManager != null) {
            try {
                ...
                StatusUtil.handleStatus(WorkbenchMessages.PreferencesExportDialog_ErrorDialogTitle + ": " + msg, e, StatusManager.SHOW, getShell());
            }
        }
        // Run the update jobs
...
*/
    Control getContainerToolBar(Composite composite) {
        ...
        showViewHandler = service.activateHandler(IWorkbenchCommandConstants.WINDOW_SHOW_VIEW_MENU, new ActionHandler(popupMenuAction), new ActiveShellExpression(getShell()));
