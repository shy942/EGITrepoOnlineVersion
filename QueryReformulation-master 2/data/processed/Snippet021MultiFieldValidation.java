...
*/
    ...
    private void bindEvensAndOddsGroup(DataBindingContext dbc) {
        ...
        IObservableValue modelField1 = new WritableValue(Integer.valueOf(1), Integer.TYPE);
        IObservableValue modelField2 = new WritableValue(Integer.valueOf(4), Integer.TYPE);
    ...
    private void bindSumAndAddendsGroup(DataBindingContext dbc) {
        ...
        addAddendButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                InputDialog dialog = new InputDialog(getShell(), "Input addend", "Enter an integer addend", "0", new IInputValidator() {
        ...
        IObservableValue modelSum = new WritableValue(Integer.valueOf(5), Integer.TYPE);
