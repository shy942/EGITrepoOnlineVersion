...
*/
    ...
    protected void createRightPanel(Composite parent) {
        ...
        textArea = new StyledText(composite, SWT.MULTI | SWT.V_SCROLL | SWT.BORDER);
        ...
        selectedCSSPropertyNameText = new Text(group, SWT.BORDER | SWT.READ_ONLY);
        selectedCSSPropertyNameText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
        label = new Label(group, SWT.NONE);
        label.setText("CSS Property value");
        selectedCSSPropertyValueText = new Text(group, SWT.BORDER);
        selectedCSSPropertyValueText.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
        ...
        b.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (newColor != null) {
                    try {
                        cssValue = engine.convert(newColor, RGB.class, selectedCSSPropertyNameText.getText());
                        if (cssValue == null)
                            return;
        ...
        b2.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                try {
                    ...
                    CSS2FontProperties fontProperties = CSS2FontPropertiesHelpers.createCSS2FontProperties(cssValue, propertyName);
                    FontData fontData = (FontData) engine.convert(fontProperties, FontData.class, display);
                    if (fontData != null) {
                ...
                if (newFontData != null) {
                    try {
                        String cssValue = engine.convert(newFontData, FontData.class, selectedCSSPropertyNameText.getText());
                        if (cssValue == null)
                            return;
                        selectedCSSPropertyValueText.setText(cssValue);
                        String property = selectedCSSPropertyNameText.getText();
        ...
        applyStyleWhenTextAreaChangeCheckbox.setText("Apply style when textarea change");
