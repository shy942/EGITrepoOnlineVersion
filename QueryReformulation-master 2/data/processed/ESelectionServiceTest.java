...
public class ESelectionServiceTest extends UITest {
    ...
    public void testGetSelection_Id() {
        ...
        serviceA.setSelection(selection1);
        //$NON-NLS-1$
        assertEquals(selection1, windowService.getSelection("partA"));
        //$NON-NLS-1$
        assertEquals(selection1, serviceA.getSelection("partA"));
        //$NON-NLS-1$
        assertEquals(selection1, serviceB.getSelection("partA"));
        //$NON-NLS-1$
        assertNull(windowService.getSelection("partB"));
        //$NON-NLS-1$
        assertNull(serviceA.getSelection("partB"));
        //$NON-NLS-1$
        assertNull(serviceB.getSelection("partB"));
        serviceB.setSelection(selection2);
        //$NON-NLS-1$
        assertEquals(selection1, windowService.getSelection("partA"));
        //$NON-NLS-1$
        ...
        assertEquals(selection1, serviceB.getSelection("partA"));
        //$NON-NLS-1$
        assertEquals(selection2, windowService.getSelection("partB"));
        //$NON-NLS-1$
        assertEquals(selection2, serviceA.getSelection("partB"));
        //$NON-NLS-1$
        assertEquals(selection2, serviceB.getSelection("partB"));
    }
    ...
    public void testSelectionListener_Id() {
        ...
        SelectionListener listener = new SelectionListener();
        //$NON-NLS-1$
        windowService.addSelectionListener("partB", listener);
        serviceA.setSelection(selectionA);
        assertNull(listener.getPart());
        assertNull(listener.getSelection());
        listener.reset();
        ...
        listener.reset();
        //$NON-NLS-1$
        windowService.removeSelectionListener("partB", listener);
    ...
    public void testSelectionListener_Id3() {
        ...
        SelectionListener listener = new SelectionListener();
        //$NON-NLS-1$
        windowService.addSelectionListener("partC", listener);
        //$NON-NLS-1$
        partService.showPart("partC", PartState.CREATE);
        assertNull(listener.getPart());
        assertNull(listener.getSelection());
    ...
    public void testBug343003() {
        ...
        SelectionListener listener = new SelectionListener();
        //$NON-NLS-1$
        selectionServiceA.addSelectionListener("partB", listener);
        MPart partB = ems.createModelElement(MPart.class);
        partB.setElementId("partB");
