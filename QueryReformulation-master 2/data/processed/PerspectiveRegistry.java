...
public class PerspectiveRegistry implements IPerspectiveRegistry, IExtensionChangeHandler {
    ...
    void postConstruct(MApplication application) {
        //$NON-NLS-1$
        IExtensionPoint point = extensionRegistry.getExtensionPoint("org.eclipse.ui.perspectives");
    ...
    private void createDescriptor(MPerspective perspective) {
        ...
        if (perspective.getIconURI() != null) {
            try {
                ...
                logger.warn(e, MessageFormat.format("Error on applying configured perspective icon: {0}", perspective.getIconURI()));
            }
        }
...
*/
    ...
    public String getDefaultPerspective() {
        String defaultId = PrefUtil.getAPIPreferenceStore().getString(IWorkbenchPreferenceConstants.DEFAULT_PERSPECTIVE_ID);
        // found
