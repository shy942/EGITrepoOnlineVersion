...
*/
        ...
        if (detailValue == null) {
            ...
            detailValue.addValueChangeListener(new IValueChangeListener<E>() {
                ...
                public void handleValueChange(ValueChangeEvent<? extends E> event) {
                    ...
                    fireMapChange(Diffs.createMapDiffSingleChange(addedKey, event.diff.getOldValue(), event.diff.getNewValue()));
                }
            });
    ...
    public boolean isStale() {
        return super.isStale() || (masterMap != null && masterMap.isStale()) || (staleDetailObservables != null && !staleDetailObservables.isEmpty());
    }
