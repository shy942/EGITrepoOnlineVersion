...
public class Snippet061FakedNativeCellEditor {
    ...
    private final class MyEditingSupport extends EditingSupport {
        ...
        private  MyEditingSupport(ColumnViewer viewer, TextCellEditor textCellEditor, TreeViewer viewer2) {
            super(viewer);
    ...
    public  Snippet061FakedNativeCellEditor(final Shell shell) {
        ...
        int features = ColumnViewerEditor.TABBING_HORIZONTAL | ColumnViewerEditor.TABBING_MOVE_TO_ROW_NEIGHBOR | ColumnViewerEditor.TABBING_VERTICAL | ColumnViewerEditor.KEYBOARD_ACTIVATION;
