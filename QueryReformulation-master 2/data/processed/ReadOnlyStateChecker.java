...
*/
    public IResource[] checkReadOnlyResources(IResource[] itemsToCheck) {
        ...
        try {
            ...
            shell.getDisplay().syncExec(() -> ErrorDialog.openError(shell, READ_ONLY_EXCEPTION_MESSAGE, null, exception.getStatus()));
        }
...
*/
    private int queryYesToAllNoCancel(IResource resource) {
        final MessageDialog dialog = new MessageDialog(this.shell, this.titleMessage, null, MessageFormat.format(this.mainMessage, new Object[] { resource.getName() }), MessageDialog.QUESTION, 0, IDialogConstants.YES_LABEL, IDialogConstants.YES_TO_ALL_LABEL, IDialogConstants.NO_LABEL, IDialogConstants.CANCEL_LABEL) {
