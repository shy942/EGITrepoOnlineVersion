...
*/
    ...
    public int compare(MarkerItem item1, MarkerItem item2) {
        ...
        String location1 = item1.getAttributeValue(IMarker.LOCATION, MarkerSupportInternalUtilities.EMPTY_STRING);
        String location2 = item2.getAttributeValue(IMarker.LOCATION, MarkerSupportInternalUtilities.EMPTY_STRING);
        if (location1.length() == 0 || location2.length() == 0)
            return item1.getAttributeValue(IMarker.LINE_NUMBER, -1) - item2.getAttributeValue(IMarker.LINE_NUMBER, -1);
