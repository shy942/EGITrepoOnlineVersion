    ...
    public IIntroPart showIntro(IWorkbenchWindow preferredWindow, boolean standby) {
        ...
        if (viewPart == null) {
            ...
            try {
                ...
                WorkbenchPlugin.log("Could not open intro", new Status(IStatus.ERROR, WorkbenchPlugin.PI_WORKBENCH, IStatus.ERROR, "Could not open intro", e));
            }
        }
...
*/
    private void createIntro(IWorkbenchWindow preferredWindow) {
        ...
        try {
            ...
            WorkbenchPlugin.log(IntroMessages.Intro_could_not_create_part, new Status(IStatus.ERROR, WorkbenchPlugin.PI_WORKBENCH, IStatus.ERROR, IntroMessages.Intro_could_not_create_part, e));
        }
    }
...
*/
    ...
    public boolean isNewContentAvailable() {
        ...
        try {
            ...
            WorkbenchPlugin.log(new Status(IStatus.WARNING, WorkbenchPlugin.PI_WORKBENCH, IStatus.WARNING, "Could not load intro content detector", ex));
        }
        return false;
    }
}
