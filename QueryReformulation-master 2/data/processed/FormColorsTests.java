...
public class FormColorsTests extends TestCase {
    ...
    private static String[] KEYS_NON_NULL = { IFormColors.BORDER, IFormColors.H_BOTTOM_KEYLINE1, IFormColors.H_BOTTOM_KEYLINE2, IFormColors.H_GRADIENT_END, IFormColors.H_GRADIENT_START, IFormColors.H_HOVER_FULL, IFormColors.H_HOVER_LIGHT, IFormColors.SEPARATOR, IFormColors.TB_BG, IFormColors.TB_BORDER, IFormColors.TB_TOGGLE, IFormColors.TB_TOGGLE_HOVER };

    // these keys may return null
    private static String[] KEYS_NULL = { IFormColors.TB_FG };
    ...
    public void testStandalone() {
        ...
        for (int i = 0; i < KEYS_NON_NULL.length; i++) colors[i] = fColors.getColor(KEYS_NON_NULL[i]);
        Color[] nullColors = new Color[KEYS_NULL.length];
        for (int i = 0; i < KEYS_NULL.length; i++) nullColors[i] = fColors.getColor(KEYS_NULL[i]);
        ...
        for (int i = 0; i < KEYS_NON_NULL.length; i++) assertEquals("FormColors did not return the same instance for key: " + KEYS_NON_NULL[i], colors[i], fColors.getColor(KEYS_NON_NULL[i]));
        for (int i = 0; i < KEYS_NULL.length; i++) assertEquals("FormColors did not return the same instance for key: " + KEYS_NULL[i], nullColors[i], fColors.getColor(KEYS_NULL[i]));
        ...
        fColors.dispose();
        for (int i = 0; i < KEYS_NON_NULL.length; i++) Assert.assertTrue("FormColors did not dispose key: " + KEYS_NON_NULL[i], colors[i].isDisposed());
        for (int i = 0; i < KEYS_NULL.length; i++) Assert.assertTrue("FormColors did not dispose key: " + KEYS_NULL[i], nullColors[i] == null || nullColors[i].isDisposed());
    ...
    public void testMultiple() {
        ...
        for (int i = 0; i < KEYS_NON_NULL.length; i++) colors2[i] = fColors2.getColor(KEYS_NON_NULL[i]);
        Color[] nullColors2 = new Color[KEYS_NULL.length];
        for (int i = 0; i < KEYS_NULL.length; i++) nullColors2[i] = fColors2.getColor(KEYS_NULL[i]);
        ...
        for (int i = 0; i < KEYS_NON_NULL.length; i++) Assert.assertEquals("Different concurrent instances of FormColors did not return the same Color for key: " + KEYS_NON_NULL[i], colors[i], colors2[i]);
        for (int i = 0; i < KEYS_NULL.length; i++) Assert.assertEquals("Different concurrent instances of FormColors did not return the same Color for key: " + KEYS_NULL[i], nullColors[i], nullColors2[i]);
        ...
        fColors2.dispose();
        for (int i = 0; i < KEYS_NON_NULL.length; i++) Assert.assertFalse("FormColors disposed different instance's key: " + KEYS_NON_NULL[i], colors[i].isDisposed());
        for (int i = 0; i < KEYS_NULL.length; i++) Assert.assertFalse("FormColors disposed different instance's key: " + KEYS_NULL[i], nullColors[i] != null && nullColors[i].isDisposed());
    ...
    public void testShared() {
        ...
        Color[] colors = new Color[KEYS_NON_NULL.length];
        for (int i = 0; i < KEYS_NON_NULL.length; i++) colors[i] = tk.getColors().getColor(KEYS_NON_NULL[i]);
        Color[] nullColors = new Color[KEYS_NULL.length];
        for (int i = 0; i < KEYS_NULL.length; i++) nullColors[i] = tk.getColors().getColor(KEYS_NULL[i]);
        ...
        Color[] colors2 = new Color[KEYS_NON_NULL.length];
        for (int i = 0; i < KEYS_NON_NULL.length; i++) colors2[i] = tk2.getColors().getColor(KEYS_NON_NULL[i]);
        Color[] nullColors2 = new Color[KEYS_NULL.length];
        for (int i = 0; i < KEYS_NULL.length; i++) nullColors2[i] = tk2.getColors().getColor(KEYS_NULL[i]);
        boolean testBorderDispose = !bc.equals(fColors.getColor(IFormColors.BORDER));
        tk2.dispose();
        for (int i = 0; i < KEYS_NON_NULL.length; i++) Assert.assertFalse("FormToolkit disposed shared FormColor's key: " + KEYS_NON_NULL[i], colors[i].isDisposed());
        for (int i = 0; i < KEYS_NULL.length; i++) Assert.assertFalse("FormToolkit disposed shared FormColor's key: " + KEYS_NULL[i], nullColors[i] != null && nullColors[i].isDisposed());
        ...
        tk.dispose();
        for (int i = 0; i < KEYS_NON_NULL.length; i++) Assert.assertFalse("Last FormToolkit disposed shared FormColor's key: " + KEYS_NON_NULL[i], colors[i].isDisposed());
        for (int i = 0; i < KEYS_NULL.length; i++) Assert.assertFalse("Last FormToolkit disposed shared FormColor's key: " + KEYS_NULL[i], nullColors[i] != null && nullColors[i].isDisposed());
