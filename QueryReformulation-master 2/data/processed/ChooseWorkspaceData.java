...
*/
    public String getInitialDefault() {
        if (initialDefault == null) {
            setInitialDefault(//$NON-NLS-1$
            System.getProperty("user.dir") + File.separator + //$NON-NLS-1$
            "workspace");
        }
...
*/
    public void writePersistedData() {
        ...
        node.putInt(IDE.Preferences.MAX_RECENT_WORKSPACES, recentWorkspaces.length);
...
*/
    private boolean readPersistedData_file() {
        ...
        try {
            ...
            showDialog = alwaysAskTag == null ? true : alwaysAskTag.getInteger(XML.SHOW_DIALOG).intValue() == 1;
...
*/
    public boolean readPersistedData() {
        IPreferenceStore store = new ScopedPreferenceStore(ConfigurationScope.INSTANCE, IDEWorkbenchPlugin.IDE_WORKBENCH);
