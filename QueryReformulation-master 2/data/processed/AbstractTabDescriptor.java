...
*/
    public Object clone() {
        try {
            ...
            IStatus status = new Status(IStatus.ERROR, TabbedPropertyViewPlugin.getPlugin().getBundle().getSymbolicName(), 666, exception.getMessage(), exception);
...
*/
    public TabContents createTab() {
        ...
        tab.setSections((ISection[]) sections.toArray(new ISection[sections.size()]));
        return tab;
    }
