...
public class EmailAddress implements IPropertySource {
    ...
    private static final String USERID_DEFAULT = MessageUtil.getString(//$NON-NLS-1$
    "unknownUser");

    private static final String DOMAIN_DEFAULT = MessageUtil.getString(//$NON-NLS-1$
    "unknownDomain");
...
*/
    private void setEmailAddress(String emailAddress) throws IllegalArgumentException {
        if (emailAddress == null)
            throw new IllegalArgumentException(MessageUtil.getString(//$NON-NLS-1$
            "emailaddress_cannot_be_set_to_null"));
        ...
        throw new IllegalArgumentException(MessageUtil.getString(//$NON-NLS-1$
        "invalid_email_address_format_should_have_been_validated"));
    }
