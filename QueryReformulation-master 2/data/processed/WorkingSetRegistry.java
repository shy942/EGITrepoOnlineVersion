...
public class WorkingSetRegistry implements IExtensionChangeHandler {
    ...
    private HashMap /*<String, WorkingSetDescriptor>*/
    workingSetDescriptors = new HashMap();
...
*/
    public void addWorkingSetDescriptor(WorkingSetDescriptor descriptor) {
        Assert.isTrue(!workingSetDescriptors.containsValue(descriptor), //$NON-NLS-1$
        "working set descriptor already registered");
        IExtensionTracker tracker = PlatformUI.getWorkbench().getExtensionTracker();
        tracker.registerObject(descriptor.getConfigurationElement().getDeclaringExtension(), descriptor, IExtensionTracker.REF_WEAK);
