...
*/
    public void testColorProviderForeground() {
        ...
        fViewer.refresh();
        //$NON-NLS-1$
        assertEquals("foreground 1 green", viewer.getTable().getItem(0).getForeground(0), green);
        //$NON-NLS-1$
        assertEquals("foreground 2 green", viewer.getTable().getItem(0).getForeground(1), green);
...
*/
    public void testColorProviderBackground() {
        ...
        fViewer.refresh();
        //$NON-NLS-1$
        assertEquals("background 1 red", viewer.getTable().getItem(0).getBackground(0), red);
        //$NON-NLS-1$
        assertEquals("background 2 red", viewer.getTable().getItem(1).getBackground(1), red);
        provider.fExtended = false;
    }
...
*/
    public void testTableItemsColorProviderForeground() {
        ...
        fViewer.refresh();
        //$NON-NLS-1$
        assertEquals("table item 1 green", table.getItem(0).getForeground(0), green);
        //$NON-NLS-1$
        assertEquals("table item 2 red", table.getItem(0).getForeground(1), red);
        provider.fExtended = false;
    }
...
*/
    public void testTableItemsColorProviderBackground() {
        ...
        fViewer.refresh();
        //$NON-NLS-1$
        assertEquals("table item 1 background red", table.getItem(0).getBackground(0), red);
        //$NON-NLS-1$
        assertEquals("table item 2 background green", table.getItem(0).getBackground(1), green);
        provider.fExtended = false;
    }
