...
public class ZoomAndPreferencesFontTest {
    ...
    public static void createFilesAndOpenEditor() throws Exception {
        ...
        // $NON-NLS-1$
        file = project.getFile(ZoomAndPreferencesFontTest.class.getSimpleName() + ".txt");
    ...
    public void testThemeAPIvsPreferences() {
        // Whatever > 0 and not default size/10
        int targetHeight = 17;
        FontRegistry registry = editor.getSite().getWorkbenchWindow().getWorkbench().getThemeManager().getCurrentTheme().getFontRegistry();
    ...
    public void testZoomCommand() throws Exception {
        ...
        command = PlatformUI.getWorkbench().getService(ICommandService.class).getCommand("org.eclipse.ui.edit.text.zoomIn");
