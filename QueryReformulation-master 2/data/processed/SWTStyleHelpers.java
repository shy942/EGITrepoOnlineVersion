    ...
    public static String getSWTWidgetStyleAsString(int style, String separator) {
        ...
        try {
            if ((style & SWT.ERROR_MENU_NOT_DROP_DOWN) != 0)
                addSWTStyle(swtStyles, "SWT.ERROR_MENU_NOT_DROP_DOWN", separator);
        } catch (Exception e) {
        }
        try {
            if ((style & SWT.ERROR_MENUITEM_NOT_CASCADE) != 0)
                addSWTStyle(swtStyles, "SWT.ERROR_MENUITEM_NOT_CASCADE", separator);
        } catch (Exception e) {
        }
        try {
...
* @param separator
*/
    private static void addSWTStyle(StringBuffer swtStyles, String style, String separator) {
