...
*/
        ...
        if (handlerListeners != null) {
            ...
            if (attributesChanged) {
                ...
                if (handlerEvent.isEnabledChanged()) {
                    ...
                    previousAttributes.put("enabled", //$NON-NLS-1$
                    disabled);
                }
            ...
            final org.eclipse.ui.commands.HandlerEvent legacyEvent = new org.eclipse.ui.commands.HandlerEvent(this, attributesChanged, previousAttributes);
            for (int i = 0; i < handlerListeners.size(); i++) {
                ((org.eclipse.ui.commands.IHandlerListener) handlerListeners.get(i)).handlerChanged(legacyEvent);
            }
        }
    }
    ...
    protected void fireHandlerChanged(final org.eclipse.ui.commands.HandlerEvent handlerEvent) {
        ...
        if (handlerListeners != null) {
            for (int i = 0; i < handlerListeners.size(); i++) {
                ((org.eclipse.ui.commands.IHandlerListener) handlerListeners.get(i)).handlerChanged(handlerEvent);
            }
        }
...
*/
    ...
    public boolean isEnabled() {
        //$NON-NLS-1$
        final Object handled = getAttributeValuesByName().get("enabled");
