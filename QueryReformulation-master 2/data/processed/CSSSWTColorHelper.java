...
*/
    ...
    public static RGBA getRGBA(RGBColor color) {
        return new RGBA((int) color.getRed().getFloatValue(CSSPrimitiveValue.CSS_NUMBER), (int) color.getGreen().getFloatValue(CSSPrimitiveValue.CSS_NUMBER), (int) color.getBlue().getFloatValue(CSSPrimitiveValue.CSS_NUMBER), // as of now does not have an element for RGBAColor.
        255);
    }
