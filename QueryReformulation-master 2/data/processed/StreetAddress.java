...
public class StreetAddress implements IPropertySource {
    ...
    private static final String APTBOX_DEFAULT = MessageUtil.getString(//$NON-NLS-1$
    "unspecified");

    private static final String STREETNAME_DEFAULT = MessageUtil.getString(//$NON-NLS-1$
    "unspecified");
    ...
    public static final String P_BUILD_NO = MessageUtil.getString(//$NON-NLS-1$
    "building_number");

    public static final String P_APTBOX = MessageUtil.getString(//$NON-NLS-1$
    "apt.no_or_box.no");
