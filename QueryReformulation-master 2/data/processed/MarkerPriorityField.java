...
*/
        public  PriorityEditingSupport(ColumnViewer viewer) {
            super(viewer);
            this.editor = new ComboBoxCellEditor((Composite) viewer.getControl(), priorities, SWT.READ_ONLY);
        }

        @Override
        protected boolean canEdit(Object element) {
            if (element instanceof MarkerEntry)
                return ((MarkerEntry) element).getAttributeValue(IMarker.USER_EDITABLE, false);
            return false;
        }
        ...
        protected void setValue(Object element, Object value) {
            ...
            try {
                entry.getMarker().setAttribute(IMarker.PRIORITY, integerValue.intValue());
...
*/
    ...
    public int compare(MarkerItem item1, MarkerItem item2) {
        return item2.getAttributeValue(IMarker.PRIORITY, IMarker.PRIORITY_NORMAL) - item1.getAttributeValue(IMarker.PRIORITY, IMarker.PRIORITY_NORMAL);
    }
        ...
        try {
            switch(((MarkerItem) cell.getElement()).getAttributeValue(IMarker.PRIORITY, IMarker.PRIORITY_NORMAL)) {
                ...
                case IMarker.PRIORITY_LOW:
                    cell.setImage(MarkerSupportInternalUtilities.createImage(LOW_PRIORITY_IMAGE_PATH, getImageManager()));
                    break;
                default:
                    break;
            }
