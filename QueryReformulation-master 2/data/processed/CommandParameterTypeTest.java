...
*/
    private void testSubtract(Object minuend, Object subtrahend, int difference) throws CommandException {
        ...
        String minuendStr = command.getParameterType(MINUEND).getValueConverter().convertToString(minuend);
        String subtrahendStr = command.getParameterType(SUBTRAHEND).getValueConverter().convertToString(subtrahend);
        // setup the parameterizations
        Parameterization minuendParam = new Parameterization(command.getParameter(MINUEND), minuendStr);
        Parameterization subtrahendParam = new Parameterization(command.getParameter(SUBTRAHEND), subtrahendStr);
        Parameterization[] parameterizations = new Parameterization[] { minuendParam, subtrahendParam };
...
*/
    ...
    private void testConvertStringToInteger(String value, int expected, boolean expectFail) throws CommandException {
        ICommandService commandService = getCommandService();
...
*/
    public void testFindIntegerParamCommand() throws CommandException {
        ...
        for (Command command2 : commands) {
            ...
            if (checkParamType1(command, parameters[0], value) && checkParamType2(parameters[0], value)) {
    ...
    private boolean checkParamType1(Command command, IParameter parameter, Object value) throws CommandException {
    ...
    private boolean checkParamType2(IParameter parameter, Object value) throws CommandException {
