...
*/
    ...
    private void bindUI() {
        ...
        final IObservableValue timeSelection = WidgetProperties.selection().observe(time);
        dbc.bindValue(new DateAndTimeObservableValue(WidgetProperties.selection().observe(date), timeSelection), model);
        dbc.bindValue(new DateAndTimeObservableValue(WidgetProperties.selection().observe(calendar), timeSelection), model);
