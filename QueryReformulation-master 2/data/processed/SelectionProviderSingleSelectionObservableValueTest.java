...
public class SelectionProviderSingleSelectionObservableValueTest extends TestCase {
    ...
    public void testSetValue() {
        IObservableValue observable = ViewersObservables.observeSingleSelection(selectionProvider);
...
*/
    private void doTestSelectionChangesTracked(boolean postSelection) {
        ...
        if (postSelection) {
            observable = ViewersObservables.observeSinglePostSelection(selectionProvider);
        } else {
            observable = ViewersObservables.observeSingleSelection(selectionProvider);
        }
        ValueChangeEventTracker listener = ValueChangeEventTracker.observe(observable);
        assertNull(observable.getValue());
