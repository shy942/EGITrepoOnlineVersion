    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == MCommand.class) {
            switch(derivedFeatureID) {
                ...
                case MTestPackage.TEST_HARNESS__CATEGORY:
                    return CommandsPackageImpl.COMMAND__CATEGORY;
                case MTestPackage.TEST_HARNESS__LOCALIZED_COMMAND_NAME:
                    return CommandsPackageImpl.COMMAND__LOCALIZED_COMMAND_NAME;
                case MTestPackage.TEST_HARNESS__LOCALIZED_DESCRIPTION:
                    return CommandsPackageImpl.COMMAND__LOCALIZED_DESCRIPTION;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MUIElement.class) {
            switch(derivedFeatureID) {
                ...
                case MTestPackage.TEST_HARNESS__CUR_SHARED_REF:
                    return UiPackageImpl.UI_ELEMENT__CUR_SHARED_REF;
                case MTestPackage.TEST_HARNESS__VISIBLE_WHEN:
                    return UiPackageImpl.UI_ELEMENT__VISIBLE_WHEN;
                case MTestPackage.TEST_HARNESS__ACCESSIBILITY_PHRASE:
                    return UiPackageImpl.UI_ELEMENT__ACCESSIBILITY_PHRASE;
                case MTestPackage.TEST_HARNESS__LOCALIZED_ACCESSIBILITY_PHRASE:
                    return UiPackageImpl.UI_ELEMENT__LOCALIZED_ACCESSIBILITY_PHRASE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MCommand.class) {
            switch(baseFeatureID) {
                ...
                case CommandsPackageImpl.COMMAND__CATEGORY:
                    return MTestPackage.TEST_HARNESS__CATEGORY;
                case CommandsPackageImpl.COMMAND__LOCALIZED_COMMAND_NAME:
                    return MTestPackage.TEST_HARNESS__LOCALIZED_COMMAND_NAME;
                case CommandsPackageImpl.COMMAND__LOCALIZED_DESCRIPTION:
                    return MTestPackage.TEST_HARNESS__LOCALIZED_DESCRIPTION;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MUIElement.class) {
            switch(baseFeatureID) {
                ...
                case UiPackageImpl.UI_ELEMENT__CUR_SHARED_REF:
                    return MTestPackage.TEST_HARNESS__CUR_SHARED_REF;
                case UiPackageImpl.UI_ELEMENT__VISIBLE_WHEN:
                    return MTestPackage.TEST_HARNESS__VISIBLE_WHEN;
                case UiPackageImpl.UI_ELEMENT__ACCESSIBILITY_PHRASE:
                    return MTestPackage.TEST_HARNESS__ACCESSIBILITY_PHRASE;
                case UiPackageImpl.UI_ELEMENT__LOCALIZED_ACCESSIBILITY_PHRASE:
                    return MTestPackage.TEST_HARNESS__LOCALIZED_ACCESSIBILITY_PHRASE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MUILabel.class) {
            switch(baseFeatureID) {
                ...
                case UiPackageImpl.UI_LABEL__LOCALIZED_LABEL:
                    return MTestPackage.TEST_HARNESS__LOCALIZED_LABEL;
                case UiPackageImpl.UI_LABEL__LOCALIZED_TOOLTIP:
                    return MTestPackage.TEST_HARNESS__LOCALIZED_TOOLTIP;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSnippetContainer.class) {
            switch(baseFeatureID) {
                case UiPackageImpl.SNIPPET_CONTAINER__SNIPPETS:
                    return MTestPackage.TEST_HARNESS__SNIPPETS;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MLocalizable.class) {
            switch(baseOperationID) {
                case UiPackageImpl.LOCALIZABLE___UPDATE_LOCALIZATION:
                    return MTestPackage.TEST_HARNESS___UPDATE_LOCALIZATION;
                default:
                    return -1;
            }
        }
