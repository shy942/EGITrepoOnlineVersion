...
public class FilterHandlerTests {
    ...
    private static final String FILTER_TRACES = "org.eclipse.ui.internal.monitoring.FilterHandlerTests.createFilteredStackSamples" + ",org.eclipse.ui.internal.monitoring.SomeClass.someMethod" + ",org.eclipse.ui.internal.monitoring.OtherClass.otherMethod";
    ...
    private StackSample[] createStackSamples() throws Exception {
        ...
        ThreadInfo threadInfo = jvmThreadManager.getThreadInfo(Thread.currentThread().getId(), Integer.MAX_VALUE);
