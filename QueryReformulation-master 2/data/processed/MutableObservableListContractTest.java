...
*/
    ...
    public void testAdd_ListDiffEntry() throws Exception {
        ...
        }, "List.add(Object)", list, Arrays.asList(new Object[] { element0, element1 }));
    }
    ...
    public void testAddAtIndex_ListDiffEntry() throws Exception {
        ...
        }, "List.add(int, Object)", list, Arrays.asList(new Object[] { element0, element1 }));
    }
    ...
    public void testAddAll_ListDiffEntry2() throws Exception {
        ...
        }, "List.addAll(Collection)", list, Arrays.asList(new Object[] { element0, element1 }));
    }
    ...
    public void testAddAllAtIndex_ChangeEvent() throws Exception {
        assertChangeEventFired(new Runnable() {
            ...
            @Override
            public void run() {
                list.addAll(0, Arrays.asList(new Object[] { delegate.createElement(list) }));
            }
    ...
    public void testAddAllAtIndex_ListChangeEvent() throws Exception {
        ...
        }, "List.addAll(int, Collection)", list, Collections.singletonList(element));
    }
    ...
    public void testAddAllAtIndex_ListDiffEntry() throws Exception {
        ...
        }, "List.addAll(int, Collection)", list, Arrays.asList(new Object[] { element0, element1 }));
    }
    ...
    public void testSet_ListChangeEvent() throws Exception {
        ...
        }, "List.set(int, Object)", list, Arrays.asList(new Object[] { element1 }));
    }
    ...
    public void testSet_ListChangeEvent2() throws Exception {
        ...
        }, "List.set(int, Object)", list, Arrays.asList(new Object[] { element0, newElement1 }));
    }
    ...
    public void testMove_ListChangeEvent() throws Exception {
        ...
        }, "IObservableList.move(int, int)", list, Arrays.asList(new Object[] { element1, element0 }));
    }
    ...
    public void testRemoveAll_ListDiffEntry2() throws Exception {
        ...
        }, "List.removeAll(Collection)", list, Collections.singletonList(element0));
    }
    ...
    public void testRetainAll_ListChangeEvent() throws Exception {
        ...
        }, "List.retainAll(Collection", list, Collections.singletonList(element0));
    }
    ...
    public void testRetainAll_ListDiffEntry() throws Exception {
        ...
        }, "List.retainAll(Collection)", list, Collections.singletonList(element));
    }
    ...
    public static Test suite(IObservableCollectionContractDelegate delegate) {
        return new SuiteBuilder().addObservableContractTest(MutableObservableListContractTest.class, delegate).addObservableContractTest(ObservableListContractTest.class, delegate).build();
    }
}
