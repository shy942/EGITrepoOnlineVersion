...
public class GridDataFactoryTest extends TestCase {
    ...
    public void testToStringWithAllOverrides() {
        GridDataFactory factory = GridDataFactory.fillDefaults().grab(true, false).align(SWT.LEFT, SWT.FILL).indent(15, 23).span(1, 2).minSize(20, 30).hint(100, SWT.DEFAULT);
        assertEquals("GridDataFactory.fillDefaults()\n    .grab(true, false)\n    .align(SWT.LEFT, SWT.FILL)\n    .indent(15, 23)\n    .span(1, 2)\n    .minSize(20, 30)\n    .hint(100, SWT.DEFAULT)\n", factory.toString());
    }
    ...
    public void testToStringAlign() {
        GridDataFactory factory = GridDataFactory.fillDefaults().align(SWT.FILL, SWT.BOTTOM);
    ...
    public void testToStringHint() {
        GridDataFactory factory = GridDataFactory.fillDefaults().hint(SWT.DEFAULT, 310);
