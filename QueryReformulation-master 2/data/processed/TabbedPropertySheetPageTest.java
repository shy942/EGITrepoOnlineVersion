...
*/
        IContentProvider contentProvider = testsView.getViewer().getContentProvider();
...
*/
        //$NON-NLS-1$
        assertEquals("Message", tabDescriptors[0].getLabel());
...
*/
        //$NON-NLS-1$
        assertEquals("Error", tabDescriptors[1].getLabel());
        //$NON-NLS-1$
        assertEquals("Message", tabDescriptors[2].getLabel());
        assertEquals(3, tabDescriptors.length);
        /**
...
*/
        //$NON-NLS-1$
        assertEquals("Resource", TabDescriptors[0].getLabel());
        assertEquals(1, TabDescriptors.length);
    }
