...
public class WizardsStatusHandlingTestCase extends TestCase {
    ...
    private static String EXCEPTION_MESSAGE = NLS.bind(RegistryMessages.plugin_instantiateClassError, new Object[] { "org.eclipse.ui.tests", "org.eclipse.ui.tests.statushandlers.FaultyExportWizard" });

    private static String EXCEPTION_MESSAGE2 = NLS.bind(RegistryMessages.plugin_loadClassError, new Object[] { "org.eclipse.ui.tests", "org.eclipse.ui.tests.statushandlers.FaultyExportWizard" });
...
*/
    ...
    private String createIncorrectExceptionMessage(String exceptionMessage) {
        return "expected:<" + EXCEPTION_MESSAGE + "> or <" + EXCEPTION_MESSAGE2 + "> but was:<" + exceptionMessage + ">";
    }
}
