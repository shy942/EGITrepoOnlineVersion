...
*/
    ...
    public static final int PRESENTATION = OUTSIDE_PERSPECTIVE | IN_ACTIVE_PERSPECTIVE | IN_SHARED_AREA;

    /** Searches for elements in the UI presentation, including all perspectives */
    public static final int ANYWHERE = OUTSIDE_PERSPECTIVE | IN_ANY_PERSPECTIVE | IN_SHARED_AREA | IN_TRIM;
...
*/
    //$NON-NLS-1$
    public static String CLONED_FROM_KEY = "Cloned From";
