...
*/
    ...
    public void testCreateReadRootReader() throws WorkbenchException {
        XMLMemento memento = XMLMemento.createReadRoot(new StringReader("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><simple>some text data</simple>"));
...
*/
    ...
    public void testCreateWriteRoot() {
        String[] rootTypes = { "type", "type.with.dots", "type_with_underscores" };
    ...
    public void testCopyChild() throws WorkbenchException, IOException {
        testPutAndGet(new MementoChecker() {
            ...
            @Override
            public void prepareAndCheckBeforeSerialization(XMLMemento mementoToSerialize) {
...
*/
    ...
    public void testGetID() throws WorkbenchException, IOException {
        final String type = "type";
        String[] ids = { "id", "", "id.with.many.dots", "id_with_underscores", "id<with<lessthan", "id>with>greaterthan", "id&with&ampersand", "id\"with\"quote", "id#with#hash" };
    ...
    public void testPutAndGetFloat() throws WorkbenchException, IOException {
        ...
        final Float[] values = new Float[] { new Float(-3.1415), new Float(1), new Float(0), new Float(4554.45235), new Float(Float.MAX_VALUE), new Float(Float.MIN_VALUE), new Float(Float.NaN), new Float(Float.POSITIVE_INFINITY), new Float(Float.NEGATIVE_INFINITY) };
    ...
    public void testPutAndGetInteger() throws WorkbenchException, IOException {
        final String key = "key";
        Integer[] values = new Integer[] { Integer.valueOf(36254), Integer.valueOf(0), Integer.valueOf(1), Integer.valueOf(-36254), Integer.valueOf(Integer.MAX_VALUE), Integer.valueOf(Integer.MIN_VALUE) };
    ...
    public void testPutMemento() throws WorkbenchException, IOException {
        testPutAndGet(new MementoChecker() {
            ...
            public void prepareAndCheckBeforeSerialization(XMLMemento mementoToSerialize) {
                ...
                assertEquals("unchanged text data", mementoToSerialize.getTextData());
                assertEquals("retained value", mementoToSerialize.getString("neverlost"));
            }
            ...
            public void checkAfterDeserialization(XMLMemento deserializedMemento) {
                ...
                assertEquals("unchanged text data", deserializedMemento.getTextData());
                assertEquals("retained value", deserializedMemento.getString("neverlost"));
            }
        });
    }
    ...
    public void testLegalKeys() throws WorkbenchException, IOException {
        String[] legalKeys = { "value", "value.with.many.dots", "value_with_underscores" };
        for (final String key : legalKeys) {
            testPutAndGet(new MementoChecker() {
                ...
                public void prepareAndCheckBeforeSerialization(XMLMemento mementoToSerialize) {
                    ...
                    assertEquals("some string", mementoToSerialize.getString(key));
                }

                @Override
                public void checkAfterDeserialization(XMLMemento deserializedMemento) {
                    assertEquals("some string", deserializedMemento.getString(key));
                }
            });
        }
    }
    ...
    private void testPutAndGet(MementoChecker mementoChecker) throws IOException, WorkbenchException {
        XMLMemento mementoToSerialize = XMLMemento.createWriteRoot("XMLMementoTest");
