...
*/
    private void createClearAllAction() {
        ...
        ImageDescriptor id = WorkbenchImages.getWorkbenchImageDescriptor(//$NON-NLS-1$
        "/elcl16/progress_remall.png");
        if (id != null) {
            clearAllAction.setImageDescriptor(id);
        }
        id = WorkbenchImages.getWorkbenchImageDescriptor(//$NON-NLS-1$
        "/dlcl16/progress_remall.png");
        if (id != null) {
