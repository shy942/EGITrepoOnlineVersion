...
public class ListDetailValueObservableListTest extends AbstractDefaultRealmTestCase {
    ...
    public void testMasterNull() {
        WritableList masterObservableList = new WritableList();
        ListDetailValueObservableList ldol = new ListDetailValueObservableList(masterObservableList, BeansObservables.valueFactory("name"), String.class);
    ...
    private static class Delegate extends AbstractObservableCollectionContractDelegate {
        ...
        public IObservableCollection createObservableCollection(Realm realm, int elementCount) {
            ...
            return new TestListDetailValueObservableList(masterList, BeansObservables.valueFactory(realm, "name"), String.class);
        }
