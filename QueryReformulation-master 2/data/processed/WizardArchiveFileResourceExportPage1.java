...
*/
    protected boolean executeExportOperation(ArchiveFileExportOperation op) {
        ...
        if (!status.isOK()) {
            ErrorDialog.openError(getContainer().getShell(), DataTransferMessages.DataTransfer_exportProblems, // no special message
            null, status);
            return false;
        }
        return true;
...
*/
    ...
    public boolean finish() {
        ...
        saveWidgetValues();
        return executeExportOperation(new ArchiveFileExportOperation(null, resourcesToExport, getDestinationValue()));
    }
...
*/
    ...
    protected boolean validateDestinationGroup() {
        ...
        destinationValue.endsWith(".tar.gz") || destinationValue.endsWith(".tgz")) {
            //$NON-NLS-1$
            compressContentsCheckbox.setSelection(true);
            targzFormatButton.setSelection(true);
            zipFormatButton.setSelection(false);
