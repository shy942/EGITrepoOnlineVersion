...
*/
    protected void initLabelProvider(TreeViewer viewer) {
        viewer.setLabelProvider(new DecoratingLabelProvider(new WorkbenchLabelProvider(), getPlugin().getWorkbench().getDecoratorManager().getLabelDecorator()));
    }
...
*/
    protected void makeActions() {
        ...
        service.activateHandler(IWorkbenchCommandConstants.NAVIGATE_TOGGLE_LINK_WITH_EDITOR, new ActionHandler(group.toggleLinkingAction));
...
* ensure there are no duplicates & don't override user preferences	 */
                ...
                //filters defined, old version: ignore filters from plugins
