...
*/
    private String formatData(final Notification notification, Map<String, Object> argMap) {
        ...
        if (notifier instanceof MApplicationElement) {
            ...
            switch(notification.getEventType()) {
                ...
                case Notification.UNSET:
                    ...
                    break;
                default:
                    Activator.log(IStatus.ERROR, getClass().getName() + //$NON-NLS-1$
                    ": unhandled EMF Notification code: " + notification.getEventType());
            }
            ...
            if (notificationNewValue != storedNewValue) {
                ...
                "A StringToObjectMap that was NOT MApplicationElement.transientData changed.  You must modify UIEventPublisher appropriately");
            }
            ...
            if (notificationNewValue != storedNewValue) {
                throw new IllegalArgumentException(//$NON-NLS-1$
                "A StringToStringMap that was NOT MApplicationElement.persistedState changed.  You must modify UIEventPublisher appropriately");
            }
        ...
        if (notification.getEventType() == Notification.SET || notification.getEventType() == Notification.MOVE || notification.getEventType() == Notification.ADD || notification.getEventType() == Notification.ADD_MANY || notification.getEventType() == Notification.REMOVE || notification.getEventType() == Notification.REMOVE_MANY) {
            if (newValue != null) {
    ...
    private String getTopic(EStructuralFeature eFeature, String type) {
        ...
        return UIEvents.UIModelTopicBase + UIEvents.TOPIC_SEP + eContainingClass.getEPackage().getName() + UIEvents.TOPIC_SEP + eContainingClass.getName() + UIEvents.TOPIC_SEP + eFeature.getName() + UIEvents.TOPIC_SEP + type;
    }
