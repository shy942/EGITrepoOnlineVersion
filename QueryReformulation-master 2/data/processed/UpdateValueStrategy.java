...
*/
    protected void fillDefaults(IObservableValue source, IObservableValue destination) {
        ...
        if (converter != null) {
            if (sourceType != null) {
                checkAssignable(converter.getFromType(), sourceType, //$NON-NLS-1$
                "converter does not convert from type " + sourceType);
            }
            if (destinationType != null) {
                checkAssignable(destinationType, converter.getToType(), //$NON-NLS-1$
                "converter does not convert to type " + destinationType);
            }
        }
    }
        ...
        if (defaultedConverter) {
            if (String.class.equals(fromType)) {
                ...
                if (result == null) {
                    ...
                    } else if (Character.class.equals(toType) || Character.TYPE.equals(toType) && converter instanceof StringToCharacterConverter) {
                        result = new StringToCharacterValidator((StringToCharacterConverter) converter);
                    } else if (Date.class.equals(toType) && converter instanceof StringToDateConverter) {
                        result = new StringToDateValidator((StringToDateConverter) converter);
                    }
                    if (result != null) {
...
*/
    public IStatus validateAfterConvert(Object value) {
        return afterConvertValidator == null ? Status.OK_STATUS : afterConvertValidator.validate(value);
    }
...
*/
    public IStatus validateAfterGet(Object value) {
        return afterGetValidator == null ? Status.OK_STATUS : afterGetValidator.validate(value);
    }
...
*/
    public IStatus validateBeforeSet(Object value) {
        return beforeSetValidator == null ? Status.OK_STATUS : beforeSetValidator.validate(value);
    }
