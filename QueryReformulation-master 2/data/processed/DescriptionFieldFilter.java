...
*/
    ...
    void loadLegacySettings(IMemento memento, MarkerContentGenerator generator) {
        ...
        if (setting != null) {
            containsModifier = Boolean.valueOf(setting).booleanValue() ? MarkerSupportConstants.CONTAINS_KEY : MarkerSupportConstants.DOES_NOT_CONTAIN_KEY;
        }
...
*/
    ...
    public void initialize(ProblemFilter problemFilter) {
        containsModifier = problemFilter.getContains() ? MarkerSupportConstants.CONTAINS_KEY : MarkerSupportConstants.DOES_NOT_CONTAIN_KEY;
