...
* @since 3.3
*/
    public static final String ACTIVE_WORKBENCH_WINDOW_IS_COOLBAR_VISIBLE_NAME = ACTIVE_WORKBENCH_WINDOW_NAME + //$NON-NLS-1$
    ".isCoolbarVisible";
...
* @since 3.3
*/
    public static final String ACTIVE_WORKBENCH_WINDOW_IS_PERSPECTIVEBAR_VISIBLE_NAME = ACTIVE_WORKBENCH_WINDOW_NAME + //$NON-NLS-1$
...
* @since 3.4
*/
    public static final String ACTIVE_WORKBENCH_WINDOW_ACTIVE_PERSPECTIVE_NAME = ACTIVE_WORKBENCH_WINDOW_NAME + //$NON-NLS-1$
    ".activePerspective";
