...
public class PersonService implements IPersonService, IDisposable {
    ...
    private static final String[] datafill = { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "Webster", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "Paul", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "Doe", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "John", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "Doe", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    "Jane", "Public", "John", "Public", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$
    "Jane" };
    ...
    public void updatePerson(Person person) {
        ...
        if (p == null) {
            //$NON-NLS-1$
            Assert.isNotNull(p, "Must update a real person");
        }
        if (person.equals(p)) {
            return;
        }
...
*/
    private void firePersonChange(String property, Person oldVal, Person person) {
        ...
        PropertyChangeEvent event = new PropertyChangeEvent(this, property, oldVal, person);
    ...
    public void login(Person person) {
        ISourceProviderService sources = serviceLocator.getService(ISourceProviderService.class);
        // should do some more checks
        UserSourceProvider userProvider = (UserSourceProvider) sources.getSourceProvider(UserSourceProvider.USER);
