...
*/
    public  PluginAction(IConfigurationElement actionElement, String id, int style) {
        ...
        if (id != null) {
            ...
            //$NON-NLS-1$
            setId("PluginAction." + Integer.toString(actionCount));
            ++actionCount;
        }
        ...
        if (delegate == null && runAttribute != null) {
            try {
                ...
                if (e instanceof CoreException) {
                    ...
                    status = StatusUtil.newStatus(IStatus.ERROR, "Internal plug-in action delegate error on creation.", e);
                }
...
*/
    ...
    public void runWithEvent(Event event) {
        ...
        if (delegate == null) {
            createDelegate();
            if (delegate == null) {
                MessageDialog.openInformation(Util.getShellToParentOn(), WorkbenchMessages.Information, WorkbenchMessages.PluginAction_operationNotAvailableMessage);
                return;
            }
            if (!isEnabled()) {
