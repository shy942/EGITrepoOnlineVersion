...
public class IAggregateWorkingSetTest extends UITestCase {
    ...
    protected void doSetUp() throws Exception {
        ...
        for (int i = 0; i < 4; i++) {
            components[i] = workingSetManager.createWorkingSet(WORKING_SET_NAME + i, new IAdaptable[] {});
            workingSetManager.addWorkingSet(components[i]);
        }
        fWorkingSet = (IAggregateWorkingSet) workingSetManager.createAggregateWorkingSet(AGGREGATE_WORKING_SET_NAME_, AGGREGATE_WORKING_SET_NAME_, components);
    ...
    public void testSaveWSet() throws Throwable {
        ...
        if (set.isAggregateWorkingSet()) {
            ...
            if (sets.length >= 1) {
                //client fails to pay enough attention to specs or unknowingly does this
                sets[0] = null;
            }
        }
        //</possible client code>
    ...
    public void testGetElemets() throws Throwable {
        ...
        //</possible client code>
        //unexpected
        assertTrue(ArrayUtil.equals(new IAdaptable[] {}, fWorkingSet.getElements()));
    }
...
*/
    public void testWorkingSetCycle() throws Throwable {
        ...
        IAggregateWorkingSet aggregate = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle", "testCycle", new IWorkingSet[0]);
        IAggregateWorkingSet aggregate2 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle", "testCycle", new IWorkingSet[] { aggregate });
        IMemento memento = XMLMemento.createWriteRoot(IWorkbenchConstants.TAG_WORKING_SET);
...
*/
    public void testCycleCleanup() throws Throwable {
        ...
        IAggregateWorkingSet aggregateSub0 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle0", "testCycle0", new IWorkingSet[0]);
        IAggregateWorkingSet aggregateSub1 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle1", "testCycle1", new IWorkingSet[0]);
        IAggregateWorkingSet aggregateSub2 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle", "testCycle", // cycle
        new IWorkingSet[0]);
        IAggregateWorkingSet aggregateSub3 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle3", "testCycle3", new IWorkingSet[0]);
        IAggregateWorkingSet aggregateSub4 = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle4", "testCycle4", new IWorkingSet[0]);
        IAggregateWorkingSet aggregate = (IAggregateWorkingSet) manager.createAggregateWorkingSet("testCycle", "testCycle", new IWorkingSet[] { aggregateSub0, aggregateSub1, aggregateSub2, aggregateSub3, aggregateSub4 });
...
*/
    ...
    public void XXXtestWorkingSetSaveRestoreAggregates() throws Throwable {
        ...
        IAggregateWorkingSet wSetB = (IAggregateWorkingSet) manager.createAggregateWorkingSet(nameB, nameB, new IWorkingSet[] {});
        manager.addWorkingSet(wSetB);
        IAggregateWorkingSet wSetC = (IAggregateWorkingSet) manager.createAggregateWorkingSet(nameC, nameC, new IWorkingSet[0]);
        ...
        try {
            ...
            invokeMethod(AggregateWorkingSet.class, "setComponents", wSetB, new Object[] { new IWorkingSet[] { wSetA, wSetC } }, new Class[] { new IWorkingSet[] {}.getClass() });
            ...
            if (componenents1.length != componenents2.length) {
                assertArrayEquals(nameB + " has lost data in the process of save/restore: " + restoredB, wSetB.getComponents(), restoredB.getComponents());
            } else {
                for (int i = 0; i < componenents1.length; i++) {
                    if (!componenents1[i].equals(componenents2[i])) {
                        assertEquals(nameB + " has lost data in the process of save/restore: " + restoredB, componenents1[i].toString(), componenents2[i].toString());
                        fail("equals() and toString() do not match for: " + componenents1[i] + " and " + componenents2[i]);
                    }
                }
            }
        } finally {
                ...
                public void propertyChange(PropertyChangeEvent event) {
                    ...
                    if (m != null) {
                        ...
                        if (msets.length != sets.length) {
                            // KABOOM!
                            error.set("Working set lost due the bad listener! " + "restored: " + Arrays.toString(sets) + ", expected: " + Arrays.toString(msets));
                        }
                    } else {
    ...
    private IMemento saveAndRemoveWorkingSets(IWorkingSet... sets) {
        IMemento managerMemento = XMLMemento.createWriteRoot(IWorkbenchConstants.TAG_WORKING_SET_MANAGER);
        IWorkingSetManager manager = fWorkbench.getWorkingSetManager();
        ...
        invokeMethod(AbstractWorkingSetManager.class, "saveWorkingSetState", manager, new Object[] { managerMemento }, new Class[] { IMemento.class });
        invokeMethod(AbstractWorkingSetManager.class, "saveMruList", manager, new Object[] { managerMemento }, new Class[] { IMemento.class });
        for (IWorkingSet set : sets) {
    ...
    private void restoreWorkingSetManager(IMemento managerMemento) {
        IWorkingSetManager manager = fWorkbench.getWorkingSetManager();
        invokeMethod(AbstractWorkingSetManager.class, "restoreWorkingSetState", manager, new Object[] { managerMemento }, new Class[] { IMemento.class });
        invokeMethod(AbstractWorkingSetManager.class, "restoreMruList", manager, new Object[] { managerMemento }, new Class[] { IMemento.class });
    }

    private Object invokeMethod(Class clazz, String methodName, Object instance, Object[] args, Class[] argsClasses) {
        try {
