...
public class BeansObservablesTest extends AbstractDefaultRealmTestCase {
    ...
    public void testObserveListArrayInferredElementType() throws Exception {
        IObservableList list = BeansObservables.observeList(Realm.getDefault(), model, "list", null);
    ...
    public void testListFactory() throws Exception {
        IObservableFactory factory = BeansObservables.listFactory(Realm.getDefault(), "list", elementType);
        IObservableList list = (IObservableList) factory.createObservable(model);
        assertTrue("elements of the list", Arrays.equals(elements, list.toArray(new Bean[list.size()])));
        assertEquals("element type", elementType, list.getElementType());
    }
    ...
    public void testObserveDetailListElementType() throws Exception {
        ...
        IObservableList list = BeansObservables.observeDetailList(parent, "list", elementType);
        assertEquals("element type", elementType, list.getElementType());
        assertTrue("elements of list", Arrays.equals(elements, list.toArray(new Bean[list.size()])));
    }
    ...
    public void testObserveDetailValueIBeanObservable() throws Exception {
        ...
        IObservableValue detailValue = BeansObservables.observeDetailValue(parent, "value", String.class);
    ...
    public void testObserveDetailValueNullOuterElementType() throws Exception {
        ...
        IObservableValue detailValue = BeansObservables.observeDetailValue(parent, "value", String.class);
        assertNull("property descriptor", ((IBeanObservable) detailValue).getPropertyDescriptor());
    }
    ...
    public void testObservableDetailListIBeanObservable() throws Exception {
        ...
        Bean bean = new Bean();
        parent.setValue(bean);
        IObservableList detailList = BeansObservables.observeDetailList(parent, "list", Bean.class);
    ...
    public void testObservableDetailListNullOuterElementType() throws Exception {
        WritableValue parent = new WritableValue(new Bean(), null);
        IObservableList detailList = BeansObservables.observeDetailList(parent, "list", Bean.class);
        assertNull("property descriptor", ((IBeanObservable) detailList).getPropertyDescriptor());
    }
    ...
    public void testObservableDetailSetIBeanObservable() throws Exception {
        ...
        Bean bean = new Bean();
        parent.setValue(bean);
        IObservableSet detailSet = BeansObservables.observeDetailSet(parent, "set", Bean.class);
        ...
        assertEquals("property descriptor", Bean.class.getMethod("getSet"), beanObservable.getPropertyDescriptor().getReadMethod());
        assertEquals("observed", bean, beanObservable.getObserved());
        // DetailObservableSet is package level we can't do a straight
        // instanceof check
        assertTrue("delegate is the observed", beanObservable.getDecorated().equals(detailSet));
    }

    public void testObservableDetailSetNullOuterElementType() throws Exception {
        WritableValue parent = new WritableValue(new Bean(), null);
        IObservableSet detailSet = BeansObservables.observeDetailSet(parent, "set", Bean.class);
        assertNull("property descriptor", ((IBeanObservable) detailSet).getPropertyDescriptor());
    }
...
*/
    public void testHandleExternalChangeToProperty() {
        ...
        IObservableList modelObservable = BeansObservables.observeList(Realm.getDefault(), model, "array", elementType);
