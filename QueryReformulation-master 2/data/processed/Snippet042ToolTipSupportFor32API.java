...
public class Snippet042ToolTipSupportFor32API {
    ...
    private static class ToolTipSupport extends DefaultToolTip {
        ...
        protected Composite createToolTipContentArea(Event event, Composite parent) {
            ...
            b.setText(((ITableLabelProvider) viewer.getLabelProvider()).getColumnText(cell.getData(), cell.index));
            b.setImage(((ITableLabelProvider) viewer.getLabelProvider()).getColumnImage(cell.getData(), cell.index));
            return comp;
        }
