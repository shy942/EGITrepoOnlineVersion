...
public class TextControlScenario extends ScenariosTestCase {
    ...
    public void testScenario02() {
        ...
        // Change the UI and verify the model changes
        // Change the model and verify the UI changes
        getDbc().bindValue(SWTObservables.observeText(text, SWT.Modify), BeansObservables.observeValue(transportation, "price"));
...
*/
    ...
    public void testScenario08() {
        ...
        dbc.bindValue(SWTObservables.observeText(text, SWT.Modify), BeansObservables.observeValue(adventure, "maxNumberOfPeople"), new CustomBeanUpdateValueStrategy(), null);
