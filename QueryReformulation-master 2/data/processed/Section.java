...
*/
    ...
    public void setBackground(Color bg) {
        ...
        if (descriptionControl != null && (getExpansionStyle() & DESCRIPTION) != 0)
...
*/
    public void setDescriptionControl(Control descriptionControl) {
        ...
        Assert.isTrue(descriptionControl != null && descriptionControl.getParent().equals(this));
...
*/
    ...
    protected void onPaint(PaintEvent e) {
        ...
        if ((getExpansionStyle() & TITLE_BAR) != 0) {
            ...
            gc.setForeground(bg);
            gc.setBackground(getBackground());
            gc.fillGradientRectangle(marginWidth, marginHeight, bounds.width - marginWidth - marginWidth, theight, true);
        }
        gc.setBackground(getBackground());
        FormUtil.setAntialias(gc, SWT.ON);
        // repair the upper left corner
        gc.fillPolygon(new int[] { marginWidth, marginHeight, marginWidth, marginHeight + 2, marginWidth + 2, marginHeight });
        // repair the upper right corner
        gc.fillPolygon(new int[] { bounds.width - marginWidth - 3, marginHeight, bounds.width - marginWidth, marginHeight, bounds.width - marginWidth, marginHeight + 3 });
        ...
        if ((getExpansionStyle() & TITLE_BAR) != 0) {
            ...
            gc.drawPolyline(new int[] { marginWidth + 1, marginHeight + gradientheight + 4, marginWidth + 1, marginHeight + 2, marginWidth + 2, marginHeight + 2, marginWidth + 2, marginHeight + 1, bounds.width - marginWidth - 3, marginHeight + 1, bounds.width - marginWidth - 3, marginHeight + 2, bounds.width - marginWidth - 2, marginHeight + 2, bounds.width - marginWidth - 2, marginHeight + gradientheight + 4 });
        }
        if (buffer != null) {
            gc.dispose();
    ...
    private void updateHeaderImage(Color bg, Rectangle bounds, int theight, int realtheight) {
        ...
        Image image = FormImages.getInstance().getSectionGradientImage(gradient, bg, realtheight, theight, marginHeight, getDisplay());
