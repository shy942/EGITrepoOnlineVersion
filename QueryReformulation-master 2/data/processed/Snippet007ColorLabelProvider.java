    ...
    public static void main(String[] args) {
        ...
        Realm.runWithDefault(DisplayRealm.getRealm(display), new Runnable() {
            ...
            public void run() {
                ...
                attributes[0] = BeanProperties.value(Person.class, "name").observeDetail(contentProvider.getKnownElements());
                attributes[1] = BeanProperties.value(Person.class, "gender").observeDetail(contentProvider.getKnownElements());
