...
public class IdentityConverterTest extends TestCase {
    ...
    public void testIsPrimitiveTypeMatchedWithBoxed() throws Exception {
        ...
        assertTrue(c.isPrimitiveTypeMatchedWithBoxed(Character.class, Character.TYPE));
        assertTrue(c.isPrimitiveTypeMatchedWithBoxed(Character.TYPE, Character.class));
