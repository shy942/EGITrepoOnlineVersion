...
*/
        IViewPart view = workbenchPage.showView(DynamicTestsView.DYNAMIC_TESTS_VIEW_ID);
        assertNotNull(view);
...
*/
        IContentProvider contentProvider = dynamicTestsView.getViewer().getContentProvider();
        ...
        treeNodes = (DynamicTestsTreeNode[]) viewContentProvider.getInvisibleRoot().getChildren();
...
*/
    public void test_BlueStaticContribution() {
        dynamicTestsView.setContributorId(DynamicTestsView.DYNAMIC_TESTS_VIEW_STATIC);
        select_all_blue();
    }
...
*/
    public void test_BlueDynamicTabContribution() {
        dynamicTestsView.setContributorId(DynamicTestsView.DYNAMIC_TESTS_VIEW_DYNAMIC_TABS);
        select_all_blue();
    }
...
*/
    public void test_BlueDynamicSectionContribution() {
        dynamicTestsView.setContributorId(DynamicTestsView.DYNAMIC_TESTS_VIEW_DYNAMIC_SECTIONS);
        select_all_blue();
    }
...
*/
    public void select_all_blue() {
        ...
        for (int i = 0; i < treeNodes.length; i++) {
            if (DynamicTestsColor.BLUE.equals(treeNodes[i].getDynamicTestsElement().getPropertyValue(DynamicTestsElement.ID_COLOR))) {
                blueList.add(treeNodes[i]);
            }
        }
        DynamicTestsTreeNode[] selectNodes = (DynamicTestsTreeNode[]) blueList.toArray(new DynamicTestsTreeNode[blueList.size()]);
...
*/
        //$NON-NLS-1$
        assertEquals("Element", tabDescriptors[0].getLabel());
        /**
* Second tab is Color
*/
        //$NON-NLS-1$
        assertEquals("Color", tabDescriptors[1].getLabel());
        /**
* No other tab
*/
...
*/
    public void select_all_triangle() {
        ...
        for (int i = 0; i < treeNodes.length; i++) {
            if (DynamicTestsShape.TRIANGLE.equals(treeNodes[i].getDynamicTestsElement().getPropertyValue(DynamicTestsElement.ID_SHAPE))) {
                triangleList.add(treeNodes[i]);
            }
        }
        DynamicTestsTreeNode[] selectNodes = (DynamicTestsTreeNode[]) triangleList.toArray(new DynamicTestsTreeNode[triangleList.size()]);
...
*/
        //$NON-NLS-1$
        assertEquals("Shape", tabDescriptors[1].getLabel());
        assertEquals(2, tabDescriptors.length);
    }
...
*/
        //$NON-NLS-1$
        assertEquals("Black", tabDescriptors[3].getLabel());
...
*/
    public void select_blackTriangle() {
        ...
        for (int i = 0; i < treeNodes.length; i++) {
            if (DynamicTestsColor.BLACK.equals(treeNodes[i].getDynamicTestsElement().getPropertyValue(DynamicTestsElement.ID_COLOR))) {
...
*/
        //$NON-NLS-1$
        assertEquals("Advanced", tabDescriptors[2].getLabel());
    }
...
*/
        //$NON-NLS-1$
        assertEquals("Star", tabDescriptors[2].getLabel());
        /**
* Fourth tab is Advanced
*/
        //$NON-NLS-1$
        assertEquals("Advanced", tabDescriptors[3].getLabel());
        assertEquals(4, tabDescriptors.length);
    }
...
*/
    public void select_RedStar() {
        ...
        for (int i = 0; i < treeNodes.length; i++) {
            if (DynamicTestsShape.STAR.equals(treeNodes[i].getDynamicTestsElement().getPropertyValue(DynamicTestsElement.ID_SHAPE))) {
