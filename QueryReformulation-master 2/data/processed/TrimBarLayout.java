...
*/
    ...
    protected Point computeSize(Composite composite, int wHint, int hHint, boolean flushCache) {
        ...
        totalMinor += horizontal ? (marginTop + marginBottom) + totalWrapSpacing : (marginLeft + marginRight) + totalWrapSpacing;
...
*/
    ...
    private boolean isStatusLine(Control ctrl) {
        MUIElement element = (MUIElement) ctrl.getData(AbstractPartRenderer.OWNING_ME);
        if (element != null && element.getElementId() != null && //$NON-NLS-1$
        element.getElementId().equals("org.eclipse.ui.StatusLine"))
            return true;
        return false;
    }
