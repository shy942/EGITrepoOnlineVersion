...
*/
    public static ImageDescriptor imageDescriptorFromPlugin(String pluginId, String imageFilePath) {
        ...
        ImageDescriptor imageDescriptor = workbench == null ? null : workbench.getSharedImages().getImageDescriptor(imageFilePath);
        if (imageDescriptor != null)
            // found in the shared images
        ...
        //$NON-NLS-1$
        IPath uriPath = new Path("/plugin").append(pluginId).append(imageFilePath);
        URL url;
        try {
            //$NON-NLS-1$
