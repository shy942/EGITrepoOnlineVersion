...
*/
    ...
    public void run() {
        ...
        try {
            ...
            ErrorDialog.openError(getShell(), TaskListMessages.PurgeCompleted_errorMessage, null, e.getStatus());
            return;
        }
        ...
        // Verify.
        if (!MessageDialog.openConfirm(getShell(), TaskListMessages.PurgeCompleted_title, NLS.bind(TaskListMessages.PurgeCompleted_permanent, String.valueOf(completed.size())))) {
            return;
        }
        ...
        execute(op, TaskListMessages.PurgeCompleted_errorMessage, null, WorkspaceUndoUtil.getUIInfoAdapter(getShell()));
    }
}
