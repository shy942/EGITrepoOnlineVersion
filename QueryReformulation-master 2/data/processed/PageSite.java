...
*/
    public  PageSite(final IViewSite parentViewSite) {
        ...
        //$NON-NLS-1$
        e4Context = ((PartSite) parentViewSite).getContext().createChild("PageSite");
...
*/
    private void initializeDefaultServices() {
        ...
        serviceLocator.registerService(IPageSiteHolder.class, new IPageSiteHolder() {
...
*/
    ...
    /* Package */
    IEclipseContext getSiteContext() {
        return e4Context;
    }
