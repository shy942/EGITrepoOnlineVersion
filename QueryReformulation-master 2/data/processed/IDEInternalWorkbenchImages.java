...
public final class IDEInternalWorkbenchImages {
    ...
    //$NON-NLS-1$
    public static final String IMG_ETOOL_PROBLEMS_VIEW = "IMG_ETOOL_PROBLEMS_VIEW";

    //$NON-NLS-1$
    public static final String IMG_ETOOL_PROBLEMS_VIEW_ERROR = "IMG_ETOOL_PROBLEMS_VIEW_ERROR";

    //$NON-NLS-1$
    public static final String IMG_ETOOL_PROBLEMS_VIEW_WARNING = "IMG_ETOOL_PROBLEMS_VIEW_WARNING";

    //$NON-NLS-1$
    public static final String IMG_ETOOL_PROBLEMS_VIEW_INFO = "IMG_ETOOL_PROBLEMS_VIEW_INFO";
    ...
    //$NON-NLS-1$
    public static final String IMG_OBJS_FIXABLE_WARNING = "IMG_OBJS_FIXABLE_WARNING";

    //$NON-NLS-1$
    public static final String IMG_OBJS_FIXABLE_ERROR = "IMG_OBJS_FIXABLE_ERROR";

    //$NON-NLS-1$
    public static final String IMG_OBJS_FIXABLE_INFO = "IMG_OBJS_FIXABLE_INFO";
