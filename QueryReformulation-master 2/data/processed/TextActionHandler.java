...
public class TextActionHandler {
    ...
    private class DeleteActionHandler extends Action {
        ...
        protected  DeleteActionHandler() {
            ...
            setEnabled(false);
            PlatformUI.getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.TEXT_DELETE_ACTION);
        }
...
*/
    ...
    private class CutActionHandler extends Action {
        ...
        protected  CutActionHandler() {
            ...
            setEnabled(false);
            PlatformUI.getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.TEXT_CUT_ACTION);
        }
    ...
    private class CopyActionHandler extends Action {
        ...
        protected  CopyActionHandler() {
            ...
            setEnabled(false);
            PlatformUI.getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.TEXT_COPY_ACTION);
        }
...
*/
    ...
    private class PasteActionHandler extends Action {
        ...
        protected  PasteActionHandler() {
            ...
            setEnabled(false);
            PlatformUI.getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.TEXT_PASTE_ACTION);
        }
...
*/
    ...
    private class SelectAllActionHandler extends Action {
        ...
        protected  SelectAllActionHandler() {
            ...
            setEnabled(false);
            PlatformUI.getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.TEXT_SELECT_ALL_ACTION);
        }
