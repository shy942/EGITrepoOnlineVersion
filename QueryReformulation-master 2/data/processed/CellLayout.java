                        ...
                        for (int colIdx = 0; colIdx < rowControls.length; colIdx++) {
                            ...
                            if (control != -1) {
                                ...
                                if (controlStart + controlSpan - 1 == idx && controlStart > lastGrowingRow) {
                                    ...
                                    int allocatedHeight = sumOfSizes(result, controlColStart, controlRowSpan - 1) + (rowSpacing * (controlRowSpan - 1));
...
*/
    private Point totalEmptySpace() {
        int numRows = gridInfo.getRows();
        return new Point((2 * marginWidth) + ((gridInfo.getCols() - 1) * horizontalSpacing), (2 * marginHeight) + ((numRows - 1) * verticalSpacing));
    }
