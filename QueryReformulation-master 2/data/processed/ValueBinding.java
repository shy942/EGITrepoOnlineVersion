...
*/
    ...
    protected void postInit() {
        ...
        if (targetToModel.getUpdatePolicy() == UpdateValueStrategy.POLICY_UPDATE || targetToModel.getUpdatePolicy() == UpdateValueStrategy.POLICY_CONVERT) {
        ...
        source.getRealm().exec(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    mergeStatus(multiStatus, new Status(IStatus.ERROR, Policy.JFACE_DATABINDING, IStatus.ERROR, message, ex));
                } finally {
