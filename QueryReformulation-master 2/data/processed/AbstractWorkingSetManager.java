...
public abstract class AbstractWorkingSetManager extends EventManager implements IWorkingSetManager, BundleListener, IExtensionChangeHandler {
    ...
    abstract static class WorkingSetRunnable implements ISafeRunnable {
...
*/
    private IExtensionPoint getExtensionPointFilter() {
        return Platform.getExtensionRegistry().getExtensionPoint(PlatformUI.PLUGIN_ID, IWorkbenchRegistryConstants.PL_WORKINGSETS);
    }
    ...
    public void addWorkingSet(IWorkingSet workingSet) {
        ...
        //$NON-NLS-1$
        Assert.isTrue(wSet == null, "working set with same name already registered");
...
*/
    ...
    public void bundleChanged(BundleEvent event) {
        ...
        if (event.getBundle().getState() == Bundle.ACTIVE) {
            ...
            Job job = new WorkbenchJob(NLS.bind(WorkbenchMessages.AbstractWorkingSetManager_updatersActivating, symbolicName)) {
    ...
    private IWorkingSetUpdater getUpdater(WorkingSetDescriptor descriptor) {
        ...
        if (updater == null) {
            ...
            if (updater == null) {
                ...
                PlatformUI.getWorkbench().getExtensionTracker().registerObject(descriptor.getConfigurationElement().getDeclaringExtension(), updater, IExtensionTracker.REF_WEAK);
            }
