...
*/
                ...
                } else if (event.getResult() != null && event.getResult().getSeverity() == IStatus.ERROR && (event.getJob() == null || event.getJob().getJobGroup() == null)) {
...
*/
            ...
            public void sleeping(IJobChangeEvent event) {
                if (// Are we showing this?
                jobs.containsKey(event.getJob()))
