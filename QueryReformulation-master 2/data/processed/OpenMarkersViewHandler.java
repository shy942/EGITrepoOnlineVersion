...
public class OpenMarkersViewHandler extends MarkerViewHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
            ...
            String defaultName = NLS.bind(MarkerMessages.newViewTitle, new Object[] { part.getSite().getRegisteredName(), count });
            InputDialog dialog = new InputDialog(part.getSite().getShell(), NLS.bind(MarkerMessages.NewViewHandler_dialogTitle, new String[] { part.getSite().getRegisteredName() }), MarkerMessages.NewViewHandler_dialogMessage, defaultName, getValidator());
