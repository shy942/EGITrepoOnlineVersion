...
*/
    ...
    public E move(int oldIndex, int newIndex) {
        ...
        ListDiff<E> diff = Diffs.createListDiff(Diffs.createListDiffEntry(oldIndex, false, element), Diffs.createListDiffEntry(newIndex, true, element));
        updateList(list, diff);
        return element;
    }
    ...
    public boolean remove(Object o) {
        ...
        if (index == -1)
            return false;
        @SuppressWarnings("unchecked") // o can only be of type E
    ...
    public ListIterator<E> listIterator(final int index) {
        ...
        return new ListIterator<E>() {
            ...
            public void set(E o) {
                checkRealm();
                checkForComodification();
                ListDiff<E> diff = Diffs.createListDiff(Diffs.createListDiffEntry(lastIndex, false, lastElement), Diffs.createListDiffEntry(lastIndex, true, o));
                updateList(list, diff);
                iterator.set(o);
                lastElement = o;
                expectedModCount = simplePropertyModCount;
    ...
    public E set(int index, E o) {
        ...
        ListDiff<E> diff = Diffs.createListDiff(Diffs.createListDiffEntry(index, false, oldElement), Diffs.createListDiffEntry(index, true, o));
        updateList(list, diff);
        return oldElement;
    }
