...
public class Snippet034ComboViewerAndEnum {
    ...
    static class View {
        ...
        public Shell createShell() {
            ...
            IObservableValue widgetObservable = WidgetProperties.text(SWT.Modify).observe(name);
            bindingContext.bindValue(widgetObservable, PojoProperties.value(viewModel.getClass(), "name").observe(viewModel));
            ...
            bindingContext.bindValue(widgetObservable, PojoProperties.value(viewModel.getClass(), "gender").observe(viewModel));
