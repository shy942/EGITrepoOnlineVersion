...
public class FilterInputDialog extends TitleAreaDialog {
    ...
    private static final Pattern methodNamePattern = Pattern.compile(//$NON-NLS-1$
    "([\\p{L}_$][\\p{L}\\p{N}_$]*\\.)+[\\p{L}_$][\\p{L}\\p{N}_$]*" + //$NON-NLS-1$
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // Placeholder to push noteLabel to the second column.
