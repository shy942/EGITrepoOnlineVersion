...
public class ThemeRegistryModifiedHandlerTest extends TestCase {
    ...
    public void testPopulateThemeRegistries() throws Exception {
        ...
        ThemeRegistryModifiedHandlerTestable handler = spy(new ThemeRegistryModifiedHandlerTestable());
        //when
        handler.populateThemeRegistries(themeRegistry, mock(FontRegistry.class), mock(ColorRegistry.class), mock(org.eclipse.e4.ui.css.swt.theme.ITheme.class), mock(ITheme.class));
        //then
        verify(fontDefinition1, times(1)).isOverridden();
        verify(fontDefinition1, never()).isAddedByCss();
        verify(handler, times(1)).populateDefinition(any(org.eclipse.e4.ui.css.swt.theme.ITheme.class), any(ITheme.class), any(FontRegistry.class), eq(fontDefinition1), any(IPreferenceStore.class));
        verify(fontDefinition2, times(1)).isOverridden();
        verify(fontDefinition2, times(1)).isAddedByCss();
        verify(handler, never()).populateDefinition(any(org.eclipse.e4.ui.css.swt.theme.ITheme.class), any(ITheme.class), any(FontRegistry.class), eq(fontDefinition2), any(IPreferenceStore.class));
        verify(colorDefinition1, times(1)).isOverridden();
        verify(colorDefinition1, times(1)).isAddedByCss();
        verify(handler, never()).populateDefinition(any(org.eclipse.e4.ui.css.swt.theme.ITheme.class), any(ITheme.class), any(ColorRegistry.class), eq(colorDefinition1), any(IPreferenceStore.class));
        verify(colorDefinition2, times(1)).isOverridden();
        verify(colorDefinition2, times(1)).isAddedByCss();
        verify(handler, times(1)).populateDefinition(any(org.eclipse.e4.ui.css.swt.theme.ITheme.class), any(ITheme.class), any(ColorRegistry.class), eq(colorDefinition2), any(IPreferenceStore.class));
    }

    public static class ThemeRegistryModifiedHandlerTestable extends ThemeRegistryModifiedHandler {

        @Override
        public void populateThemeRegistries(ThemeRegistry themeRegistry, FontRegistry fontRegistry, ColorRegistry colorRegistry, org.eclipse.e4.ui.css.swt.theme.ITheme cssTheme, ITheme theme) {
        ...
        @Override
        public void populateDefinition(org.eclipse.e4.ui.css.swt.theme.ITheme cssTheme, ITheme theme, FontRegistry registry, FontDefinition definition, IPreferenceStore store) {
        }

        @Override
        public void populateDefinition(org.eclipse.e4.ui.css.swt.theme.ITheme cssTheme, ITheme theme, ColorRegistry registry, ColorDefinition definition, IPreferenceStore store) {
        }
    }
}
