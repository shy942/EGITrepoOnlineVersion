...
*/
            ...
            private Object getFirstContext(Object helpContext, HelpEvent e) {
                ...
                if (helpContext instanceof IContextComputer) {
                    // get local contexts
                    contexts = ((IContextComputer) helpContext).getLocalContexts(e);
                } else {
...
*/
    private void makeActions() {
        ...
        //$NON-NLS-1$
        defaultsAction.setImageDescriptor(createImageDescriptor("elcl16/defaults_ps.png"));
        //$NON-NLS-1$
        defaultsAction.setDisabledImageDescriptor(createImageDescriptor("dlcl16/defaults_ps.png"));
        defaultsAction.setEnabled(false);
        ...
        //$NON-NLS-1$
        filterAction.setImageDescriptor(createImageDescriptor("elcl16/filter_ps.png"));
        ...
        //$NON-NLS-1$
        categoriesAction.setImageDescriptor(createImageDescriptor("elcl16/tree_mode.png"));
        ...
        //$NON-NLS-1$
        copyAction = new CopyPropertyAction(viewer, "copy", clipboard);
    ...
    private ImageDescriptor createImageDescriptor(String relativeIconPath) {
        ...
        ImageDescriptor imageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(bundle.getSymbolicName(), ICONS_PATH + relativeIconPath);
