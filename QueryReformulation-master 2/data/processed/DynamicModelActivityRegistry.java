...
public class DynamicModelActivityRegistry extends AbstractActivityRegistry {
    ...
    //$NON-NLS-1$
    final String sourceId = "org.eclipse.ui.tests";
...
*/
    private void populateActivityRequirementBindingDefinitions() {
        activityRequirementBindingDefinitions.add(new ActivityRequirementBindingDefinition(((ActivityDefinition) activityDefinitions.toArray()[0]).getId(), ((ActivityDefinition) activityDefinitions.toArray()[1]).getId(), //$NON-NLS-1$
        sourceId));
        activityRequirementBindingDefinitions.add(new ActivityRequirementBindingDefinition(((ActivityDefinition) activityDefinitions.toArray()[2]).getId(), ((ActivityDefinition) activityDefinitions.toArray()[3]).getId(), //$NON-NLS-1$
        sourceId));
    }
...
*/
    private void populateActivityPatternBindingDefinitions() {
        for (int index = 0; index < activityDefinitions.size(); index++) {
            activityPatternBindingDefinitions.add(new ActivityPatternBindingDefinition(((ActivityDefinition) activityDefinitions.toArray()[index]).getId(), //$NON-NLS-1$
            "org.eclipse.pattern" + Integer.toString(index + 1), sourceId));
        }
    }
...
*/
    private void populateCategoryActivityBindingDefinitions() {
        ...
        for (int index = 1; index <= categoryDefinitions.size(); index++) {
            categoryActivityBindingDefinitions.add(new CategoryActivityBindingDefinition(//$NON-NLS-1$
            "org.eclipse.activity" + Integer.toString(counter), //$NON-NLS-1$
            "org.eclipse.category" + Integer.toString(index), sourceId));
            counter++;
            categoryActivityBindingDefinitions.add(new CategoryActivityBindingDefinition(//$NON-NLS-1$
            "org.eclipse.activity" + Integer.toString(counter), //$NON-NLS-1$
            "org.eclipse.category" + Integer.toString(index), sourceId));
...
*/
    private void populateActivityDefinitions() {
        ...
        for (int index = 1; index <= categoryDefinitions.size() * 3; index++) {
            ...
            activityDefinitions.add(new ActivityDefinition("org.eclipse.activity" + stringToAppend, //$NON-NLS-1$ //$NON-NLS-2$
            "Activity " + stringToAppend, sourceId, //$NON-NLS-1$
            "description"));
        }
    }
...
*/
    private void populateCategoryDefinitions() {
        ...
        for (int index = 1; index <= 6; index++) {
            stringToAppend = Integer.toString(index);
            categoryDefinitions.add(new CategoryDefinition("org.eclipse.category" + stringToAppend, //$NON-NLS-1$ //$NON-NLS-2$
            "Category " + stringToAppend, sourceId, //$NON-NLS-1$
            "description"));
        }
    }
...
*/
    public void addActivity(String activityId, String activityName) {
        activityDefinitions.add(new ActivityDefinition(activityId, activityName, sourceId, //$NON-NLS-1$
        "description"));
...
*/
    public void removeActivity(String activityId, String activityName) {
        activityDefinitions.remove(new ActivityDefinition(activityId, activityName, sourceId, //$NON-NLS-1$
        "description"));
        fireActivityRegistryChanged();
    }
...
*/
    public void addCategory(String categoryId, String categoryName) {
        categoryDefinitions.add(new CategoryDefinition(categoryId, categoryName, sourceId, //$NON-NLS-1$
        "description"));
        fireActivityRegistryChanged();
    }
...
*/
    public void removeCategory(String categoryId, String categoryName) {
        categoryDefinitions.remove(new CategoryDefinition(categoryId, categoryName, sourceId, //$NON-NLS-1$
        "description"));
        fireActivityRegistryChanged();
    }
...
*/
    public void removeActivityRequirementBinding(String childId, String parentId) {
        activityRequirementBindingDefinitions.remove(new ActivityRequirementBindingDefinition(childId, parentId, sourceId));
        fireActivityRegistryChanged();
    }
...
*            The category id.
*/
    public void removeCategoryActivityBinding(String activityId, String categoryId) {
        categoryActivityBindingDefinitions.remove(new CategoryActivityBindingDefinition(activityId, categoryId, sourceId));
        fireActivityRegistryChanged();
    }
...
*/
    public void updateCategoryDescription(String categoryId, String categoryDescription) {
...
*/
    public void updateActivityDescription(String activityId, String activityDescription) {
...
*/
    public void removeActivityPatternBinding(String pattern) {
        ...
        for (Iterator i = activityPatternBindingDefinitions.iterator(); i.hasNext(); ) {
