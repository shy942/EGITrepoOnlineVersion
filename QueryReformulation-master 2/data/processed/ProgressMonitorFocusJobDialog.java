...
*/
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        Button runInWorkspace = createButton(parent, IDialogConstants.CLOSE_ID, ProgressMessages.ProgressMonitorFocusJobDialog_RunInBackgroundButton, true);
...
*/
            private void runAsync(final Runnable runnable) {
                ...
                display.asyncExec(new Runnable() {
                    ...
                    public void run() {
                        if (alreadyClosed) {
                            // Check again as the async may come too
                            return;
                        // late
                        }
...
*/
    ...
    protected void createExtendedDialogArea(Composite parent) {
        showDialog = WorkbenchPlugin.getDefault().getPreferenceStore().getBoolean(IPreferenceConstants.RUN_IN_BACKGROUND);
    ...
    public boolean close() {
        if (getReturnCode() != CANCEL)
            WorkbenchPlugin.getDefault().getPreferenceStore().setValue(IPreferenceConstants.RUN_IN_BACKGROUND, showDialog);
        return super.close();
    }
}
