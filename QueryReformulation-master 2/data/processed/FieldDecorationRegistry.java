...
*/
    static {
        ...
        imageRegistry.put(IMG_DEC_FIELD_CONTENT_PROPOSAL, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/contassist_ovr.png"));
        imageRegistry.put(IMG_DEC_FIELD_ERROR, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/error_ovr.png"));
        imageRegistry.put(IMG_DEC_FIELD_WARNING, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/warn_ovr.png"));
        imageRegistry.put(IMG_DEC_FIELD_REQUIRED, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/required_field_cue.png"));
        imageRegistry.put(IMG_DEC_FIELD_ERROR_QUICKFIX, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/errorqf_ovr.png"));
        imageRegistry.put(IMG_DEC_FIELD_INFO, ImageDescriptor.createFromFile(FieldDecorationRegistry.class, //$NON-NLS-1$
        "images/info_ovr.png"));
        // Define the standard decorations. Some do not have standard
        // descriptions. Use null in these cases.
        getDefault().registerFieldDecoration(DEC_CONTENT_PROPOSAL, JFaceResources.getString(//$NON-NLS-1$
        "FieldDecorationRegistry.contentAssistMessage"), IMG_DEC_FIELD_CONTENT_PROPOSAL, imageRegistry);
        getDefault().registerFieldDecoration(DEC_ERROR, JFaceResources.getString(//$NON-NLS-1$
        "FieldDecorationRegistry.errorMessage"), IMG_DEC_FIELD_ERROR, imageRegistry);
        getDefault().registerFieldDecoration(DEC_ERROR_QUICKFIX, JFaceResources.getString(//$NON-NLS-1$
        "FieldDecorationRegistry.errorQuickFixMessage"), IMG_DEC_FIELD_ERROR_QUICKFIX, imageRegistry);
        ...
        getDefault().registerFieldDecoration(DEC_REQUIRED, JFaceResources.getString(//$NON-NLS-1$
        "FieldDecorationRegistry.requiredFieldMessage"), IMG_DEC_FIELD_REQUIRED, imageRegistry);
    }
...
*/
    public void registerFieldDecoration(String id, String description, String imageId) {
        decorations.put(id, new Entry(description, imageId, JFaceResources.getImageRegistry()));
