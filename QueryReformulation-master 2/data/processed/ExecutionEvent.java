...
*/
    @Deprecated
    public  ExecutionEvent(@SuppressWarnings("rawtypes") final Map parameters, final Object trigger, final Object applicationContext) {
...
*/
    ...
    public  ExecutionEvent(final Command command, @SuppressWarnings("rawtypes") final Map parameters, final Object trigger, final Object applicationContext) {
        if (parameters == null) {
            //$NON-NLS-1$
