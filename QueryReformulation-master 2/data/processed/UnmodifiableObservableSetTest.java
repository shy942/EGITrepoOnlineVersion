...
public class UnmodifiableObservableSetTest extends AbstractDefaultRealmTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        unmodifiable = (UnmodifiableObservableSet) Observables.unmodifiableObservableSet(mutable);
    }
...
*/
    ...
    private static class Delegate extends AbstractObservableCollectionContractDelegate {
        ...
        public IObservableCollection createObservableCollection(Realm realm, int elementCount) {
            IObservableSet backingList = new WritableSet(realm, new HashSet(), elementType);
            IObservableSet result = new UnmodifiableObservableSetStub(backingList);
            for (int i = 0; i < elementCount; i++) backingList.add(createElement(result));
            return result;
        }
