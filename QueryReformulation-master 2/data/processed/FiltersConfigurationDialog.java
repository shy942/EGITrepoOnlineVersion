...
*/
    private IDialogSettings getDialogSettings() {
        IDialogSettings settings = IDEWorkbenchPlugin.getDefault().getDialogSettings().getSection(this.getClass().getName());
        if (settings == null) {
            settings = IDEWorkbenchPlugin.getDefault().getDialogSettings().addNewSection(this.getClass().getName());
        }
        return settings;
    }
...
*/
    ...
    protected void performDefaults() {
        ...
        configsTable.refresh();
        configsTable.setSelection(new StructuredSelection(filterGroups.size() > 1 ? filterGroups.iterator().next() : new Object[0]));
