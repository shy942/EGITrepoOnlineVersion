...
class Overlay {
    ...
    public class OutlineRegion extends Adornment {
        ...
        public void updateRegion(Region region) {
            outerRect = new Rectangle(innerRect.x - width, innerRect.y - width, innerRect.width + (2 * width), innerRect.height + (2 * width));
    ...
    public  Overlay(Shell shell) {
        ...
        overlayShell.setBackground(baseShell.getDisplay().getSystemColor(SWT.COLOR_DARK_GREEN));
