...
/* package */
class StatusLine extends Composite implements IProgressMonitor {
    ...
    protected static ImageDescriptor fgStopImage = ImageDescriptor.createFromFile(StatusLine.class, //$NON-NLS-1$
    "images/stop.png");

    private MenuItem copyMenuItem;

    static {
        JFaceResources.getImageRegistry().put("org.eclipse.jface.parts.StatusLine.stopImage", //$NON-NLS-1$
        fgStopImage);
    }
...
*/
    public class StatusLineLayout extends Layout {
        ...
        public void layout(Composite composite, boolean flushCache) {
            ...
            // make the first StatusLabel wider
            ws[0] += diff;
...
*/
                if (w == fProgressBarComposite && !fProgressIsVisible || w == fToolBar && !fCancelButtonIsVisible) {
...
*/
    public  StatusLine(Composite parent, int style) {
        ...
        // SWT.SHADOW_IN);
        fMessageLabel = new CLabel(this, SWT.NONE);
        ...
        //$NON-NLS-1$
        copyMenuItem.setText(JFaceResources.getString("copy"));
        ...
        fCancelButton.setToolTipText(JFaceResources.getString(//$NON-NLS-1$
...
*/
    ...
    public void subTask(String name) {
        ...
        if (fTaskName == null || fTaskName.length() == 0) {
            ...
            //$NON-NLS-1$
            text = JFaceResources.format("Set_SubTask", fTaskName, newName);
        }
        setMessage(text);
    }
