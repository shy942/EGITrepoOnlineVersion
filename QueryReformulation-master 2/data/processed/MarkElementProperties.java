...
*/
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        ...
        descriptor = new PropertyDescriptor(PROPERTY_LINECOUNT, MessageUtil.getString(//$NON-NLS-1$
        "Line_count"));
        propertyDescriptors[0] = descriptor;
        descriptor = new PropertyDescriptor(PROPERTY_START, MessageUtil.getString(//$NON-NLS-1$
        "Title_start"));
        propertyDescriptors[1] = descriptor;
        descriptor = new PropertyDescriptor(PROPERTY_LENGTH, MessageUtil.getString(//$NON-NLS-1$
        "Title_length"));
