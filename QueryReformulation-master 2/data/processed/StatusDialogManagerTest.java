...
public class StatusDialogManagerTest extends TestCase {
    ...
    public void testCheckingForMessageDuplication1() {
        ...
        assertEquals(status.getException().getClass().getName(), StatusDialogUtil.getTitleLabel().getText());
...
*/
    public void testWithStatusAdapter2() {
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_1, TITLE), false);
        Label titleLabel = StatusDialogUtil.getTitleLabel();
        assertNotNull(titleLabel);
...
*/
    public void testWithStatusAdapter3() {
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_1, NPE_WITH_MESSAGE), false);
        Label titleLabel = StatusDialogUtil.getTitleLabel();
        assertNotNull(titleLabel);
        assertEquals(MESSAGE_1, titleLabel.getText());
        Label secondaryLabel = StatusDialogUtil.getSingleStatusLabel();
...
*/
    public void testWithStatusAdapter5() {
        ...
        StatusAdapter statusAdapter = new StatusAdapter(new Status(IStatus.ERROR, "testplugin", message));
        Job job = new Job("job") {
...
*/
    public void testWithStatusAdapter6() {
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_1, JOB_NAME, ACTION_NAME), false);
        Label titleLabel = StatusDialogUtil.getTitleLabel();
        assertNotNull(titleLabel);
...
*/
    public void testList3() {
        ...
        StatusAdapter sa2 = createStatusAdapter(MESSAGE_2, JOB_NAME, ACTION_NAME);
    ...
    public void testBug260937() {
        WorkbenchStatusDialogManager wsdm = new WorkbenchStatusDialogManager(IStatus.CANCEL, null);
        StatusAdapter sa = createStatusAdapter(MESSAGE_1);
        try {
            wsdm.addStatusAdapter(sa, false);
            assertTrue(true);
    ...
    public void testOKStatus1() {
        ...
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_1), false);
        assertEquals("Only one status should be visible (OK should be ignored)", 1, wsdm.getStatusAdapters().size());
    }
    ...
    public void testBug278965_1() {
        ...
        assertFalse("Link to error log should not be disposed", errorLogLink.isDisposed());
        assertTrue("Link to error log should be enabled", errorLogLink.isEnabled());
        assertTrue("Link to error log should be visible", errorLogLink.isVisible());
    }
    ...
    public void testBug278965_2() {
        ...
        assertEquals(1, wsdm[0].getStatusAdapters().size());
        boolean status = StatusDialogUtil.getErrorLogLink() == null || StatusDialogUtil.getErrorLogLink().isDisposed() || !StatusDialogUtil.getErrorLogLink().isVisible();
    ...
    public void testIgnoringOpenTrayOnShow() {
        ...
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_1), false);
        WorkbenchStatusDialogManagerImpl manager = (WorkbenchStatusDialogManagerImpl) wsdm.getProperty(IStatusDialogConstants.MANAGER_IMPL);
        assertNull("Tray should not be opened", manager.getDialog().getTray());
        wsdm.addStatusAdapter(createStatusAdapter(MESSAGE_2, new NullPointerException()), false);
        Table table = StatusDialogUtil.getTable();
        selectTable(table, 1);
        processRemainingUiEvents();
...
*            element of this array.
*/
    private void openSupportArea(StatusAdapter statusAdapter, final StatusAdapter[] passed) {
        Point sizeBefore = StatusDialogUtil.getStatusShell().getSize();
...
*            array.
*/
    private void setupDetails(final StatusAdapter[] passed, final Composite[] details) {
...
*/
    private StatusAdapter createStatusAdapter(String message) {
        return new StatusAdapter(new Status(IStatus.ERROR, "org.eclipse.ui.tests", message));
    }
...
* @return created StatusAdapter
*/
    private StatusAdapter createStatusAdapter(String message, Throwable throwable) {
        return new StatusAdapter(new Status(IStatus.ERROR, "org.eclipse.ui.tests", message, throwable));
    }
...
* @return created StatusAdapter
*/
    private StatusAdapter createStatusAdapter(String message, String jobname, String actionName) {
...
*/
    ...
    protected void tearDown() throws Exception {
        ...
        if (shell != null) {
            shell.dispose();
            WorkbenchStatusDialogManagerImpl impl = (WorkbenchStatusDialogManagerImpl) wsdm.getProperty(IStatusDialogConstants.MANAGER_IMPL);
