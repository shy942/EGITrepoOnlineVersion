...
*            the index in the list.
*/
        public  ListElement(Composite parent, final ITabItem tab, int dynamicImageCount, int index) {
        ...
        if (children.length == 0) {
            ...
            for (int i = 0; i < children.length; i++) {
                ...
                if (tabToDynamicImageCountMap != null && tabToDynamicImageCountMap.containsKey(children[i])) {
                    dynamicImageCount = ((Integer) tabToDynamicImageCountMap.get(children[i])).intValue();
                }
                elements[i] = new ListElement(this, (ITabItem) children[i], dynamicImageCount, i);
...
*/
        ...
        if (tabToDynamicImageCountMap != null) {
            ...
            if (tabToDynamicImageCountMap.containsKey(tabItem)) {
                dynamicImageCount = ((Integer) tabToDynamicImageCountMap.get(tabItem)).intValue();
            }
...
*/
        defaultGradientStart = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.defaultTabGradientStart", FormColors.blend(widgetBackground.getRGB(), FormColors.blend(white, widgetNormalShadow.getRGB(), 20), 60));
        defaultGradientEnd = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.defaultTabGradientEnd", FormColors.blend(widgetBackground.getRGB(), widgetNormalShadow.getRGB(), 40));
        navigationElementShadowStroke = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.shadowStroke", FormColors.blend(white, widgetNormalShadow.getRGB(), 55));
        bottomNavigationElementShadowStroke1 = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.tabShadowStroke1", FormColors.blend(black, widgetBackground.getRGB(), 10));
        bottomNavigationElementShadowStroke2 = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.tabShadowStroke2", FormColors.blend(black, widgetBackground.getRGB(), 5));
        /*
...
* 10%
*/
        hoverGradientStart = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.hoverBackgroundGradientStart", FormColors.blend(white, widgetBackground.getRGB(), 20));
        hoverGradientEnd = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.hoverBackgroundGradientEnd", FormColors.blend(widgetNormalShadow.getRGB(), widgetBackground.getRGB(), 10));
        indentedDefaultBackground = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.indentedDefaultBackground", FormColors.blend(white, widgetBackground.getRGB(), 10));
        indentedHoverBackground = factory.getColors().createColor(//$NON-NLS-1$
        "TabbedPropertyList.indentedHoverBackground", FormColors.blend(white, widgetBackground.getRGB(), 75));
    }
...
*/
    private int getTabHeight() {
        //$NON-NLS-1$
        int tabHeight = getTextDimension("").y + INDENT;
