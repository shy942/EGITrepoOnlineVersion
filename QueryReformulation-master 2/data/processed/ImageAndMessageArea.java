    ...
    public  ImageAndMessageArea(Composite parent, int style) {
        ...
        setLayout(new Layout() {
            ...
            public void layout(Composite parent, boolean changed) {
                ...
                container.setBounds(carea.x + BORDER_MARGIN, carea.y + BORDER_MARGIN, carea.width - (2 * BORDER_MARGIN), carea.height - (2 * BORDER_MARGIN));
            }
...
*/
    public void setImage(Image image) {
        ...
        //$NON-NLS-1$
        registry.registerFieldDecoration("messageImage", null, image);
        messageField.addFieldDecoration(registry.getFieldDecoration(//$NON-NLS-1$
        "messageImage"), SWT.LEFT | SWT.TOP, false);
    }
