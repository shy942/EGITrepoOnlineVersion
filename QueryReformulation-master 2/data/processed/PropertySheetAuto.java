...
*/
    private class Car implements IPropertySource {
        ...
        public  Car(int carModelYear, RGB carColor, String carManufacturer, String carModel, double carEngineSize) {
...
*/
    ...
    protected IWorkbenchPart createTestParts(IWorkbenchPage page) throws Throwable {
...
*/
    public void testInput() throws Throwable {
        ...
        assertTrue("'Selection provider' view should be visible", activePage.isPartVisible(selectionProviderView));
...
*/
    public void XtestInputIfHiddenBug69953() throws Throwable {
        ...
        for (int i = 0; i < NUMBER_OF_SELECTIONS; i++) {
            ...
            selectionProviderView.setSelection(structuredSelection);
            processUiEvents();
            assertNull("Selection should be null in properties view", propView.getShowInContext().getSelection());
        }
    }
...
*/
    ...
    private void assertViewsVisibility1(PropertySheet propView, IViewPart projectExplorer) {
        processUiEvents();
        assertFalse("'Property' view should be hidden", activePage.isPartVisible(propView));
        assertTrue("'Project Explorer' view should be visible", activePage.isPartVisible(projectExplorer));
        assertTrue("'Selection provider' view should be visible", activePage.isPartVisible(selectionProviderView));
    }
    ...
    private void assertViewsVisibility2(PropertySheet propView, IViewPart projectExplorer) {
        processUiEvents();
        assertTrue("'Property' view should be visible", activePage.isPartVisible(propView));
        assertFalse("'Project Explorer' view should be hidden", activePage.isPartVisible(projectExplorer));
        assertTrue("'Selection provider' view should be visible", activePage.isPartVisible(selectionProviderView));
    }
