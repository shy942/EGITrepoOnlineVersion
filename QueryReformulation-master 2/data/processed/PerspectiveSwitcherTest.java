...
public class PerspectiveSwitcherTest extends UITestCase {
    ...
    protected void doSetUp() throws Exception {
        ...
        originalShowOpenValue = apiPreferenceStore.getBoolean(IWorkbenchPreferenceConstants.SHOW_OPEN_ON_PERSPECTIVE_BAR);
        originalPerspectiveBarPosition = apiPreferenceStore.getString(IWorkbenchPreferenceConstants.DOCK_PERSPECTIVE_BAR);
    }
...
*/
    public void testCreateBarManagerBug274486() {
        ...
        if (IWorkbenchPreferenceConstants.TOP_RIGHT.equals(originalPerspectiveBarPosition) || IWorkbenchPreferenceConstants.TOP_LEFT.equals(originalPerspectiveBarPosition)) {
            ...
            "The current perspective bar position is unknown: " + originalPerspectiveBarPosition);
        }
        WorkbenchWindow window = (WorkbenchWindow) fWorkbench.getActiveWorkbenchWindow();
        assertNotNull(//$NON-NLS-1$
        "We should have a perspective bar in the beginning", getPerspectiveSwitcher(window));
        ...
        assertNotNull(//$NON-NLS-1$
        "The perspective bar should have been created successfully", getPerspectiveSwitcher(window));
    }
