...
public class Snippet070GenericSelectionDialog {
    ...
    public  Snippet070GenericSelectionDialog(final Shell shell) {
        ...
        GenericSelectionDialog genericSelectionDialog = new GenericSelectionDialog(shell, models, models.get(0), "SelectionDialog with generics", "Select one or more of the Model elements");
...
*            shell message
*/
        public  GenericSelectionDialog(Shell shell, Collection<Model> models, Model initialSelection, String shellTitle, String shellMessage) {
            super(shell);
        ...
        protected Control createDialogArea(Composite parent) {
            ...
            listViewer.setLabelProvider(new LabelProvider() {
                ...
                public String getText(Object element) {
                    //$NON-NLS-1$
                    return element == null ? "" : ((Model) element).getName();
                }
            });
