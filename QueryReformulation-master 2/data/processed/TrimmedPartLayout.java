...
*/
    ...
    protected void layout(Composite composite, boolean flushCache) {
        ...
        if (top != null && top.isVisible()) {
            ...
            Rectangle newBounds = new Rectangle(ca.x, ca.y, caRect.width, topSize.y);
        ...
        if (bottom != null && bottom.isVisible()) {
            Point bottomSize = bottom.computeSize(caRect.width, SWT.DEFAULT, true);
            caRect.height -= bottomSize.y;
            // Don't layout unless we've changed
            Rectangle newBounds = new Rectangle(caRect.x, caRect.y + caRect.height, caRect.width, bottomSize.y);
        ...
        if (left != null && left.isVisible()) {
            ...
            // Don't layout unless we've changed
            Rectangle newBounds = new Rectangle(caRect.x - leftSize.x, caRect.y, leftSize.x, caRect.height);
        ...
        if (right != null && right.isVisible()) {
            Point rightSize = right.computeSize(SWT.DEFAULT, caRect.height, true);
            caRect.width -= rightSize.x;
            // Don't layout unless we've changed
            Rectangle newBounds = new Rectangle(caRect.x + caRect.width, caRect.y, rightSize.x, caRect.height);
