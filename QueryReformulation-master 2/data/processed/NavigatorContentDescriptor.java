...
*/
    ...
    // FIXME: will replace 'overridingExtensions' in 3.6
...
*/
    public ITreeContentProvider createContentProvider() throws CoreException {
        if (Policy.DEBUG_EXTENSION_SETUP)
            //$NON-NLS-1$
            System.out.println("createContentProvider: " + this);
...
*/
    public ILabelProvider createLabelProvider() throws CoreException {
        if (Policy.DEBUG_EXTENSION_SETUP)
            //$NON-NLS-1$
            System.out.println("createLabelProvider: " + this);
...
*/
    ...
    public String toString() {
        ...
        return "Content[" + id + "(" + sequenceNumber + ") " + ", \"" + name + "\"]";
    }
