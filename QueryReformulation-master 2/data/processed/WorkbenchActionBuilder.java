...
public final class WorkbenchActionBuilder extends ActionBarAdvisor {
    ...
    // Incremental workspace build
    private IWorkbenchAction buildAllAction;
...
*/
    private MenuManager createNavigateMenu() {
        ...
        {
            MenuManager showInSubMenu = new MenuManager(IDEWorkbenchMessages.Workbench_showIn, //$NON-NLS-1$
            "showIn");
...
*/
    private MenuManager addPerspectiveActions() {
        MenuManager menu = new MenuManager(IDEWorkbenchMessages.Workbench_perspective, IWorkbenchActionConstants.M_PERSPECTIVE);
...
*/
    ...
    protected void makeActions(final IWorkbenchWindow window) {
        ...
        if (Util.isCocoa()) {
            CommandContributionItemParameter minimizeParam = new CommandContributionItemParameter(window, null, "org.eclipse.ui.cocoa.minimizeWindow", //$NON-NLS-1$
            CommandContributionItem.STYLE_PUSH);
            minimizeItem = new CommandContributionItem(minimizeParam);
            CommandContributionItemParameter zoomParam = new CommandContributionItemParameter(window, null, "org.eclipse.ui.cocoa.zoomWindow", //$NON-NLS-1$
            CommandContributionItem.STYLE_PUSH);
            zoomItem = new CommandContributionItem(zoomParam);
            CommandContributionItemParameter fullscreenParam = new CommandContributionItemParameter(window, null, "org.eclipse.ui.cocoa.fullscreenWindow", //$NON-NLS-1$
            CommandContributionItem.STYLE_PUSH);
            fullscreenItem = new CommandContributionItem(fullscreenParam);
            CommandContributionItemParameter arrangeWindowsParam = new CommandContributionItemParameter(window, null, "org.eclipse.ui.cocoa.arrangeWindowsInFront", //$NON-NLS-1$
            CommandContributionItem.STYLE_PUSH);
...
*/
    ...
    private IContributionItem getResetPerspectiveItem() {
        return getItem(ActionFactory.RESET_PERSPECTIVE.getId(), ActionFactory.RESET_PERSPECTIVE.getCommandId(), null, null, WorkbenchMessages.ResetPerspective_text, WorkbenchMessages.ResetPerspective_toolTip, IWorkbenchHelpContextIds.RESET_PERSPECTIVE_ACTION);
    }

    private IContributionItem getSavePerspectiveItem() {
        return getItem(ActionFactory.SAVE_PERSPECTIVE.getId(), ActionFactory.SAVE_PERSPECTIVE.getCommandId(), null, null, WorkbenchMessages.SavePerspective_text, WorkbenchMessages.SavePerspective_toolTip, IWorkbenchHelpContextIds.SAVE_PERSPECTIVE_ACTION);
    }
    ...
    private IContributionItem getItem(String actionId, String commandId, String image, String disabledImage, String label, String tooltip, String helpContextId) {
        ...
        CommandContributionItemParameter commandParm = new CommandContributionItemParameter(getWindow(), actionId, commandId, null, sharedImages.getImageDescriptor(image), sharedImages.getImageDescriptor(disabledImage), null, label, null, tooltip, CommandContributionItem.STYLE_PUSH, null, false);
