...
public class ImageResource {
    ...
    //$NON-NLS-1$
    private static final String URL_CLCL = URL_PREFIX + "clcl16/";

    //$NON-NLS-1$
    private static final String URL_ELCL = URL_PREFIX + "elcl16/";

    //$NON-NLS-1$
    private static final String URL_DLCL = URL_PREFIX + "dlcl16/";

    //$NON-NLS-1$
    private static final String URL_OBJ = URL_PREFIX + "obj16/";
...
*/
    protected static void initializeImageRegistry() {
        ...
        for (int i = 0; i < 13; i++) {
            ...
            registerImage("busy" + i, URL_OBJ + "busy/" + (i + 1) + ".gif");
            //$NON-NLS-1$
