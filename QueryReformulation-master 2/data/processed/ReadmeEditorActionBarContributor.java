...
public class ReadmeEditorActionBarContributor extends BasicTextEditorActionContributor {
    ...
    class EditorAction extends Action {
        ...
        public void run() {
            ...
            MessageUtil.getString("Readme_Editor"), MessageUtil.format("ReadmeEditorActionExecuted", //$NON-NLS-1$
...
*/
    public  ReadmeEditorActionBarContributor() {
        ...
        action2 = new RetargetAction(IReadmeConstants.RETARGET2, MessageUtil.getString(//$NON-NLS-1$
        "Editor_Action2"));
        //$NON-NLS-1$
        ...
        action3 = new LabelRetargetAction(IReadmeConstants.LABELRETARGET3, //$NON-NLS-1$
        MessageUtil.getString("Editor_Action3"));
        ...
        //$NON-NLS-1$
        handler3.setToolTipText(MessageUtil.getString("Readme_Editor_Action3"));
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        MenuManager readmeMenu = new MenuManager(MessageUtil.getString(//$NON-NLS-1$
        "Readme_Menu"));
