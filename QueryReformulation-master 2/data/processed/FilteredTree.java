...
*/
    static {
        ImageDescriptor descriptor = AbstractUIPlugin.imageDescriptorFromPlugin(PlatformUI.PLUGIN_ID, //$NON-NLS-1$
        "$nl$/icons/full/etool16/clear_co.png");
        if (descriptor != null) {
            JFaceResources.getImageRegistry().put(CLEAR_ICON, descriptor);
        }
        descriptor = AbstractUIPlugin.imageDescriptorFromPlugin(PlatformUI.PLUGIN_ID, //$NON-NLS-1$
...
*/
    private void createClearTextOld(Composite parent) {
        ...
        if ((filterText.getStyle() & SWT.ICON_CANCEL) == 0) {
            ...
            IAction clearTextAction = new //$NON-NLS-1$
            Action(//$NON-NLS-1$
            "", //$NON-NLS-1$
