...
*/
    ...
    protected void pageChange(int newPageIndex) {
        ...
        if (oldPageIndex != -1 && pages.size() > oldPageIndex && pages.get(oldPageIndex) instanceof IFormPage && oldPageIndex != newPageIndex) {
            // Check the old page
        ...
        if (oldPageIndex != -1 && pages.size() > oldPageIndex && newPageIndex != oldPageIndex && pages.get(oldPageIndex) instanceof IFormPage)
...
*/
    ...
    protected void setActivePage(int pageIndex) {
        ...
        if (pages.size() > pageIndex && pages.get(pageIndex) instanceof IFormPage) {
...
*/
    protected void updateActionBarContributor(int pageIndex) {
        ...
        if (contributor != null && contributor instanceof MultiPageEditorActionBarContributor) {
            ((MultiPageEditorActionBarContributor) contributor).setActivePage(getEditor(pageIndex));
        }
    }
