...
public class GradientTest extends CSSSWTTestCase {
    ...
    public void testGradients() {
        ...
        //gradient begin
        assertEquals(RED, getSelectionBackgroundBegin(folderToTest).getRGB());
        //gradient end
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
    }
    ...
    public void testDefaultPercents() {
        ...
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
        // default
        assertArrayEquals(new int[] { 100 }, getSelectionGradientPercents(folderToTest));
    // percent
    }

    @Test
    public void testDefaultManyPercents() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: red green blue yellow}");
        // default
        assertArrayEquals(new int[] { 33, 67, 100 }, getSelectionGradientPercents(folderToTest));
    // percent
    }

    @Test
    public void testSpecifiedPercents() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: #FF0000 #0000FF 53%}");
        assertArrayEquals(new int[] { 53 }, getSelectionGradientPercents(folderToTest));
    }

    @Test
    public void testManyColorsAndSpecifiedManyPercents() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: #FF0000 #00FF00 #0000FF 22% 44%}");
        //gradient begin
        assertEquals(RED, getSelectionBackgroundBegin(folderToTest).getRGB());
        //2nd gradient
        assertEquals(GREEN, getSelectionBackground(folderToTest, 1).getRGB());
        //gradient end
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
...
*/
    ...
    public void testBadPercents() {
        ...
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: red green blue yellow 10%}");
        // default
        assertArrayEquals(new int[] { 33, 67, 100 }, getSelectionGradientPercents(folderToTest));
    // percent
    }
...
*/
    ...
    public void testBadColors() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: #FF0000 notAColor #0000FF}");
        //gradient begin
        assertEquals(RED, getSelectionBackgroundBegin(folderToTest).getRGB());
        //gradient end
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
...
*/
    ...
    public void testAboveRangePercents() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: #FF0000 #00FF00 #0000FF 20% 110%}");
        //gradient begin
        assertEquals(RED, getSelectionBackgroundBegin(folderToTest).getRGB());
        //gradient end
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
        // default
        assertArrayEquals(new int[] { 50, 100 }, getSelectionGradientPercents(folderToTest));
    // percent
    }
...
*/
    ...
    public void testBelowRangePercents() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: #FF0000 #00FF00 #0000FF -20% 50%}");
        //gradient begin
        assertEquals(RED, getSelectionBackgroundBegin(folderToTest).getRGB());
        //gradient end
        assertEquals(BLUE, folderToTest.getSelectionBackground().getRGB());
...
*/
    ...
    public void testAltSyntax() {
        CTabFolder folderToTest = createTestCTabFolder("CTabItem:selected { background-color: gradient, rgb(140,140,140), rgb(48,48,48), 100%;");
        //gradient begin
        assertEquals(new RGB(140, 140, 140), getSelectionBackgroundBegin(folderToTest).getRGB());
        //gradient end
        assertEquals(new RGB(48, 48, 48), folderToTest.getSelectionBackground().getRGB());
        // default
        assertArrayEquals(new int[] { 100 }, getSelectionGradientPercents(folderToTest));
    // percent
    }
