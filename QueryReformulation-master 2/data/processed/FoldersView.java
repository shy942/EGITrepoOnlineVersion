...
public class FoldersView extends ViewPart {
    ...
    private class ViewLabelProvider extends LabelProvider implements IFontProvider, IColorProvider {
        ...
        public Image getImage(Object elem) {
            ...
            return sharedImages.getImage(isFolderType(elem) ? ISharedImages.IMG_OBJ_ELEMENT : ISharedImages.IMG_OBJ_FOLDER);
        }

        @Override
        public Font getFont(Object element) {
            return isFolderType(element) ? Theme.getFont(Theme.FoldersView.FOLDER_TYPE_FONT) : Theme.getFont(Theme.FoldersView.MAILBOX_NAME_FONT);
        }

        private boolean isFolderType(Object elem) {
            return elem instanceof TreeItem && ((TreeItem) elem).getValue() instanceof FolderType;
        }

        @Override
        public Color getForeground(Object element) {
            return isFolderType(element) ? Theme.getColor(Theme.FoldersView.FOLDER_TYPE_FOREGROUND) : Theme.getColor(Theme.FoldersView.MAILBOX_NAME_FOREGROUND);
        }
