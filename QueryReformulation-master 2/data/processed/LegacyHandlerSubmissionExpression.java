...
*/
    public  LegacyHandlerSubmissionExpression(final String activePartId, final Shell activeShell, final IWorkbenchPartSite activeSite) {
...
*/
    ...
    public final boolean equals(final Object object) {
        if (object instanceof LegacyHandlerSubmissionExpression) {
            ...
            return equals(this.activePartId, that.activePartId) && equals(this.activeShell, that.activeShell) && equals(this.activeSite, that.activeSite);
        }
        return false;
    }
...
*/
    ...
    public final String toString() {
        ...
        //$NON-NLS-1$
        buffer.append("LegacyHandlerSubmission(");
