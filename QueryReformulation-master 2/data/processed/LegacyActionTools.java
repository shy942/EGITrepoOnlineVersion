    ...
    private static String getModifierString(int keyCode) {
        ...
        if ((keyCode & SWT.ALT) != 0) {
            if (modString.equals("")) {
                ...
                modString = modString + "+" + //$NON-NLS-1$
                findModifierString(keyCode & SWT.ALT);
            }
        }
        if ((keyCode & SWT.SHIFT) != 0) {
            if (modString.equals("")) {
                ...
                modString = modString + "+" + //$NON-NLS-1$
                findModifierString(keyCode & SWT.SHIFT);
            }
        }
        if ((keyCode & SWT.COMMAND) != 0) {
            if (modString.equals("")) {
                ...
                modString = modString + "+" + //$NON-NLS-1$
                findModifierString(keyCode & SWT.COMMAND);
            }
        }
        return modString;
    }
...
*/
    private static final void initKeyCodes() {
        ...
        //$NON-NLS-1$
        keyCodes.put("BACKSPACE", Integer.valueOf(8));
        //$NON-NLS-1$
        keyCodes.put("TAB", Integer.valueOf(9));
        //$NON-NLS-1$
        keyCodes.put("RETURN", Integer.valueOf(13));
        //$NON-NLS-1$
        keyCodes.put("ENTER", Integer.valueOf(13));
        //$NON-NLS-1$
        keyCodes.put("ESCAPE", Integer.valueOf(27));
        //$NON-NLS-1$
        keyCodes.put("ESC", Integer.valueOf(27));
        //$NON-NLS-1$
        keyCodes.put("DELETE", Integer.valueOf(127));
        //$NON-NLS-1$
        keyCodes.put("SPACE", Integer.valueOf(' '));
        //$NON-NLS-1$
        keyCodes.put("ARROW_UP", Integer.valueOf(SWT.ARROW_UP));
        //$NON-NLS-1$
        keyCodes.put("ARROW_DOWN", Integer.valueOf(SWT.ARROW_DOWN));
        //$NON-NLS-1$
        keyCodes.put("ARROW_LEFT", Integer.valueOf(SWT.ARROW_LEFT));
        //$NON-NLS-1$
        keyCodes.put("ARROW_RIGHT", Integer.valueOf(SWT.ARROW_RIGHT));
        //$NON-NLS-1$
        keyCodes.put("PAGE_UP", Integer.valueOf(SWT.PAGE_UP));
        //$NON-NLS-1$
        keyCodes.put("PAGE_DOWN", Integer.valueOf(SWT.PAGE_DOWN));
        //$NON-NLS-1$
        keyCodes.put("HOME", Integer.valueOf(SWT.HOME));
        //$NON-NLS-1$
        keyCodes.put("END", Integer.valueOf(SWT.END));
        //$NON-NLS-1$
        keyCodes.put("INSERT", Integer.valueOf(SWT.INSERT));
        //$NON-NLS-1$
        keyCodes.put("F1", Integer.valueOf(SWT.F1));
        //$NON-NLS-1$
        keyCodes.put("F2", Integer.valueOf(SWT.F2));
        //$NON-NLS-1$
        keyCodes.put("F3", Integer.valueOf(SWT.F3));
        //$NON-NLS-1$
        keyCodes.put("F4", Integer.valueOf(SWT.F4));
        //$NON-NLS-1$
        keyCodes.put("F5", Integer.valueOf(SWT.F5));
        //$NON-NLS-1$
        keyCodes.put("F6", Integer.valueOf(SWT.F6));
        //$NON-NLS-1$
        keyCodes.put("F7", Integer.valueOf(SWT.F7));
        //$NON-NLS-1$
        keyCodes.put("F8", Integer.valueOf(SWT.F8));
        //$NON-NLS-1$
        keyCodes.put("F9", Integer.valueOf(SWT.F9));
        //$NON-NLS-1$
        keyCodes.put("F10", Integer.valueOf(SWT.F10));
        //$NON-NLS-1$
        keyCodes.put("F11", Integer.valueOf(SWT.F11));
        //$NON-NLS-1$
        keyCodes.put("F12", Integer.valueOf(SWT.F12));
        //$NON-NLS-1$
        keyCodes.put("F13", Integer.valueOf(SWT.F13));
        //$NON-NLS-1$
        keyCodes.put("F14", Integer.valueOf(SWT.F14));
        //$NON-NLS-1$
        keyCodes.put("F15", Integer.valueOf(SWT.F15));
        //$NON-NLS-1$
        keyCodes.put("F16", Integer.valueOf(SWT.F16));
        //$NON-NLS-1$
        keyCodes.put("F17", Integer.valueOf(SWT.F17));
        //$NON-NLS-1$
        keyCodes.put("F18", Integer.valueOf(SWT.F18));
        //$NON-NLS-1$
        keyCodes.put("F19", Integer.valueOf(SWT.F19));
        //$NON-NLS-1$
        keyCodes.put("F20", Integer.valueOf(SWT.F20));
    }
...
*/
    private static void initKeyStrings() {
        ...
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(8), JFaceResources.getString("Backspace"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(9), JFaceResources.getString("Tab"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(13), JFaceResources.getString("Return"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(13), JFaceResources.getString("Enter"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(27), JFaceResources.getString("Escape"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(27), JFaceResources.getString("Esc"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(127), JFaceResources.getString("Delete"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(' '), JFaceResources.getString("Space"));
        keyStrings.put(Integer.valueOf(SWT.ARROW_UP), JFaceResources.getString(//$NON-NLS-1$
        "Arrow_Up"));
        keyStrings.put(Integer.valueOf(SWT.ARROW_DOWN), JFaceResources.getString(//$NON-NLS-1$
        "Arrow_Down"));
        keyStrings.put(Integer.valueOf(SWT.ARROW_LEFT), JFaceResources.getString(//$NON-NLS-1$
        "Arrow_Left"));
        keyStrings.put(Integer.valueOf(SWT.ARROW_RIGHT), JFaceResources.getString(//$NON-NLS-1$
        "Arrow_Right"));
        keyStrings.put(Integer.valueOf(SWT.PAGE_UP), JFaceResources.getString(//$NON-NLS-1$
        "Page_Up"));
        keyStrings.put(Integer.valueOf(SWT.PAGE_DOWN), JFaceResources.getString(//$NON-NLS-1$
        "Page_Down"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.HOME), JFaceResources.getString("Home"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.END), JFaceResources.getString("End"));
        keyStrings.put(Integer.valueOf(SWT.INSERT), JFaceResources.getString(//$NON-NLS-1$
        "Insert"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F1), JFaceResources.getString("F1"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F2), JFaceResources.getString("F2"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F3), JFaceResources.getString("F3"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F4), JFaceResources.getString("F4"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F5), JFaceResources.getString("F5"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F6), JFaceResources.getString("F6"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F7), JFaceResources.getString("F7"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F8), JFaceResources.getString("F8"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F9), JFaceResources.getString("F9"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F10), JFaceResources.getString("F10"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F11), JFaceResources.getString("F11"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F12), JFaceResources.getString("F12"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F13), JFaceResources.getString("F13"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F14), JFaceResources.getString("F14"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F15), JFaceResources.getString("F15"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F16), JFaceResources.getString("F16"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F17), JFaceResources.getString("F17"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F18), JFaceResources.getString("F18"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F19), JFaceResources.getString("F19"));
        //$NON-NLS-1$
        keyStrings.put(Integer.valueOf(SWT.F20), JFaceResources.getString("F20"));
    }
...
*/
    private static void initLocalizedKeyCodes() {
        ...
        localizedKeyCodes.put(JFaceResources.getString("Backspace").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(8));
        localizedKeyCodes.put(JFaceResources.getString("Tab").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(9));
        localizedKeyCodes.put(JFaceResources.getString("Return").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(13));
        localizedKeyCodes.put(JFaceResources.getString("Enter").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(13));
        localizedKeyCodes.put(JFaceResources.getString("Escape").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(27));
        localizedKeyCodes.put(JFaceResources.getString("Esc").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(27));
        localizedKeyCodes.put(JFaceResources.getString("Delete").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(127));
        localizedKeyCodes.put(JFaceResources.getString("Space").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(' '));
        localizedKeyCodes.put(JFaceResources.getString("Arrow_Up").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.ARROW_UP));
        localizedKeyCodes.put(JFaceResources.getString("Arrow_Down").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.ARROW_DOWN));
        localizedKeyCodes.put(JFaceResources.getString("Arrow_Left").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.ARROW_LEFT));
        localizedKeyCodes.put(JFaceResources.getString("Arrow_Right").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.ARROW_RIGHT));
        localizedKeyCodes.put(JFaceResources.getString("Page_Up").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.PAGE_UP));
        localizedKeyCodes.put(JFaceResources.getString("Page_Down").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.PAGE_DOWN));
        localizedKeyCodes.put(JFaceResources.getString("Home").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.HOME));
        localizedKeyCodes.put(JFaceResources.getString("End").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.END));
        localizedKeyCodes.put(JFaceResources.getString("Insert").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.INSERT));
        localizedKeyCodes.put(JFaceResources.getString("F1").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F1));
        localizedKeyCodes.put(JFaceResources.getString("F2").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F2));
        localizedKeyCodes.put(JFaceResources.getString("F3").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F3));
        localizedKeyCodes.put(JFaceResources.getString("F4").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F4));
        localizedKeyCodes.put(JFaceResources.getString("F5").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F5));
        localizedKeyCodes.put(JFaceResources.getString("F6").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F6));
        localizedKeyCodes.put(JFaceResources.getString("F7").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F7));
        localizedKeyCodes.put(JFaceResources.getString("F8").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F8));
        localizedKeyCodes.put(JFaceResources.getString("F9").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F9));
        localizedKeyCodes.put(JFaceResources.getString("F10").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F10));
        localizedKeyCodes.put(JFaceResources.getString("F11").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F11));
        localizedKeyCodes.put(JFaceResources.getString("F12").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F12));
        localizedKeyCodes.put(JFaceResources.getString("F13").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F13));
        localizedKeyCodes.put(JFaceResources.getString("F14").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F14));
        localizedKeyCodes.put(JFaceResources.getString("F15").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F15));
        localizedKeyCodes.put(JFaceResources.getString("F16").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F16));
        localizedKeyCodes.put(JFaceResources.getString("F17").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F17));
        localizedKeyCodes.put(JFaceResources.getString("F18").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F18));
        localizedKeyCodes.put(JFaceResources.getString("F19").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F19));
        localizedKeyCodes.put(JFaceResources.getString("F20").toUpperCase(), //$NON-NLS-1$
        Integer.valueOf(SWT.F20));
    }
