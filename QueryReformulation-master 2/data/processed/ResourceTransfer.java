        ...
        try {
            ...
            if (count > MAX_RESOURCES_TO_TRANSFER) {
                ...
                if (Util.isLinux()) {
                    ...
                    "(use '-noclipboard' and '-nosetclipboard' arguments).";
                }
                IDEWorkbenchPlugin.log(message, new IllegalArgumentException(//$NON-NLS-1$
                "Maximum limit of resources to transfer is: " + MAX_RESOURCES_TO_TRANSFER));
                return null;
            }
...
*/
    private IResource readResource(DataInputStream dataIn) throws IOException {
        ...
        "Unknown resource type in ResourceTransfer.readResource");
    }
