...
*/
    Font calculateDefaultFont() {
        ...
        if (// can't do much without Display
        current == null)
    ...
    private FontRecord getFontRecord(String symbolicName) {
        ...
        if (fontRecord == null) {
            ...
            if (Display.getCurrent() == null) {
                ...
                // don't add it to the cache; if later asked from UI thread, a proper font will be created
                return fontRecord;
            }
        }
...
*/
    private FontData makeFontData(String value) throws MissingResourceException {
        try {
            ...
            throw new MissingResourceException("Wrong font data format. Value is: \"" + value + "\"", getClass().getName(), value);
        }
    }
...
*/
    private void readResourceBundle(ResourceBundle bundle, String bundleName) throws MissingResourceException {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (pos == -1) {
                stringToFontData.put(key, new FontData[] { makeFontData(bundle.getString(key)) });
            } else {
