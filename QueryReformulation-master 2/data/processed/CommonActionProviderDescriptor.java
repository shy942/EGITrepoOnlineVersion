...
*/
    public  CommonActionProviderDescriptor(IConfigurationElement aConfigElement, IConfigurationElement anEnablementExpression, Priority defaultPriority, String anOverrideId, boolean nestedUnderNavigatorContent) {
        super();
        Assert.isTrue(TAG_ACTION_PROVIDER.equals(aConfigElement.getName()));
        Assert.isTrue(TAG_POSSIBLE_CHILDREN.equals(anEnablementExpression.getName()) || TAG_ENABLEMENT.equals(anEnablementExpression.getName()));
        configurationElement = aConfigElement;
        pluginId = configurationElement.getContributor().getName();
...
*/
    ...
    protected boolean hasOverridingDescriptors() {
        return overridingDescriptors != null && !overridingDescriptors.isEmpty();
    }
...
*/
    ...
    public String toString() {
        if (toString == null) {
            ...
            toString = "CommonActionProviderDescriptor[definedId=" + getDefinedId() + ", visibilityId=" + getId() + ", dependsOn=" + getDependsOnId() + ", overrides=" + getOverridesId() + "]";
        }
        return toString;
    }
