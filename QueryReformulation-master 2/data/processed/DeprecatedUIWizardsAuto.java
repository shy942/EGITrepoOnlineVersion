...
public class DeprecatedUIWizardsAuto extends TestCase {
    ...
    private WizardDialog exportWizard(IWizardPage page) {
        ...
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IWorkbenchHelpContextIds.EXPORT_WIZARD });
        if (page != null) {
    ...
    private WizardDialog importWizard(IWizardPage page) {
        ...
        dialog.create();
        dialog.getShell().setSize(Math.max(SIZING_WIZARD_WIDTH, dialog.getShell().getSize().x), SIZING_WIZARD_HEIGHT);
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IWorkbenchHelpContextIds.IMPORT_WIZARD });
        if (page != null) {
            page.setWizard(wizard);
            dialog.showPage(page);
        }
...
*/
    ...
    public void testExportResources() {
        //reference: ExportResourcesAction
...
*/
    public void testImportResources() {
        //reference: ImportResourcesAction
...
*/
    public void testNewFile() {
        ...
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IIDEHelpContextIds.NEW_FILE_WIZARD });
        DialogCheck.assertDialogTexts(dialog, this);
    }
...
*/
    public void testNewFile2() {
        ...
        dialog.create();
        dialog.getShell().setText("CreateFileAction_title");
        WorkbenchHelp.setHelp(dialog.getShell(), IIDEHelpContextIds.NEW_FILE_WIZARD);
        DialogCheck.assertDialogTexts(dialog, this);
    }
    ...
    public void testNewFolder() {
        ...
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IIDEHelpContextIds.NEW_FOLDER_WIZARD });
        DialogCheck.assertDialogTexts(dialog, this);
    }
    ...
    public void testNewProjectPage1() {
        ...
        dialog.getShell().setText("CreateFileAction_title");
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IIDEHelpContextIds.NEW_PROJECT_WIZARD });
        DialogCheck.assertDialogTexts(dialog, this);
    }
    ...
    public void testNewProjectPage2() {
        ...
        wizard.init(PlatformUI.getWorkbench(), null);
        wizard.setNeedsProgressMonitor(true);
        WizardNewProjectReferencePage page = new WizardNewProjectReferencePage(//$NON-NLS-1$
    ...
    public void testNewResource() {
        ...
        dialog.create();
        dialog.getShell().setSize(Math.max(SIZING_WIZARD_WIDTH_2, dialog.getShell().getSize().x), SIZING_WIZARD_HEIGHT_2);
        WorkbenchHelp.setHelp(dialog.getShell(), new Object[] { IWorkbenchHelpContextIds.NEW_WIZARD });
        DialogCheck.assertDialogTexts(dialog, this);
    }
}
