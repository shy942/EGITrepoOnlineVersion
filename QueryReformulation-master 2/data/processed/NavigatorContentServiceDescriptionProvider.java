...
*/
    protected final String getDefaultStatusBarMessage(int aSize) {
        return NLS.bind(aSize != 1 ? CommonNavigatorMessages.Navigator_statusLineMultiSelect : CommonNavigatorMessages.Navigator_statusLineSingleSelect, new Object[] { Integer.valueOf(aSize) });
    }
}
