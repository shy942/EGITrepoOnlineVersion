...
*/
    private IStatus performFileDrop(Object data) {
        MultiStatus problems = new MultiStatus(PlatformUI.PLUGIN_ID, 0, ResourceNavigatorMessages.DropAdapter_problemImporting, null);
...
*/
    private IStatus performResourceMove(IResource[] sources) {
        ...
        if (shouldLinkAutomatically) {
            ...
            ReadOnlyStateChecker checker = new ReadOnlyStateChecker(getShell(), ResourceNavigatorMessages.MoveResourceAction_title, ResourceNavigatorMessages.MoveResourceAction_checkMoveMessage);
...
*/
    ...
    public String queryOverwrite(String pathString) {
        ...
        getDisplay().syncExec(() -> {
            MessageDialog dialog = new MessageDialog(getShell(), ResourceNavigatorMessages.DropAdapter_question, null, msg, MessageDialog.QUESTION, 0, options);
            dialog.open();
