...
public class NewStylePage extends FormPage {
    ...
    private static final String[] MESSAGE_NAMES = { "text", "info", "warning", "error" };
...
*/
    ...
    protected void createFormContent(IManagedForm managedForm) {
        ...
        section = toolkit.createSection(form.getBody(), ExpandableComposite.TITLE_BAR | ExpandableComposite.TWISTIE | ExpandableComposite.EXPANDED);
        ...
        for (int i = 0; i < checkboxes.length; i++) checkboxes[i].addSelectionListener(mmListener);
        ...
        shortMessage.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                form.setMessage(getErrorMessage(form.getMessageType(), longMessage.getSelection()), form.getMessageType());
            }
        });
        ...
        error.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                form.setMessage(getErrorMessage(IMessageProvider.ERROR, longMessage.getSelection()), IMessageProvider.ERROR);
            }
        });
        ...
        warning.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                form.setMessage(getErrorMessage(IMessageProvider.WARNING, longMessage.getSelection()), IMessageProvider.WARNING);
            }
        });
        ...
        info.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                form.setMessage(getErrorMessage(IMessageProvider.INFORMATION, longMessage.getSelection()), IMessageProvider.INFORMATION);
            }
        });
    ...
    private void addHeadingGradient(FormToolkit toolkit, ScrolledForm form, boolean add) {
        ...
        form.getForm().setHeadColor(IFormColors.H_BOTTOM_KEYLINE1, add ? colors.getColor(IFormColors.H_BOTTOM_KEYLINE1) : null);
        form.getForm().setHeadColor(IFormColors.H_BOTTOM_KEYLINE2, add ? colors.getColor(IFormColors.H_BOTTOM_KEYLINE2) : null);
        ...
        form.getForm().setHeadColor(IFormColors.TB_TOGGLE_HOVER, add ? colors.getColor(IFormColors.TB_TOGGLE_HOVER) : null);
    ...
    private void updateTitle(ScrolledForm form, boolean addTitle, boolean shortTitle) {
        if (addTitle) {
    ...
    private void addToolBar(FormToolkit toolkit, ScrolledForm form, boolean add) {
        if (add) {
            ...
            haction.setImageDescriptor(ExamplesPlugin.getDefault().getImageRegistry().getDescriptor(ExamplesPlugin.IMG_HORIZONTAL));
            ...
            vaction.setImageDescriptor(ExamplesPlugin.getDefault().getImageRegistry().getDescriptor(ExamplesPlugin.IMG_VERTICAL));
    ...
    private void addDragSupport(final ScrolledForm form) {
        ...
        form.getForm().addTitleDragSupport(operations, transferTypes, new DragSourceListener() {
        ...
        form.getForm().addTitleDropSupport(operations, transferTypes, new DropTargetAdapter() {
        });
    }
}
