...
*/
    public void testGetValueBeforeFocusOutChangeEventsFire() throws Exception {
        IObservableValue observableValue = SWTObservables.observeText(text, SWT.FocusOut);
    ...
    public void testDispose() throws Exception {
        IObservableValue observableValue = SWTObservables.observeText(text, SWT.Modify);
