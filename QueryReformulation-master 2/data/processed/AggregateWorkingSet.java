    ...
    private void constructElements(boolean fireEvent) {
        ...
        try {
            ...
            for (int i = 0; i < localComponents.length; i++) {
                ...
                } catch (IllegalStateException // an invalid component; remove it
                e) {
    ...
    public void saveState(IMemento memento) {
        if (workingSetMemento != null) {
            ...
            for (int i = 0; i < localComponents.length; i++) {
                ...
                memento.createChild(IWorkbenchConstants.TAG_WORKING_SET, componentSet.getName());
            }
        }
    }
...
*/
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof AggregateWorkingSet) {
            ...
            return Util.equals(workingSet.getName(), getName()) && Util.equals(workingSet.getComponentsInternal(), getComponentsInternal());
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "AWS [name=" + getName() + ", components=" + Arrays.toString(getComponentsInternal()) + "]";
    }
}
