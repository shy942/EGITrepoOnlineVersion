...
public class ImageBasedFrame extends Canvas {
    ...
    public  ImageBasedFrame(Composite parent, Control toWrap, boolean vertical, boolean draggable) {
        ...
        if (toWrap instanceof ToolBar) {
            // ((ToolBar) toWrap).getItem(0).getToolTipText(); //$NON-NLS-1$
            id = "TB";
        }
    }
    ...
    protected void drawFrame(PaintEvent e) {
        ...
        dstRect.width = w1;
        dstRect.height = h1;
        e.gc.drawImage(imageCache, srcRect.x, srcRect.y, srcRect.width, srcRect.height, dstRect.x, dstRect.y, dstRect.width, dstRect.height);
        // Top Rail
        srcRect.x = w1;
        srcRect.y = 0;
        srcRect.width = w2;
        ...
        if (handleHeight > 0) {
            ...
            e.gc.drawImage(handle, srcRect.x, srcRect.y, srcRect.width, srcRect.height, dstRect.x, dstRect.y, dstRect.width, dstRect.height);
        }
        // Top Right
        srcRect.x = w1 + w2;
        srcRect.y = 0;
