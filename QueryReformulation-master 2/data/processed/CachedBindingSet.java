...
*/
     CachedBindingSet(final Map activeContextTree, final String[] locales, final String[] platforms, final String[] schemeIds) {
        if (locales == null) {
            //$NON-NLS-1$
...
*/
    ...
    public final int hashCode() {
        if (!hashCodeComputed) {
            ...
            hashCode = hashCode * HASH_FACTOR + Util.hashCode(activeContextTree);
...
*/
    final void setBindingsByTrigger(final Map commandIdsByTrigger) {
        if (commandIdsByTrigger == null) {
            ...
            "Cannot set a null binding resolution");
        }
...
*/
    final void setConflictsByTrigger(final Map conflicts) {
        if (conflicts == null) {
            throw new NullPointerException(//$NON-NLS-1$
            "Cannot set a null binding conflicts");
        }
...
*/
    final boolean isInitialized() {
        return bindingsByTrigger != null && triggersByCommandId != null && conflictsByTrigger != null && prefixTable != null;
    }
}
