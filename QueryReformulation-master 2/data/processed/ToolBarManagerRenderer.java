...
public class ToolBarManagerRenderer extends SWTPartRenderer {
    ...
    @Inject
    @Optional
    private void subscribeTopicUpdateToolbarEnablement(@UIEventTopic(UIEvents.REQUEST_ENABLEMENT_UPDATE_TOPIC) Event eventData) {
...
*/
    ...
    public void init() {
        ...
        "org.eclipse.ui.internal.services.EvaluationService.evaluate", IServiceConstants.ACTIVE_CONTEXTS, IServiceConstants.ACTIVE_PART, IServiceConstants.ACTIVE_SELECTION, IServiceConstants.ACTIVE_SHELL };
...
*/
    public void processContribution(MToolBar toolbarModel, String elementId) {
        ...
        ContributionsAnalyzer.XXXgatherToolBarContributions(toolbarModel, application.getToolBarContributions(), elementId, toContribute);
    ...
    boolean hasOnlySeparators(ToolBar toolbar) {
        ...
        for (ToolItem toolItem : children) {
            if ((toolItem.getStyle() & SWT.SEPARATOR) == 0) {
                return false;
            } else if (toolItem.getControl() != null && toolItem.getControl().getData(OWNING_ME) instanceof MToolControl) {
                return false;
            }
        }
        return true;
