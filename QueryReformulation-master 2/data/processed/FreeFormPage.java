...
*/
    ...
    public static final void createSharedFormContent(IManagedForm managedForm) {
        ...
        TableWrapData td;
        Hyperlink link = toolkit.createHyperlink(form.getBody(), "Sample hyperlink with longer text.", SWT.WRAP);
    ...
    private static void loadFormText(final FormText rtext, FormToolkit toolkit) {
        rtext.addHyperlinkListener(new HyperlinkAdapter() {
            ...
            public void linkActivated(HyperlinkEvent e) {
                MessageDialog.openInformation(rtext.getShell(), "Eclipse Forms", "Link activated: href=" + e.getHref());
            }
        });
