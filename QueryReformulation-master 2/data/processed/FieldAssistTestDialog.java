...
public class FieldAssistTestDialog extends StatusDialog {
    ...
    abstract class SmartField {
        ...
        FieldDecoration getErrorDecoration() {
            if (errorDecoration == null) {
                ...
                if (hasQuickFix()) {
                    standardError = FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_ERROR_QUICKFIX);
                } else {
                    standardError = FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_ERROR);
                }
        ...
        FieldDecoration getWarningDecoration() {
            if (warningDecoration == null) {
                FieldDecoration standardWarning = FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_WARNING);
    ...
    String[] validUsers = { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    "tom", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    "dick", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    "harry", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    "ferdinand", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    "tim", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "teresa", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "tori", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "daniela", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "aaron", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "kevin", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "tod", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "mike", "kim", "eric", "paul", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    "todd" };
    ...
    boolean showErrorDecoration, showErrorMessage, showWarningDecoration, showRequiredFieldDecoration, showRequiredFieldLabelIndicator, showSecondaryPopup, showContentAssist;
...
*/
    ...
    private void getPreferenceValues() {
        ...
        showErrorMessage = store.getBoolean(PreferenceConstants.PREF_SHOWERRORMESSAGE);
        showErrorDecoration = store.getBoolean(PreferenceConstants.PREF_SHOWERRORDECORATION);
        showWarningDecoration = store.getBoolean(PreferenceConstants.PREF_SHOWWARNINGDECORATION);
        showRequiredFieldDecoration = store.getBoolean(PreferenceConstants.PREF_SHOWREQUIREDFIELDDECORATION);
        showRequiredFieldLabelIndicator = store.getBoolean(PreferenceConstants.PREF_SHOWREQUIREDFIELDLABELINDICATOR);
        showSecondaryPopup = store.getBoolean(PreferenceConstants.PREF_SHOWSECONDARYPOPUP);
        showContentAssist = store.getBoolean(PreferenceConstants.PREF_SHOWCONTENTPROPOSALCUE);
        triggerKey = store.getString(PreferenceConstants.PREF_CONTENTASSISTKEY);
        marginWidth = store.getInt(PreferenceConstants.PREF_DECORATOR_MARGINWIDTH);
    }
    ...
    FieldDecoration getCueDecoration() {
        ...
        if (dec == null) {
            ...
            registry.registerFieldDecoration(FieldAssistPlugin.DEC_CONTENTASSIST, NLS.bind(TaskAssistExampleMessages.Decorator_ContentAssist, triggerKey), standardDecoration.getImage());
    ...
    FieldDecoration getWarningDecoration() {
        return FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_WARNING);
    }
        ...
        if (!smartField.isValid()) {
            ...
            if (smartField.isWarning()) {
                ...
                if (showContentAssist && smartField.hasContentAssist()) {
                    ...
                    showRequiredFieldDecoration(smartField, showRequiredFieldDecoration);
                }
            }
        }
    }
    ...
    void showError(SmartField smartField) {
        ...
        if (showErrorMessage) {
            updateStatus(new Status(IStatus.ERROR, "org.eclipse.examples.contentassist", 0, //$NON-NLS-1$
            dec.getDescription(), null));
        }
    ...
    void installContentProposalAdapter(Control control, IControlContentAdapter contentAdapter) {
        ...
        if (triggerKey.equals(PreferenceConstants.PREF_CONTENTASSISTKEYAUTO)) {
            ...
            keyStroke = null;
        } else if (triggerKey.equals(PreferenceConstants.PREF_CONTENTASSISTKEYAUTOSUBSET)) {
            keyStroke = null;
        ...
        ContentProposalAdapter adapter = new ContentProposalAdapter(control, contentAdapter, getContentProposalProvider(), keyStroke, autoActivationCharacters);
                ...
                for (int i = 0; i < validUsers.length; i++) {
                    ...
                    proposals[i] = new IContentProposal() {
                        ...
                        public String getDescription() {
                            if (//$NON-NLS-1$
                            showSecondaryPopup && !user.equals("tori"))
    ...
    FieldDecoration getRequiredFieldDecoration() {
        return FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_REQUIRED);
    }
