...
* tasks and problems.
*/
class TaskListContentProvider implements IStructuredContentProvider, IResourceChangeListener {
...
*/
    public String getStatusSummaryVisible() {
        ...
        return NLS.bind(TaskListMessages.TaskList_statusSummaryVisible, sum(visibleMarkerCounts), getStatusSummaryBreakdown(visibleMarkerCounts));
    }
...
*/
    public String getStatusSummarySelected(IStructuredSelection selection) {
        ...
        return NLS.bind(TaskListMessages.TaskList_statusSummarySelected, sum(selectedMarkerCounts), getStatusSummaryBreakdown(selectedMarkerCounts));
    }
...
*/
    private String getStatusSummaryBreakdown(int[] counts) {
        return NLS.bind(TaskListMessages.TaskList_statusSummaryBreakdown, new Object[] { counts[TASKS], counts[ERRORS], counts[WARNINGS], counts[INFOS] });
    }
