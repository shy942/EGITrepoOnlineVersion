...
*/
    public boolean isActive(INavigatorContentDescriptor aContentDescriptor) {
        return activationService.isNavigatorExtensionActive(aContentDescriptor.getId());
    }
...
*/
    public boolean isActive(String aContentExtensionId) {
        return activationService.isNavigatorExtensionActive(aContentExtensionId);
    }
...
*/
    public boolean isVisible(INavigatorContentDescriptor aContentDescriptor) {
        return programmaticVisibilityBindings.contains(aContentDescriptor.getId()) || viewerDescriptor.isVisibleContentExtension(aContentDescriptor.getId());
    }
...
*/
    public boolean isVisible(String aContentExtensionId) {
        return programmaticVisibilityBindings.contains(aContentExtensionId) || viewerDescriptor.isVisibleContentExtension(aContentExtensionId);
    }
...
*/
    public boolean isRootExtension(String aContentExtensionId) {
        return programmaticRootBindings.contains(aContentExtensionId) || viewerDescriptor.isRootExtension(aContentExtensionId);
    }
