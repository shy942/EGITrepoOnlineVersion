...
public final class LegacyResourceSupport {
    ...
    private static String[] resourceClassNames = { //$NON-NLS-1$
...
*/
    public static Class getFileClass() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.core.resources", "org.eclipse.core.resources.IFile");
        if (c != null) {
...
*/
    public static Class getResourceClass() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.core.resources", "org.eclipse.core.resources.IResource");
        if (c != null) {
            // The class was found so record it
            iresourceClass = c;
        }
...
*/
    public static Class getResourceMappingClass() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.core.resources", "org.eclipse.core.resources.mapping.ResourceMapping");
        if (c != null) {
            // The class was found so record it
...
*/
    public static Class getIContributorResourceAdapterClass() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.ui.ide", "org.eclipse.ui.IContributorResourceAdapter");
        if (c != null) {
            // The class was found so record it
...
*/
    public static Class getIContributorResourceAdapter2Class() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.ui.ide", "org.eclipse.ui.ide.IContributorResourceAdapter2");
        if (c != null) {
            // The class was found so record it
...
*/
    public static Class getDefaultContributorResourceAdapterClass() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Class c = loadClass("org.eclipse.ui.ide", "org.eclipse.ui.internal.ide.DefaultContributorResourceAdapter");
        if (c != null) {
            // The class was found so record it
    ...
    private static Object getDefaultContributorResourceAdapter() {
        ...
        if (c != null) {
            try {
                //$NON-NLS-1$
                Method m = c.getDeclaredMethod("getDefault", new Class[0]);
...
*/
    ...
    private static Method getContributorResourceAdapterGetAdaptedResourceMethod() {
        ...
        if (c != null) {
            try {
                //$NON-NLS-1$
                getAdaptedResourceMethod = c.getDeclaredMethod("getAdaptedResource", new Class[] { IAdaptable.class });
                return getAdaptedResourceMethod;
            } catch (SecurityException e) {
            } catch (NoSuchMethodException e) {
            }
    ...
    private static Method getContributorResourceAdapter2GetAdaptedResourceMappingMethod() {
        ...
        if (c != null) {
            try {
                //$NON-NLS-1$
                getAdaptedResourceMappingMethod = c.getDeclaredMethod("getAdaptedResourceMapping", new Class[] { IAdaptable.class });
                return getAdaptedResourceMappingMethod;
            } catch (SecurityException e) {
            } catch (NoSuchMethodException e) {
            }
