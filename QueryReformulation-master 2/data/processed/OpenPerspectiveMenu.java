...
*/
    ...
    private void openPage(IPerspectiveDescriptor desc, int keyStateMask) {
        // Verify page input.
        if (pageInput == null) {
            StatusUtil.handleStatus(PAGE_PROBLEMS_TITLE + ": " + PAGE_PROBLEMS_MESSAGE, //$NON-NLS-1$
            StatusManager.SHOW);
            return;
        }
        // Open the page.
        try {
            ...
            StatusUtil.handleStatus(PAGE_PROBLEMS_TITLE + ": " + e.getMessage(), e, StatusManager.SHOW);
        }
    }
