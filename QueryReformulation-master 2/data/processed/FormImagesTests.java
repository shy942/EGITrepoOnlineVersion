...
public class FormImagesTests extends TestCase {
    ...
    public void testMultipleSimpleInstances() throws Exception {
        ...
        for (count = 1; count < 20; count++) Assert.assertEquals("getGradient(...) returned a different image for the same params on iteration " + count, gradient, FormImages.getInstance().getGradient(new Color(display, 200, 200, 200), new Color(display, 0, 0, 0), 30, 16, 3, display));
        for (; count > 0; count--) {
            FormImages.getInstance().markFinished(gradient, display);
            if (count != 1)
    ...
    public void testMultipleComplexInstances() throws Exception {
        Display display = Display.getCurrent();
        Image gradient = FormImages.getInstance().getGradient(new Color[] { new Color(display, 200, 200, 200), new Color(display, 0, 0, 0) }, new int[] { 100 }, 31, true, null, display);
        int count;
        // ensure that the same image is returned for many calls with the same parameter
        for (count = 1; count < 20; count++) Assert.assertEquals("getGradient(...) returned a different image for the same params on iteration " + count, gradient, FormImages.getInstance().getGradient(new Color[] { new Color(display, 200, 200, 200), new Color(display, 0, 0, 0) }, new int[] { 100 }, 31, true, null, display));
        for (; count > 0; count--) {
            FormImages.getInstance().markFinished(gradient, display);
            if (count != 1)
                // ensure that the gradient is not disposed early
    ...
    public void testMultipleUniqueInstances() throws Exception {
        ...
        images[11] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 1, 1, 1) }, new int[] { 80 }, 31, true, new Color(display, 255, 255, 255), display);
        images[12] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 1, 1, 1) }, new int[] { 80 }, 31, true, new Color(display, 0, 0, 0), display);
        images[13] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 100, 100) }, new int[] { 100 }, 31, true, null, display);
        images[14] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 1, 0, 0), new Color(display, 100, 100, 100) }, new int[] { 100 }, 31, true, null, display);
        images[15] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 1, 0), new Color(display, 100, 100, 100) }, new int[] { 100 }, 31, true, null, display);
        images[16] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 1), new Color(display, 100, 100, 100) }, new int[] { 100 }, 31, true, null, display);
        images[17] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 101, 100, 100) }, new int[] { 100 }, 31, true, null, display);
        images[18] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 101, 100) }, new int[] { 100 }, 31, true, null, display);
        images[19] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 100, 101) }, new int[] { 100 }, 31, true, null, display);
        images[20] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 100, 100) }, new int[] { 100 }, 20, true, null, display);
        images[21] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 100, 100) }, new int[] { 100 }, 31, false, null, display);
        images[22] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 100, 100, 100) }, new int[] { 50 }, 31, true, new Color(display, 1, 1, 1), display);
        images[23] = FormImages.getInstance().getGradient(new Color[] { new Color(display, 1, 1, 1), new Color(display, 101, 101, 101) }, new int[] { 50 }, 20, false, new Color(display, 1, 1, 1), display);
    ...
    public void testComplexEquality() throws Exception {
        Display display = Display.getCurrent();
        Image image1 = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 255, 255, 255) }, new int[] { 100 }, 20, true, new Color(display, 100, 100, 100), display);
        Image image2 = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 255, 255, 255) }, new int[] { 100 }, 20, true, new Color(display, 0, 0, 0), display);
        ...
        image1 = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 255, 255, 255) }, new int[] { 80 }, 20, true, new Color(display, 100, 100, 100), display);
        image2 = FormImages.getInstance().getGradient(new Color[] { new Color(display, 0, 0, 0), new Color(display, 255, 255, 255) }, new int[] { 80 }, 20, true, new Color(display, 0, 0, 0), display);
