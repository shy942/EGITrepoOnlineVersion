...
*/
     LegacyCommandListenerWrapper(final org.eclipse.ui.commands.ICommandListener listener, final BindingManager bindingManager) {
        if (listener == null) {
            //$NON-NLS-1$
        ...
        if (bindingManager == null) {
            ...
            "Cannot create a listener wrapper without a binding manager");
        }
    ...
    public final void commandChanged(final CommandEvent commandEvent) {
        ...
        listener.commandChanged(new org.eclipse.ui.commands.CommandEvent(command, false, false, definedChanged, descriptionChanged, handledChanged, false, nameChanged, null));
    }
