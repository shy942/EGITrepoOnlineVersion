...
*/
    protected Control createMessageArea(Composite composite) {
        ...
        if (message != null) {
            ...
            GridDataFactory.fillDefaults().align(SWT.FILL, SWT.BEGINNING).grab(true, false).hint(convertHorizontalDLUsToPixels(IDialogConstants.MINIMUM_MESSAGE_AREA_WIDTH), SWT.DEFAULT).applyTo(messageLabel);
        }
        return composite;
    }
...
*/
    ...
    protected Control createButtonBar(Composite parent) {
        ...
        // this is incremented
        GridLayoutFactory.fillDefaults().numColumns(0).equalWidth(// by createButton
...
*/
    ...
    protected Control createContents(Composite parent) {
        ...
        GridLayoutFactory.fillDefaults().margins(LayoutConstants.getMargins()).spacing(defaultSpacing.x * 2, defaultSpacing.y).numColumns(getColumnCount()).applyTo(parent);
...
*/
    private Image getSWTImage(final int imageID) {
        ...
        if (shell == null || shell.isDisposed()) {
            ...
            Assert.isNotNull(display, //$NON-NLS-1$
