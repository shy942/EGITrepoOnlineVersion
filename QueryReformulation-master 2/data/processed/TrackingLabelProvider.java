...
*
*/
public class TrackingLabelProvider extends LabelProvider implements ICommonLabelProvider, IDescriptionProvider, IColorProvider, IFontProvider, IStyledLabelProvider {

    private static final boolean PRINT_DEBUG_INFO = false;

    public static Color BG_COLOR = Display.getCurrent().getSystemColor(SWT.COLOR_GRAY);

    public static Color FG_COLOR = Display.getCurrent().getSystemColor(SWT.COLOR_BLACK);

    public static Font FONT = new Font(Display.getDefault(), new FontData());

    public static final Map descriptionQueries = new HashMap(), backgroundQueries = new HashMap(), foregroundQueries = new HashMap(), fontQueries = new HashMap(), styledTextQueries = new HashMap(), textQueries = new HashMap(), imageQueries = new HashMap();
