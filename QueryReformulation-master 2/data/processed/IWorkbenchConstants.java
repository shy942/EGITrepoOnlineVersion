...
*/
    ...
    ACCELERATOR_CONFIGURATION_ID = "acceleratorConfigurationId";
...
*/
    @Deprecated
    public static final String //$NON-NLS-1$
    DEFAULT_ACCELERATOR_CONFIGURATION_ID = "org.eclipse.ui.defaultAcceleratorConfiguration";
...
*/
    @Deprecated
    public static final String //$NON-NLS-1$
    DEFAULT_ACCELERATOR_SCOPE_ID = "org.eclipse.ui.globalScope";

    // ID of the MPerspectiveStack in the IDE e4 model
    //$NON-NLS-1$
    public static final String PERSPECTIVE_STACK_ID = "org.eclipse.ui.ide.perspectivestack";
    ...
    public static final String WORKBENCH_PROPERTIES_PAGE_INFO = PlatformUI.PLUGIN_ID + //$NON-NLS-1$
    ".propertypages.info.file";

    // Various editor.
    public static final String OLE_EDITOR_ID = PlatformUI.PLUGIN_ID + //$NON-NLS-1$
    ".OleEditor";
