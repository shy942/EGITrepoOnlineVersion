...
public class UserElement extends OrganizationElement {
    ...
    public static final String P_PHONENUMBER = MessageUtil.getString(//$NON-NLS-1$
    "phonenumber");
    ...
    public static final String P_PERSONELINFO = MessageUtil.getString(//$NON-NLS-1$
    "personel");

    public static final String P_PERSONALINFO = MessageUtil.getString(//$NON-NLS-1$
    "personal");
    ...
    public static final String P_VALUE_TRUE_LABEL = MessageUtil.getString(//$NON-NLS-1$
    "true");

    public static final String P_VALUE_FALSE_LABEL = MessageUtil.getString(//$NON-NLS-1$
    "false");
        ...
        propertyDescriptor.setValidator(new ICellEditorValidator() {
            ...
            public String isValid(Object value) {
                ...
                if (trySalary.floatValue() < 0.0)
                    ...
                    "salary_must_be_greator_than_zero");
                return null;
            }
        });
        propertyDescriptor.setCategory(P_PERSONELINFO);
