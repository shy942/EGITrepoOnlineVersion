...
*/
    public  ShowInNavigatorAction(IWorkbenchPage page, ISelectionProvider viewer) {
        ...
        page.getWorkbenchWindow().getWorkbench().getHelpSystem().setHelp(this, INavigatorHelpContextIds.SHOW_IN_NAVIGATOR_ACTION);
    }
...
*/
    ...
    public void run() {
        ...
        try {
            ...
            ErrorDialog.openError(page.getWorkbenchWindow().getShell(), ResourceNavigatorMessages.ShowInNavigator_errorMessage, e.getMessage(), e.getStatus());
        }
    }
