...
public class SWTEventHelper {
    ...
    public static boolean performDnD(Widget startItem, Widget dropItem) {
        ...
        if (startItem instanceof TreeItem) {
            ...
            boundsStart = Display.getCurrent().map(startControl, null, ((TreeItem) startItem).getBounds());
        ...
        if (dropItem instanceof TreeItem) {
            boundsEnd = Display.getCurrent().map(((TreeItem) dropItem).getParent(), null, ((TreeItem) dropItem).getBounds());
