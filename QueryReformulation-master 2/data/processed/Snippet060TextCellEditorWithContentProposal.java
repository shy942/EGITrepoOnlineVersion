...
public class Snippet060TextCellEditorWithContentProposal {
    ...
    public static class TextCellEditorWithContentProposal extends TextCellEditor {
        ...
        // true, iff popup is currently open
...
*/
    ...
    private static class ColorNameEditingSupport extends EditingSupport {
        ...
        public  ColorNameEditingSupport(TableViewer viewer) {
            super(viewer);
            IContentProposalProvider contentProposalProvider = new SimpleContentProposalProvider(new String[] { "red", "green", "blue" });
    ...
    public  Snippet060TextCellEditorWithContentProposal(Shell shell) {
        ...
        ColumnViewerEditorActivationStrategy activationSupport = new ColumnViewerEditorActivationStrategy(viewer) {
            ...
            protected boolean isEditorActivationEvent(ColumnViewerEditorActivationEvent event) {
                return event.eventType == ColumnViewerEditorActivationEvent.TRAVERSAL || event.eventType == ColumnViewerEditorActivationEvent.MOUSE_DOUBLE_CLICK_SELECTION || event.eventType == ColumnViewerEditorActivationEvent.PROGRAMMATIC || (event.eventType == ColumnViewerEditorActivationEvent.KEY_PRESSED && event.keyCode == KeyLookupFactory.getDefault().formalKeyLookup(IKeyLookup.ENTER_NAME));
            }
        };
...
*/
        ...
        TableViewerEditor.create(viewer, focusCellManager, activationSupport, ColumnViewerEditor.TABBING_VERTICAL | ColumnViewerEditor.KEYBOARD_ACTIVATION);
