...
public class PropertyScenarios extends ScenariosTestCase {
    ...
    public void testScenario01() {
        Text text = new Text(getComposite(), SWT.BORDER);
        getDbc().bindValue(SWTObservables.observeText(text, SWT.Modify), BeansObservables.observeValue(adventure, "name"));
    ...
    public void testScenario02() {
        ...
        getDbc().bindValue(SWTObservables.observeText(text, SWT.None), BeansObservables.observeValue(adventure, "name"));
        assertEquals(adventure.getName(), text.getText());
    }
    ...
    public void testScenario04() {
        ...
        // now.
        IObservableValue defaultLodging = BeansObservables.observeDetailValue(BeansObservables.observeValue(adventure, "defaultLodging"), "description", String.class);
    ...
    public void testScenario05() {
        ...
        getDbc().bindValue(SWTObservables.observeText(text, SWT.Modify), BeansObservables.observeValue(adventure, "name"), new UpdateValueStrategy().setConverter(converter2), new UpdateValueStrategy().setConverter(converter1));
        // spinEventLoop(1);
    ...
    public void testScenario06() {
        ...
        assertEquals(max15CharactersMessage, ((IStatus) binding.getValidationStatus().getValue()).getMessage());
        assertEquals("ValidValue", adventure.getName());
    ...
    public void testScenario09() {
        ...
        getDbc().bindValue(SWTObservables.observeSelection(checkbox), BeansObservables.observeValue(adventure, "petsAllowed"));
    ...
    public void testScenario12() {
        ...
        getDbc().bindValue(checkbox1Selected, checkbox2Selected, new UpdateValueStrategy().setConverter(negatingConverter), new UpdateValueStrategy().setConverter(negatingConverter));
