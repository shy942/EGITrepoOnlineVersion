...
public class PlatformUIPreferenceListener implements IEclipsePreferences.IPreferenceChangeListener {
    ...
    public void preferenceChange(PreferenceChangeEvent event) {
        ...
        if (IWorkbenchPreferenceConstants.SHOW_SYSTEM_JOBS.equals(propertyName)) {
            boolean setting = PrefUtil.getAPIPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.SHOW_SYSTEM_JOBS);
        ...
        if (IWorkbenchPreferenceConstants.DEFAULT_PERSPECTIVE_ID.equals(propertyName)) {
            ...
            workbench.getPerspectiveRegistry().setDefaultPerspective(PrefUtil.getAPIPreferenceStore().getString(IWorkbenchPreferenceConstants.DEFAULT_PERSPECTIVE_ID));
            return;
        }
        ...
        // Set Open mode
        if (IPreferenceConstants.OPEN_ON_SINGLE_CLICK.equals(propertyName) || IPreferenceConstants.SELECT_ON_HOVER.equals(propertyName) || IPreferenceConstants.OPEN_AFTER_DELAY.equals(propertyName) || IPreferenceConstants.SELECT_ON_HOVER.equals(propertyName)) {
