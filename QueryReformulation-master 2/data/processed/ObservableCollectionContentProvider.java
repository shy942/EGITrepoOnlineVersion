...
*/
    protected  ObservableCollectionContentProvider(IViewerUpdater explicitViewerUpdater) {
    ...
    IViewerUpdater createViewerUpdater(Viewer viewer) {
        ...
        "This content provider only works with AbstractTableViewer or AbstractListViewer");
    }
    ...
    void setInput(Object input) {
        ...
        if (input != null) {
            checkInput(input);
            Assert.isTrue(input instanceof IObservableCollection, //$NON-NLS-1$
            "Input must be an IObservableCollection");
...
*/
    protected abstract void removeCollectionChangeListener(IObservableCollection collection);
