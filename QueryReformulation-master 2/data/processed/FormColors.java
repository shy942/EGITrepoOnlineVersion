...
*/
    protected void updateBorderColor() {
        if (isWhiteBackground())
            ...
            if (border.getRed() == bg.getRed() && border.getGreen() == bg.getGreen() && border.getBlue() == bg.getBlue())
...
*/
        ...
        if (testTwoPrimaryColors(listSelection, -1, 121))
            rgb = listSelection;
        else // Aqua, OSX Graphite, Linux GTK
        if (testTwoPrimaryColors(listSelection, 120, 256) || (bg.red == 0 && bg.green == 0 && bg.blue == 0))
    ...
    private void createTitleBarGradientColors() {
        ...
        else // Gradient Top = TITLE BACKGROUND @ 0% Opacity over LIST_BACKGROUND
        if (testTwoPrimaryColors(tbBg, 120, 180))
    ...
    private void createTitleBarOutlineColors() {
        ...
        else // Keyline = TITLE_BACKGROUND @ 50% Opacity over LIST_BACKGROUND
        if (testTwoPrimaryColors(tbBorder, 120, 180))
