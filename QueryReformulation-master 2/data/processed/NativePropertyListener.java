...
*/
    protected void fireChange(S source, D diff) {
        listener.handleEvent(new SimplePropertyEvent<S, D>(SimplePropertyEvent.CHANGE, source, property, diff));
    }
...
*/
    protected void fireStale(S source) {
        listener.handleEvent(new SimplePropertyEvent<S, D>(SimplePropertyEvent.STALE, source, property, null));
    }
}
