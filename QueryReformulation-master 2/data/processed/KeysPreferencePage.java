...
*/
    ...
    static {
        UNSORTED_COLUMN_NAMES[VIEW_CATEGORY_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnCategory");
        UNSORTED_COLUMN_NAMES[VIEW_COMMAND_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnCommand");
        UNSORTED_COLUMN_NAMES[VIEW_KEY_SEQUENCE_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnKeySequence");
        UNSORTED_COLUMN_NAMES[VIEW_CONTEXT_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnContext");
        SORTED_COLUMN_NAMES[VIEW_CATEGORY_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnCategorySorted");
        SORTED_COLUMN_NAMES[VIEW_COMMAND_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnCommandSorted");
        SORTED_COLUMN_NAMES[VIEW_KEY_SEQUENCE_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnKeySequenceSorted");
        SORTED_COLUMN_NAMES[VIEW_CONTEXT_COLUMN_INDEX] = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnContextSorted");
    }
...
*/
    private int[] sortOrder = { VIEW_CATEGORY_COLUMN_INDEX, VIEW_COMMAND_COLUMN_INDEX, VIEW_KEY_SEQUENCE_COLUMN_INDEX, VIEW_CONTEXT_COLUMN_INDEX };
...
*/
    ...
    protected final Control createContents(final Composite parent) {
        ...
        modifyTab.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "modifyTab.Text"));
...
*/
    private final Composite createModifyTab(final TabFolder parent) {
        ...
        labelKeyConfiguration.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelScheme"));
        ...
        groupCommand.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "groupCommand"));
        final Label labelCategory = new Label(groupCommand, SWT.LEFT);
        gridData = new GridData();
        labelCategory.setLayoutData(gridData);
        labelCategory.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelCategory"));
        ...
        labelCommand.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelCommand"));
        ...
        labelBindingsForCommand.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelAssignmentsForCommand"));
        tableBindingsForCommand = new Table(groupCommand, SWT.BORDER | SWT.FULL_SELECTION | SWT.H_SCROLL | SWT.V_SCROLL);
        ...
        tableColumnContext.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnContext"));
        ...
        tableColumnKeySequence.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnKeySequence"));
        ...
        groupKeySequence.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "groupKeySequence"));
        final Label labelKeySequence = new Label(groupKeySequence, SWT.LEFT);
        gridData = new GridData();
        labelKeySequence.setLayoutData(gridData);
        labelKeySequence.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelKeySequence"));
        ...
        buttonAddKey.setToolTipText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "buttonAddKey.ToolTipText"));
        gridData = new GridData();
        ...
        labelBindingsForTriggerSequence.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelAssignmentsForKeySequence"));
        tableBindingsForTriggerSequence = new Table(groupKeySequence, SWT.BORDER | SWT.FULL_SELECTION | SWT.H_SCROLL | SWT.V_SCROLL);
        ...
        tableColumnCommand.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "tableColumnCommand"));
        ...
        labelContext.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "labelContext"));
        ...
        //$NON-NLS-1$
        buttonAdd.setText(Util.translateString(RESOURCE_BUNDLE, "buttonAdd"));
        ...
        buttonRemove.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "buttonRemove"));
        ...
        gridData = new GridData();
        widthHint = convertHorizontalDLUsToPixels(IDialogConstants.BUTTON_WIDTH);
        buttonRestore.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "buttonRestore"));
...
*/
    private final Composite createViewTab(final TabFolder parent) {
        ...
        final TableColumn tableColumnKeySequence = new TableColumn(tableBindings, SWT.NONE, VIEW_KEY_SEQUENCE_COLUMN_INDEX);
        ...
        gridData = new GridData();
        widthHint = convertHorizontalDLUsToPixels(IDialogConstants.BUTTON_WIDTH);
        buttonExport.setText(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "buttonExport"));
...
*/
    private final void logPreferenceStoreException(final Throwable exception) {
        final String message = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "PreferenceStoreError.Message");
    ...
    protected final void performDefaults() {
        ...
        final String title = Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        ...
        if (confirmed) {
            ...
            final Binding[] trimmedBindingArray = (Binding[]) trimmedBindings.toArray(new Binding[trimmedBindings.size()]);
...
*/
    private final void selectedButtonAdd() {
        ...
        localChangeManager.addBinding(new KeyBinding(keySequence, command, schemeId, contextId, null, null, null, Binding.USER));
        update(true);
    }
...
*/
    private final void selectedButtonExport() {
        ...
        fileDialog.setFilterNames(new String[] { Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
        "csvFilterName") });
                ...
                try {
                    ...
                    for (int i = 0; i < items.length; i++) {
                        ...
                        for (int j = 0; j < numColumns; j++) {
                            ...
                            Util.replaceAll(//$NON-NLS-1$
                            item.getText(j), //$NON-NLS-1$
                            "\"", //$NON-NLS-1$
                            "\"\"");
                            //$NON-NLS-1$//$NON-NLS-2$
...
*/
    private final void selectedButtonRemove() {
        ...
        final KeySequence keySequence = getKeySequence();
        localChangeManager.removeBindings(keySequence, schemeId, contextId, null, null, null, Binding.USER);
        localChangeManager.addBinding(new KeyBinding(keySequence, null, schemeId, contextId, null, null, null, Binding.USER));
        update(true);
    }
    ...
    public final void setVisible(final boolean visible) {
        if (visible == true) {
            ...
            for (Iterator iterator = contextsByName.entrySet().iterator(); iterator.hasNext(); ) {
                ...
                if (contexts.size() == 1) {
                    ...
                    while (iterator2.hasNext()) {
                        Context context = (Context) iterator2.next();
                        String uniqueName = MessageFormat.format(Util.translateString(RESOURCE_BUNDLE, "uniqueName"), new Object[] { //$NON-NLS-1$
                        name, context.getId() });
            ...
            if (commandIdsByCategoryId.containsKey(null)) {
                categoryNames.add(0, Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
                "other"));
            }
            ...
            if (context.isDefined()) {
                try {
                    ...
                    if (parentId != null) {
                        ...
                        if (name != null) {
                            labelContextExtends.setText(MessageFormat.format(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
                            "extends"), new Object[] { name }));
                            return;
                        }
                    }
                } catch (final NotDefinedException e) {
    ...
    private final void updateLabelSchemeExtends() {
        ...
        if (schemeId != null) {
            ...
            try {
                ...
                if (name != null) {
                    labelSchemeExtends.setText(MessageFormat.format(Util.translateString(RESOURCE_BUNDLE, //$NON-NLS-1$
                    "extends"), new Object[] { name }));
                    return;
                }
            } catch (final NotDefinedException e) {
...
*/
    private final void updateSelection(final Table table, final String contextId, final TriggerSequence triggerSequence) {
                ...
                for (int i = 0; i < sortOrder.length; i++) {
                    switch(sortOrder[i]) {
                        ...
                        case VIEW_CONTEXT_COLUMN_INDEX:
                            ...
                            break;
                        default:
                            throw new Error(//$NON-NLS-1$
                            "Programmer error: added another sort column without modifying the comparator.");
                    }
                }
                return compare;
            }
