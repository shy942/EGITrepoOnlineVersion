...
*/
    ...
    //accessed from this test AND wizard
    ...
    public void testPageChangeListening() {
        ...
        //assert is in the listener
        dialog.addPageChangingListener(changingListener);
        ...
        //if not removed, its assert will fail on next nextPressed()
        dialog.removePageChangingListener(changingListener);
        //change to page 2
        dialog.nextPressed();
