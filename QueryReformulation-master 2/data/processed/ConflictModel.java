...
*/
    ...
    private void updateConflictsFor(BindingElement oldValue, BindingElement newValue, boolean removal) {
        updateConflictsFor(newValue, oldValue == null ? null : oldValue.getTrigger(), newValue == null ? null : newValue.getTrigger(), removal);
    }
    ...
    public void updateConflictsFor(BindingElement newValue, TriggerSequence oldTrigger, TriggerSequence newTrigger, boolean removal) {
        ...
        if (matches != null) {
            ...
            while (i.hasNext()) {
                ...
                if (binding != b && b.getContextId().equals(binding.getContextId()) && b.getSchemeId().equals(binding.getSchemeId())) {
    ...
    public void init(BindingManager manager, BindingModel model) {
        ...
        controller.addPropertyChangeListener(new IPropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent event) {
                if (event.getSource() == ConflictModel.this && CommonModel.PROP_SELECTED_ELEMENT.equals(event.getProperty())) {
