...
public class SetDetailValueObservableMapTest extends AbstractDefaultRealmTestCase {
    ...
    public void testGetValueType() {
        SetDetailValueObservableMap sdom = new SetDetailValueObservableMap(new WritableSet(), BeansObservables.valueFactory("name"), String.class);
    ...
    public void testDetailObservableValuesAreDisposed() {
        ...
        WritableSet masterKeySet = new WritableSet();
        SetDetailValueObservableMap sdom = new SetDetailValueObservableMap(masterKeySet, detailValueFactory, null);
