...
public class ElementTreeSelectionDialog extends SelectionStatusDialog {
    ...
    private IStatus fCurrStatus = new Status(IStatus.OK, PlatformUI.PLUGIN_ID, IStatus.OK, "", //$NON-NLS-1$
    null);
    ...
    protected void updateOKStatus() {
        if (!fIsEmpty) {
            if (fValidator != null) {
                ...
                fCurrStatus = new Status(IStatus.OK, PlatformUI.PLUGIN_ID, //$NON-NLS-1$
