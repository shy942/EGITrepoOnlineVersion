...
public class MapDetailValueObservableMapTest extends AbstractDefaultRealmTestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(MapDetailValueObservableMapTest.class.getName());
    ...
    public void testGetValueType() {
        MapDetailValueObservableMap mdom = new MapDetailValueObservableMap(new WritableMap(), BeansObservables.valueFactory("name"), String.class);
