    ...
    public static boolean test(IMarker marker, String attributeName, String expectedValue) {
        if (TYPE.equals(attributeName)) {
            ...
            try {
                ...
                return SimpleWildcardTester.testWildcardIgnoreCase(expectedValue, msg);
            } catch (CoreException e) {
                return false;
            }
            ...
            if (!(desiredType == IResource.FILE || desiredType == IResource.FOLDER || desiredType == IResource.PROJECT || desiredType == IResource.ROOT)) {
                return false;
            }
