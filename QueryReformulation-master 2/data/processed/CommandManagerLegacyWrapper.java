...
* @since 3.1
*/
public final class CommandManagerLegacyWrapper implements ICommandManager, org.eclipse.core.commands.ICommandManagerListener, IBindingManagerListener, IContextManagerListener {
...
*
*/
    public  CommandManagerLegacyWrapper(final BindingManager bindingManager, final CommandManager commandManager, final ContextManager contextManager) {
        if (contextManager == null) {
            throw new NullPointerException(//$NON-NLS-1$
            "The context manager cannot be null.");
        }
    ...
    @Override
    public final void addCommandManagerListener(final ICommandManagerListener commandManagerListener) {
    ...
    public final void bindingManagerChanged(final BindingManagerEvent event) {
        ...
        if (schemeDefinitionsChanged) {
            ...
            for (int i = 0; i < definedSchemesCount; i++) {
                ...
                if ((definedScheme == scheme) && (event.isSchemeDefined())) {
                    // skip this one, it was just defined.
                    continue;
                }
        ...
        fireCommandManagerChanged(new CommandManagerEvent(this, false, event.isActiveSchemeChanged(), event.isLocaleChanged(), event.isPlatformChanged(), false, false, schemeDefinitionsChanged, null, null, previousSchemes));
    }

    @Override
    public final void commandManagerChanged(final org.eclipse.core.commands.CommandManagerEvent event) {
        ...
        fireCommandManagerChanged(new CommandManagerEvent(this, false, false, false, false, categoryIdsChanged, commandIdsChanged, false, previousCategoryIds, previousCommandIds, null));
    }

    @Override
    public final void contextManagerChanged(final ContextManagerEvent event) {
        fireCommandManagerChanged(new CommandManagerEvent(this, event.isActiveContextsChanged(), false, false, false, false, false, false, null, null, null));
    }
    ...
    public final void setHandlersByCommandId(final Map handlersByCommandId) {
        ...
        while (entryItr.hasNext()) {
            ...
            if (handler instanceof org.eclipse.ui.commands.IHandler) {
                ...
                handlersByCommandId.put(commandId, new LegacyHandlerWrapper((org.eclipse.ui.commands.IHandler) handler));
            }
        }
