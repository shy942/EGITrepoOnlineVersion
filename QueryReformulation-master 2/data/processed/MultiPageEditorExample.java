...
*/
    void createPage0() {
        try {
            ...
            //$NON-NLS-1$
            setPageText(editorIndex, MessageUtil.getString("Source"));
        } catch (PartInitException e) {
            ErrorDialog.openError(getSite().getShell(), MessageUtil.getString("ErrorCreatingNestedEditor"), null, e.getStatus());
        }
    }
...
*/
    void createPage1() {
        ...
        //$NON-NLS-1$
        setPageText(index, MessageUtil.getString("Properties"));
    }
...
*/
    void createPage2() {
        ...
        int index = addPage(composite);
        //$NON-NLS-1$
        setPageText(index, MessageUtil.getString("Preview"));
    }
