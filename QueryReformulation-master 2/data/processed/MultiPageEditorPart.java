        ...
        if (activeEditor != null) {
            ...
            if (selectionProvider != null) {
                ...
                if (outerProvider instanceof MultiPageSelectionProvider) {
                    ...
                    if (Policy.DEBUG_MPE) {
                        Tracing.printTrace(TRACING_COMPONENT, //$NON-NLS-1$
                        "MultiPageEditorPart " + getTitle() + //$NON-NLS-1$
                        " did not propogate selection for " + activeEditor.getTitle());
                    }
                }
            }
        }
    ...
    protected final void deactivateSite(boolean immediate, boolean containerSiteActive) {
        ...
        if (pageIndex < 0 || pageIndex >= getPageCount() || immediate) {
            ...
            if (service instanceof INestableKeyBindingService) {
                ...
                "MultiPageEditorPart.deactivateSite()   Parent key binding service was not an instance of INestableKeyBindingService.  It was an instance of " + service.getClass().getName() + " instead.");
            }
        }
    ...
    protected final void activateSite() {
        ...
        if (editor != null) {
            ...
            if (service instanceof INestableKeyBindingService) {
                ...
                WorkbenchPlugin.log(//$NON-NLS-1$ //$NON-NLS-2$
                "MultiPageEditorPart.activateSite()   Parent key binding service was not an instance of INestableKeyBindingService.  It was an instance of " + service.getClass().getName() + " instead.");
            }
