...
*/
    ...
    protected Object[] queryDestinationParameters(IProject project) {
        ProjectLocationMoveDialog dialog = new ProjectLocationMoveDialog(shellProvider.getShell(), project);
...
*/
    ...
    public void run() {
        ...
        if (errorStatus != null) {
            ErrorDialog.openError(this.shellProvider.getShell(), PROBLEMS_TITLE, null, errorStatus);
            errorStatus = null;
        }
    }
}
