...
public class EmptyObservableListTest {
    ...
    public static class ImmutableObservableListContractTest extends ObservableListContractTest {
        ...
        public static Test suite(IObservableCollectionContractDelegate delegate) {
            return new SuiteBuilder().addObservableContractTest(ImmutableObservableListContractTest.class, delegate).build();
        }

        public  ImmutableObservableListContractTest(IObservableCollectionContractDelegate delegate) {
            super(delegate);
        }

        public  ImmutableObservableListContractTest(String name, IObservableCollectionContractDelegate delegate) {
            super(name, delegate);
        }
