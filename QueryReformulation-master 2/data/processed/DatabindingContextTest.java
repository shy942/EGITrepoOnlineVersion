...
public class DatabindingContextTest extends AbstractDefaultRealmTestCase {
    ...
    public void testBindValue() throws Exception {
        ...
        assertTrue("binding is of the incorrect type", binding.getClass().getName().endsWith("ValueBinding"));
    }
    ...
    public void testBindList() throws Exception {
        ...
        assertTrue("binding is of the incorrect type", binding.getClass().getName().endsWith("ListBinding"));
    }
...
*/
    public void testValidationError() throws Exception {
        ...
        dbc.bindValue(targetObservable, modelObservable, new UpdateValueStrategy().setAfterGetValidator(validator), null);
...
*/
    public void testValidateTargetAfterValueBindingCreation() throws Exception {
        ...
        Binding binding = dbc.bindValue(target, model, new UpdateValueStrategy().setAfterConvertValidator(new Validator()), null);
