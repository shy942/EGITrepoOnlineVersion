...
*/
    public  InternalErrorDialog(Shell parentShell, String dialogTitle, Image dialogTitleImage, String dialogMessage, Throwable detail, int dialogImageType, String[] dialogButtonLabels, int defaultIndex) {
...
*/
    public static boolean openQuestion(Shell parent, String title, String message, Throwable detail, int defaultIndex) {
        ...
        InternalErrorDialog dialog = new InternalErrorDialog(parent, title, // accept the default window icon
        null, message, detail, QUESTION, labels, defaultIndex);
        if (detail != null) {
