...
*/
    protected static final void addElementToIndexedArray(final IConfigurationElement elementToAdd, final IConfigurationElement[][] indexedArray, final int index, final int currentCount) {
...
*            <code>null</code>.
*/
    protected static final void addWarning(final List warningsToLog, final String message, final IConfigurationElement element) {
...
*/
    protected static final void addWarning(final List warningsToLog, final String message, final IConfigurationElement element, final String id) {
...
*            <code>null</code>.
*/
    protected static final void addWarning(final List warningsToLog, final String message, final IConfigurationElement element, final String id, final String extraAttributeName, final String extraAttributeValue) {
        String statusMessage = message;
        if (element != null) {
            statusMessage = statusMessage + ": plug-in='" + element.getNamespace() + //$NON-NLS-1$
            '\'';
        }
        if (id != null) {
            if (element != null) {
            ...
            //$NON-NLS-1$
            statusMessage = statusMessage + " id='" + id + '\'';
        }
...
*/
    protected static final boolean checkClass(final IConfigurationElement configurationElement, final List warningsToLog, final String message, final String id) {
        // Check to see if we have a handler class.
        if ((configurationElement.getAttribute(ATT_CLASS) == null) && (configurationElement.getChildren(TAG_CLASS).length == 0)) {
...
*/
    protected static final void logWarnings(final List warningsToLog, final String message) {
        ...
        if ((warningsToLog != null) && (!warningsToLog.isEmpty())) {
            final IStatus status = new MultiStatus(WorkbenchPlugin.PI_WORKBENCH, 0, (IStatus[]) warningsToLog.toArray(new IStatus[warningsToLog.size()]), message, null);
...
*/
    protected static final boolean readBoolean(final IConfigurationElement configurationElement, final String attribute, final boolean defaultValue) {
...
* @return The attribute's value; may be <code>null</code> if none.
*/
    protected static final String readOptional(final IConfigurationElement configurationElement, final String attribute) {
...
*/
    protected static final ParameterizedCommand readParameterizedCommand(final IConfigurationElement configurationElement, final ICommandService commandService, final List warningsToLog, final String message, final String id) {
...
*         <code>null</code> if none can be found.
*/
    protected static final ParameterizedCommand readParameters(final IConfigurationElement configurationElement, final List warningsToLog, final Command command) {
        ...
        for (int i = 0; i < parameterElements.length; i++) {
            ...
            if ((id == null) || (id.length() == 0)) {
                ...
                "Parameters need a name", configurationElement);
                continue;
            }
            ...
            if (parameter == null) {
                ...
                "Could not find a matching parameter", configurationElement, id);
                continue;
            }
            // Read out the value.
            ...
            if ((value == null) || (value.length() == 0)) {
                ...
                addWarning(//$NON-NLS-1$
                warningsToLog, //$NON-NLS-1$
                "Parameters need a value", configurationElement, id);
                continue;
            }
        ...
        return new ParameterizedCommand(command, (Parameterization[]) parameters.toArray(new Parameterization[parameters.size()]));
    }
...
*/
    protected static final String readRequired(final IConfigurationElement configurationElement, final String attribute, final List warningsToLog, final String message) {
...
* @return The required attribute; may be <code>null</code> if missing.
*/
    protected static final String readRequired(final IConfigurationElement configurationElement, final String attribute, final List warningsToLog, final String message, final String id) {
        final String value = configurationElement.getAttribute(attribute);
        if ((value == null) || (value.length() == 0)) {
            addWarning(warningsToLog, message, configurationElement, id);
            return null;
...
*         <code>null</code>.
*/
    protected static final Expression readWhenElement(final IConfigurationElement parentElement, final String whenElementName, final String id, final List warningsToLog) {
        ...
        if (whenElements.length > 0) {
            ...
            if (whenElements.length > 1) {
                ...
                id, //$NON-NLS-1$
                "whenElementName", whenElementName);
            ...
            if (expressionElements.length > 0) {
                ...
                if (expressionElements.length > 1) {
                    ...
                    addWarning(warningsToLog, //$NON-NLS-1$
                    "There should only be one expression element", //$NON-NLS-1$
                    parentElement, //$NON-NLS-1$
                    id, //$NON-NLS-1$
                    "whenElementName", whenElementName);
                    return ERROR_EXPRESSION;
                ...
                try {
                    ...
                    addWarning(warningsToLog, "Problem creating when element", parentElement, id, "whenElementName", whenElementName);
                    return ERROR_EXPRESSION;
                }
            }
        }
