...
public abstract class AbstractChatExample {
    ...
    private static final String[] GROUPS = new String[] { "Work", "RCP Dev", "Friends" };

    private static final String[] NAMES = new String[] { "Betty Zechman", "Susan Adams", "Samantha Daryn", "Ted Amado" };
