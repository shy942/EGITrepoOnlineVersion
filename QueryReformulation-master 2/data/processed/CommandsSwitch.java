            ...
            case CommandsPackageImpl.BINDING_CONTEXT:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(bindingContext);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            case CommandsPackageImpl.BINDING_TABLE:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(bindingTable);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            case CommandsPackageImpl.COMMAND:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(command);
                    if (result == null)
                        result = caseLocalizable(command);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            case CommandsPackageImpl.COMMAND_PARAMETER:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(commandParameter);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            case CommandsPackageImpl.HANDLER:
                {
                    ...
                    if (result == null)
                        result = caseContribution(handler);
                    if (result == null)
                        result = caseApplicationElement(handler);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            ...
            case CommandsPackageImpl.KEY_BINDING:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(keyBinding);
                    if (result == null)
                        result = caseKeySequence(keyBinding);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            ...
            case CommandsPackageImpl.PARAMETER:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(parameter);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
            case CommandsPackageImpl.CATEGORY:
                {
                    ...
                    if (result == null)
                        result = caseApplicationElement(category);
                    if (result == null)
                        result = caseLocalizable(category);
                    if (result == null)
                        result = defaultCase(theEObject);
                    return result;
                }
