...
*/
public class DynamicTestsViewContentProvider implements IStructuredContentProvider, ITreeContentProvider {
    ...
    public void initialize() {
        String elements[] = new String[] { //$NON-NLS-1$
        "icons/black_triangle.gif", //$NON-NLS-1$
        ...
        "icons/red_triangle.gif" };
        DynamicTestsTreeNode[] nodes = new DynamicTestsTreeNode[elements.length];
        for (int i = 0; i < elements.length; i++) {
            DynamicTestsElement dynamicTestsElement = new DynamicTestsElement(view, elements[i]);
