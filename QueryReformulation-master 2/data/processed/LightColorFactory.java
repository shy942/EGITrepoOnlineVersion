...
*/
    ...
    public void setInitializationData(IConfigurationElement config, String propertyName, Object data) {
        if (data instanceof Hashtable) {
            ...
            //$NON-NLS-1$
            baseColorName = (String) table.get("base");
            //$NON-NLS-1$
            definitionId = (String) table.get("definitionId");
        }
    }
...
*/
    ...
    public RGB createColor() {
        ...
        if (baseColorName == null || definitionId == null)
            return white;
        if (//$NON-NLS-1$
        definitionId.equals("org.eclipse.ui.workbench.ACTIVE_TAB_BG_START"))
            return getActiveFocusStartColor();
        if (//$NON-NLS-1$
        definitionId.equals("org.eclipse.ui.workbench.ACTIVE_TAB_BG_END"))
            return getActiveFocusEndColor();
        if (//$NON-NLS-1$
        definitionId.equals("org.eclipse.ui.workbench.ACTIVE_TAB_TEXT_COLOR"))
            return getActiveFocusTextColor();
        if (//$NON-NLS-1$
        definitionId.equals("org.eclipse.ui.workbench.ACTIVE_NOFOCUS_TAB_BG_START"))
