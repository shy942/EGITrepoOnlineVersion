...
*/
    public  StyledCellLabelProvider(int style) {
        this.style = style & (COLORS_ON_SELECTION | NO_FOCUS) | OWNER_DRAW_ENABLED;
    }
...
*/
    private int updateTextLayout(TextLayout layout, ViewerCell cell, boolean applyColors) {
        ...
        // set also if null to clear previous usages
        layout.setFont(cell.getFont());
        // text width without any styles
        int originalTextWidth = layout.getBounds().width;
...
*/
    public static StyledString styleDecoratedString(String decoratedString, Styler decorationStyler, StyledString styledString) {
        ...
        if (originalStart == -1) {
            // the decorator did something wild
