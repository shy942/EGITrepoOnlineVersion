...
*/
    ...
    private static class DeltaSet<E> extends AbstractSet<E> {
        ...
        @Override
        public int size() {
            return original.size() + diff.getAdditions().size() - diff.getRemovals().size();
        }
    }
...
*/
    ...
    public String toString() {
        ...
        "{additions [").append(//$NON-NLS-1$
        getAdditions() != null ? getAdditions().toString() : "null").append(//$NON-NLS-1$
        "], removals [").append(//$NON-NLS-1$
        getRemovals() != null ? getRemovals().toString() : "null").append(//$NON-NLS-1$
        "]}");
