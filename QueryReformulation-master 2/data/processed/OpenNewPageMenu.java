...
*/
    ...
    protected void run(IPerspectiveDescriptor desc) {
        ...
        if (pageInput == null) {
            ...
            WorkbenchMessages.OpenNewPageMenu_dialogTitle + ": " + WorkbenchMessages.OpenNewPageMenu_unknownPageInput, StatusManager.SHOW);
            return;
        }
        // Open the page.
        try {
            ...
            StatusUtil.handleStatus(WorkbenchMessages.OpenNewPageMenu_dialogTitle + ": " + e.getMessage(), e, StatusManager.SHOW);
        }
    }
