...
public class AllMarkersSeverityAndDescriptionConfigurationArea extends SeverityAndDescriptionConfigurationArea {
    ...
    public void createContents(Composite parent) {
        ...
        severityComposite.setLayoutData(new GridData(GridData.FILL_HORIZONTAL | GridData.GRAB_HORIZONTAL));
    ...
    public void apply(MarkerFieldFilter filter) {
        super.apply(filter);
        ((AllMarkersSeverityAndDescriptionFieldFilter) filter).setFilterOnSeverity(filterOnSeverity);
    }

    @Override
    public void initialize(MarkerFieldFilter filter) {
        super.initialize(filter);
        setFilterOnSeverity(((AllMarkersSeverityAndDescriptionFieldFilter) filter).getFilterOnSeverity());
    }
