...
*/
     CommandImageManagerEvent(final CommandImageManager commandImageManager, final String[] changedCommandIds, final int type, final String style) {
        ...
        if ((changedCommandIds == null) || (changedCommandIds.length < 1)) {
            ...
            "There must be at least one change command identifier");
        }
...
*/
    public final boolean isCommandImageChanged(final String commandId, final int type) {
        return isCommandIdChanged(commandId) && ((type == CommandImageManager.TYPE_DEFAULT) || (type == this.type)) && (style == null);
    }
...
*/
    public final boolean isCommandImageChanged(final String commandId, final int type, final String style) {
        return isCommandIdChanged(commandId) && ((type == CommandImageManager.TYPE_DEFAULT) || (type == this.type)) && ((style == null) || (style.equals(this.style)));
    }
...
*/
    public final boolean isCommandImageChanged(final String commandId, final String style) {
        return isCommandIdChanged(commandId) && (type == CommandImageManager.TYPE_DEFAULT) && ((style == null) || (style.equals(this.style)));
    }
}
