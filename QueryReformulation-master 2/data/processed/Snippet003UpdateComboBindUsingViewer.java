...
public class Snippet003UpdateComboBindUsingViewer {
    ...
    static class View {
        ...
        public Shell createShell() {
            ...
            ViewerSupport.bind(viewer, BeanProperties.list(viewModel.getClass(), "choices", String.class).observe(viewModel), Properties.selfValue(String.class));
            dbc.bindValue(ViewersObservables.observeSingleSelection(viewer), BeanProperties.value(viewModel.getClass(), "text").observe(viewModel));
