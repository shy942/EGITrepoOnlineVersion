    ...
    public void createContents(Composite parent) {
        ...
        completeButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                updateCompletion(CompletionFieldFilter.COMPLETED, completeButton.getSelection());
            }
        });
        ...
        incompleteButton.addSelectionListener(new SelectionAdapter() {
            ...
            @Override
            public void widgetSelected(SelectionEvent e) {
                updateCompletion(CompletionFieldFilter.NOT_COMPLETED, incompleteButton.getSelection());
            }
        });
    }
...
*/
    ...
    public void initialize(MarkerFieldFilter filter) {
        ...
        completeButton.setSelection((CompletionFieldFilter.COMPLETED & completionState) > 0);
        incompleteButton.setSelection((CompletionFieldFilter.NOT_COMPLETED & completionState) > 0);
    }
