...
*/
    ...
    public boolean performOk() {
        if (isValid()) {
            ...
            getPreferenceStore().setValue(IPreferenceConstants.SAVE_AUTOMATICALLY_INTERVAL, intervalField.getTextControl(intervalComposite).getText());
        }
...
*/
    protected int getAutoSaveIntervalTextValue() {
        final int interval;
        if (intervalField != null && intervalComposite != null && !intervalField.getTextControl(intervalComposite).isDisposed()) {
...
*/
    protected void setAutoSaveIntervalTextValue(int interval) {
        if (intervalField != null && intervalComposite != null && !intervalField.getTextControl(intervalComposite).isDisposed() && autoSaveButton != null && !autoSaveButton.isDisposed() && autoSaveButton.getSelection()) {
            intervalField.setStringValue(String.valueOf(interval));
        }
    }
...
*/
    ...
    private void updateEnablement() {
        ...
        if (autoSave) {
            ...
            intervalField.getLabelControl(intervalComposite).setForeground(display.getSystemColor(SWT.COLOR_WIDGET_FOREGROUND));
        } else {
            ...
            intervalField.getLabelControl(intervalComposite).setForeground(display.getSystemColor(SWT.COLOR_TITLE_INACTIVE_FOREGROUND));
        }
    }
...
*/
    private void createIntervalPart() {
        ...
        intervalField = new //$NON-NLS-1$
        IntegerFieldEditor(//$NON-NLS-1$
        IPreferenceConstants.SAVE_AUTOMATICALLY_INTERVAL, //$NON-NLS-1$
        "", intervalComposite);
