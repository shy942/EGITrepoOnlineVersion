...
public class Snippet036ValidationMessageProvider {
    ...
    private static final class MessageProviderWizardPage extends WizardPage {
        ...
        private void createTextLine(Composite parent, String labelText, IObservableValue modelValue) {
            // Create the Label.
            ...
            Binding binding = dbc.bindValue(textObservable, modelValue, new UpdateValueStrategy().setAfterConvertValidator(new RequiredValidator()), new UpdateValueStrategy());
            ...
            ControlDecorationUpdater decorationUpdater = new ControlDecorationUpdater() {
                ...
                protected Image getImage(IStatus status) {
                    ...
                    if (text.getText().length() == 0) {
                        ...
                        FieldDecoration fieldDecoration = FieldDecorationRegistry.getDefault().getFieldDecoration(FieldDecorationRegistry.DEC_REQUIRED);
