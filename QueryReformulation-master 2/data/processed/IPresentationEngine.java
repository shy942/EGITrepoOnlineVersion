...
*/
    //$NON-NLS-1$
    public static String STYLE_OVERRIDE_KEY = "styleOverride";
...
*/
    //$NON-NLS-1$
    public static String WINDOW_MINIMIZED_TAG = "shellMinimized";
...
*/
    //$NON-NLS-1$
    public static String WINDOW_MAXIMIZED_TAG = "shellMaximized";
...
*/
    //$NON-NLS-1$
    public static String WINDOW_TOP_LEVEL = "shellTopLevel";
...
*/
    //$NON-NLS-1$
    public static String SPLIT_HORIZONTAL = "Split Horizontal";
...
*/
    //$NON-NLS-1$
    public static String SPLIT_VERTICAL = "Split Vertical";
