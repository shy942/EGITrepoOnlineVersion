...
*/
    ...
    protected Control createAnimationItem(Composite parent) {
        if (okImage == null) {
            ...
            noneImage = WorkbenchImages.getWorkbenchImageDescriptor("progress/progress_none.png").createImage(//$NON-NLS-1$
            display);
            okImage = WorkbenchImages.getWorkbenchImageDescriptor("progress/progress_ok.png").createImage(//$NON-NLS-1$
            display);
            errorImage = WorkbenchImages.getWorkbenchImageDescriptor("progress/progress_error.png").createImage(//$NON-NLS-1$
            display);
        }
