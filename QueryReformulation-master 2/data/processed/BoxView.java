...
*/
    ...
    public void createPartControl(Composite parent) {
        paintCanvas = new Canvas(parent, SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL | SWT.NO_REDRAW_RESIZE);
    ...
    private void addListeners() {
        paintCanvas.addMouseListener(new MouseAdapter() {
            ...
            public void mouseUp(MouseEvent event) {
                if (event.button != 1) {
                    // abort if right or middle mouse button
                    resetDrag(true);
                    // pressed
                    return;
                }
                ...
                if (dragInProgress) {
                    Box box = new Box(anchorPosition.x, anchorPosition.y, tempPosition.x, tempPosition.y);
...
*/
    private void makeActions() {
        ...
        clearBoxesAction.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_DELETE));
    }
