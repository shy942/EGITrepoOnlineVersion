...
*/
    static boolean promptOnExit(Shell parentShell) {
        ...
        if (promptOnExit) {
            ...
            MessageDialogWithToggle dlg = MessageDialogWithToggle.openOkCancelConfirm(parentShell, IDEWorkbenchMessages.PromptOnExitDialog_shellTitle, message, IDEWorkbenchMessages.PromptOnExitDialog_choice, false, null, null);
...
*/
    private void hookTitleUpdateListeners(IWorkbenchWindowConfigurer configurer) {
        ...
        propertyChangeListener = new IPropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent event) {
                ...
                if (IDEInternalPreferences.WORKSPACE_NAME.equals(property) || IDEInternalPreferences.SHOW_LOCATION.equals(property)) {
    ...
    private String computeTitle() {
        ...
        String workspaceName = IDEWorkbenchPlugin.getDefault().getPreferenceStore().getString(IDEInternalPreferences.WORKSPACE_NAME);
                    ...
                    if (pi != null) {
                        ...
                        if (bundle != null) {
                            try {
                                ...
                                StatusManager.getManager().handle(new Status(IStatus.ERROR, IDEApplication.PLUGIN_ID, "Failed to load feature", exception));
                            }
                        }
                    }
                }
