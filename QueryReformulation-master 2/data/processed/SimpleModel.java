...
public class SimpleModel {
    ...
    private void initialize() {
        ...
        NamedObject[] objects = { new TypeOne("TypeOne instance 1", 2, true, "Some text"), new TypeOne("TypeOne instance 2", 1, false, "Different text"), new TypeOne("TypeOne instance 3", 3, true, "Text"), new TypeOne("TypeOne instance 4", 0, false, "Longer text"), new TypeOne("TypeOne instance 5", 1, true, "Sample"), new TypeTwo("TypeTwo instance 1", false, true), new TypeTwo("TypeTwo instance 2", true, false) };
        add(objects, false);
    }
