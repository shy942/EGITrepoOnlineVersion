...
public class BeanPropertyListenerTest extends AbstractDefaultRealmTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        listener = new BeanPropertyListenerStub(property, propertyDescriptor, simpleListener);
    }
    ...
    public void testPropertyChange_ExpectedPropertyName() {
        ...
        SimplePropertyEvent expectedEvent = new SimplePropertyEvent(SimplePropertyEvent.CHANGE, source, property, Diffs.createValueDiff(oldValue, newValue));
        assertEquals(Collections.singletonList(expectedEvent), simpleListener.log);
    }
    ...
    public void testPropertyChange_NullPropertyName() {
        ...
        listener.propertyChange(new PropertyChangeEvent(source, propertyName, oldValue, newValue));
        SimplePropertyEvent expectedEvent = new SimplePropertyEvent(SimplePropertyEvent.CHANGE, source, property, null);
        assertEquals(Collections.singletonList(expectedEvent), simpleListener.log);
    }
