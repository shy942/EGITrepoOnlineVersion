...
*/
    ...
    public void testLocalPartService() throws Throwable {
        IPartService service = fWindow.getService(IPartService.class);
        MockViewPart view = (MockViewPart) fPage.showView(MockViewPart.ID);
        MockViewPart view2 = (MockViewPart) fPage.showView(MockViewPart.ID2);
        IPartService slaveService = view.getSite().getService(IPartService.class);
        ...
        fPage.activate(view);
        assertTrue(history.verifyOrder(new String[] { "partDeactivated", "partActivated" }));
        ...
        assertTrue(history.verifyOrder(new String[] { "partDeactivated", "partActivated", "partClosed" }));
