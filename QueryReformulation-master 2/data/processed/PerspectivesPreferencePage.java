...
*/
    ...
    protected Control createContents(Composite parent) {
        ...
        // the help content
        PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, IWorkbenchHelpContextIds.PERSPECTIVES_PREFERENCE_PAGE);
...
*/
    ...
    protected void performDefaults() {
        ...
        String newDefault = PrefUtil.getAPIPreferenceStore().getDefaultString(IWorkbenchPreferenceConstants.DEFAULT_PERSPECTIVE_ID);
...
*/
    private boolean canDeletePerspective(IPerspectiveDescriptor desc) {
        ...
        if (modelService.findElements(application, desc.getId(), MPerspective.class, null).isEmpty())
            return true;
        return MessageDialog.openQuestion(getShell(), WorkbenchMessages.PerspectivesPreference_perspectiveopen_title, NLS.bind(WorkbenchMessages.PerspectivesPreference_perspectiveopen_message, desc.getLabel()));
    }
