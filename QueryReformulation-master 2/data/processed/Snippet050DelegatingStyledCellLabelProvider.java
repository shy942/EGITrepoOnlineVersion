...
public class Snippet050DelegatingStyledCellLabelProvider {
    ...
    public void createPartControl(Composite parent) {
        ...
        //$NON-NLS-1$
        final ColumnViewer ownerDrawViewer = createViewer("Owner draw viewer:", composite, styledCellLP1, styledCellLP2);
        CellLabelProvider normalLP1 = new NameAndSizeLabelProvider();
        CellLabelProvider normalLP2 = new ModifiedDateLabelProvider();
        //$NON-NLS-1$
        final ColumnViewer normalViewer = createViewer("Normal viewer:", composite, normalLP1, normalLP2);
    ...
    private static class NameAndSizeLabelProvider extends ColumnLabelProvider implements IStyledLabelProvider {
        ...
        public StyledString getStyledText(Object element) {
            ...
            if (element instanceof File) {
                ...
                if (file.isFile()) {
                    //$NON-NLS-1$
                    String decoration = MessageFormat.format(" ({0} bytes)", new Object[] { new Long(file.length()) });
