...
*/
    private static final Collection<?> expandParameters(final int startIndex, final IParameter[] parameters) {
...
*/
    public static final Collection generateCombinations(final Command command) throws NotDefinedException {
        ...
        while (expansionItr.hasNext()) {
            ...
            if (combination == null) {
                ...
                if (combination.isEmpty()) {
                    ...
                    final Parameterization[] parameterizations = combination.toArray(new Parameterization[combination.size()]);
...
*/
    @Deprecated
    public final Object execute(final Object trigger, final Object applicationContext) throws ExecutionException, NotHandledException {
...
* @since 3.2
*/
    public final Object executeWithChecks(final Object trigger, final Object applicationContext) throws ExecutionException, NotDefinedException, NotEnabledException, NotHandledException {
...
*/
    ...
    private void appendParameter(final StringBuffer nameBuffer, final Parameterization parameterization, boolean shouldAppendName) {
        if (shouldAppendName) {
