...
public class ToolbarThemeProcessor {
    ...
    private static final String PROCESSOR_ID = "org.eclipse.e4.demo.contacts.processor.toolbar";
    ...
    protected void processTheme(String name, MCommand switchCommand, MParameter themeId, String iconURI, EModelService service) {
        MHandledToolItem toolItem = service.createModelElement(MHandledToolItem.class);
