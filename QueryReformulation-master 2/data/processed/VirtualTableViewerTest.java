...
*/
    ...
    public void setUp() {
        super.setUp();
        // run events for SetData precondition test
        processEvents();
    }
...
*/
    ...
    public void testElementsCreated() {
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            assertTrue("Missing data in item " + String.valueOf(i) + " of " + items.length, item.getData() instanceof TestElement);
        }
    }
...
*/
    public void testSetAllSelection() {
        ...
        assertTrue("Size was " + String.valueOf(result.size()) + " expected " + String.valueOf(children.length), (result.size() == children.length));
