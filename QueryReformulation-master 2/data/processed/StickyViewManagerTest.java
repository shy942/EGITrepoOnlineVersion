...
*/
    ...
    protected void doSetUp() throws Exception {
        ...
        originalPreference = PlatformUI.getPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.ENABLE_32_STICKY_CLOSE_BEHAVIOR);
        // this test tests the new behaviour
        PlatformUI.getPreferenceStore().setValue(IWorkbenchPreferenceConstants.ENABLE_32_STICKY_CLOSE_BEHAVIOR, false);
        super.doSetUp();
    }
    ...
    protected void doTearDown() throws Exception {
        ...
        PlatformUI.getPreferenceStore().setValue(IWorkbenchPreferenceConstants.ENABLE_32_STICKY_CLOSE_BEHAVIOR, originalPreference);
    }
...
*/
    public void testMultipleStickyViewAcrossPerspectivesBug280656() throws Exception {
        ...
        page.showView("org.eclipse.ui.tests.api.MockViewPartMultSticky", null, IWorkbenchPage.VIEW_ACTIVATE);
        // show a multi-instance view that has a secondary id
        page.showView("org.eclipse.ui.tests.api.MockViewPartMultSticky", "secondary", IWorkbenchPage.VIEW_ACTIVATE);
        ...
        for (IPerspectiveDescriptor descriptor : descriptors) {
            ...
            assertNotNull(page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", null));
            assertNotNull(page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", "secondary"));
        }
    }
...
*/
    public void testRemovedMultipleStickyViewAcrossPerspectives() throws Exception {
        ...
        IWorkbenchPage page = fWorkbench.getActiveWorkbenchWindow().getActivePage();
        IViewReference primaryViewReference = page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", null);
        IViewReference secondaryViewReference = page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", "secondary");
        ...
        for (IPerspectiveDescriptor descriptor : descriptors) {
            ...
            // hidden
            page.setPerspective(descriptor);
            assertNull(page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", null));
            assertNull(page.findViewReference("org.eclipse.ui.tests.api.MockViewPartMultSticky", "secondary"));
        }
    }
...
*/
    public void testRemovedMultipleStickyViewAcrossPerspectives2() throws Exception {
        ...
        IPerspectiveDescriptor resourcePerspectiveDescriptor = registry.findPerspectiveWithId("org.eclipse.ui.resourcePerspective");
        IPerspectiveDescriptor viewPerspectiveDescriptor = registry.findPerspectiveWithId("org.eclipse.ui.tests.api.ViewPerspective");
        IWorkbenchPage page = fWorkbench.getActiveWorkbenchWindow().getActivePage();
        page.setPerspective(resourcePerspectiveDescriptor);
        // show some multi-instance sticky view instances
        IViewPart primaryViewPart = page.showView("org.eclipse.ui.tests.api.MockViewPartMultSticky", null, IWorkbenchPage.VIEW_ACTIVATE);
        page.showView("org.eclipse.ui.tests.api.MockViewPartMultSticky", "secondary", IWorkbenchPage.VIEW_ACTIVATE);
        // show the 'Outline' view, a non-sticky view
        IViewPart outlineViewPart = page.showView(IPageLayout.ID_OUTLINE, null, IWorkbenchPage.VIEW_ACTIVATE);
