            ...
            switch(index) {
                case COMMAND_NAME_COLUMN:
                    ...
                    try {
                        ...
                        final String message = "Problem retrieving image for a command '" + commandId + '\'';
    ...
    private final void createDataControls(final Composite parent) {
        ...
        fWhenCombo.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public final void selectionChanged(final SelectionChangedEvent event) {
                ContextElement context = (ContextElement) ((IStructuredSelection) event.getSelection()).getFirstElement();
                if (context != null) {
        ...
        IPropertyChangeListener whenListener = new IPropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent event) {
                if (event.getSource() == keyController.getContextModel() && CommonModel.PROP_SELECTED_ELEMENT.equals(event.getProperty())) {
        ...
        // filler
        new Label(rightDataArea, SWT.NONE);
        ...
        IPropertyChangeListener dataUpdateListener = new IPropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent event) {
                ...
                if (event.getSource() == keyController.getBindingModel() && CommonModel.PROP_SELECTED_ELEMENT.equals(event.getProperty())) {
                    ...
                    weCare = true;
                } else if (event.getSource() == keyController.getBindingModel().getSelectedElement() && ModelElement.PROP_MODEL_OBJECT.equals(event.getProperty())) {
                ...
                if (bindingElement == null && weCare) {
                    ...
                    //$NON-NLS-1$
                    fDescriptionText.setText(desc == null ? "" : desc);
...
*/
    ...
    private void createSchemeControls(Composite parent) {
        ...
        IPropertyChangeListener listener = new IPropertyChangeListener() {
            ...
            @Override
            public void propertyChange(PropertyChangeEvent event) {
                if (event.getSource() == keyController.getSchemeModel() && CommonModel.PROP_SELECTED_ELEMENT.equals(event.getProperty())) {
                    Object newVal = event.getNewValue();
                    StructuredSelection structuredSelection = newVal == null ? null : new StructuredSelection(newVal);
    ...
    protected final void performDefaults() {
        ...
        if (confirmed) {
            ...
            if (DEBUG) {
                ...
                Tracing.printTrace(TRACING_COMPONENT, //$NON-NLS-1$ //$NON-NLS-2$
                "performDefaults:model in " + elapsedTime + "ms");
            }
        }
