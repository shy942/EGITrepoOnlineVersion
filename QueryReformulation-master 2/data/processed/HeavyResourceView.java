...
public class HeavyResourceView extends ViewPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        explanation.setText("This view allocates all available SWT resources on demand. " + "This is not supposed to be a recoverable error, and is expected to crash the workbench. " + "This view allows us observe the workbench when it crashes in this manner.");
