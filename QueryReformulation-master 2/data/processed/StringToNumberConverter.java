...
*/
        try {
            ...
            //$NON-NLS-1$
            icuBigDecimalScale = icuBigDecimal.getMethod("scale");
            //$NON-NLS-1$
            icuBigDecimalUnscaledValue = icuBigDecimal.getMethod("unscaledValue");
...
*/
    ...
    public Object convert(Object fromObject) {
        ParseResult result = StringToNumberParser.parse(fromObject, numberFormat, toType.isPrimitive());
...
*/
        if (Integer.class.equals(boxedType)) {
            ...
            if (n instanceof Long)
                ...
                "Consider using ICU4J or Java 5 which can properly format and parse these types.");
            }
        ...
        if (min != null && max != null) {
            throw new IllegalArgumentException(StringToNumberParser.createOutOfRangeMessage(min, max, numberFormat));
        }
        /*
...
*/
        ...
        "Could not convert [" + fromObject + "] to type [" + toType + "]");
    }
