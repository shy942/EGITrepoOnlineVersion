...
*/
    public void testKeyValueTypeNull() throws Exception {
        ...
        DetailObservableMap detailObservable = new DetailObservableMap(factory, observableValue, null, null);
...
*/
    public void testKeyValueTypeNotNull() throws Exception {
        WritableValue observableValue = new WritableValue();
        WritableMapFactory factory = new WritableMapFactory();
        DetailObservableMap detailObservable = new DetailObservableMap(factory, observableValue, Object.class, Object.class);
...
*/
    public void testMasterNotDisposedWhenDetailDisposed() {
        ...
        WritableMapFactory factory = new WritableMapFactory();
        DetailObservableMap detailObservable = new DetailObservableMap(factory, outerObservable, null, null);
    ...
    public void testDisposeWhileFiringEvents() {
        ...
        detailObservable[0] = MasterDetailObservables.detailMap(master, factory, null, null);
