...
*/
    public void testWindowChildWhenDialog() throws NotDefinedException, ParseException {
        ...
        bindingManager.addBinding(new KeyBinding(KeySequence.getInstance("CTRL+F"), parameterizedCommand, scheme.getId(), windowChildContext.getId(), null, null, null, Binding.SYSTEM));
...
*/
        ...
        assertTrue("The previous contexts should include the dialog context", previousContextIds.contains(IContextIds.CONTEXT_ID_DIALOG));
        assertTrue("The previous contexts should include the dialog context", previousContextIds.contains(IContextIds.CONTEXT_ID_DIALOG_AND_WINDOW));
        assertTrue("The previous contexts should include the dialog context", previousContextIds.contains(windowChildContext.getId()));
