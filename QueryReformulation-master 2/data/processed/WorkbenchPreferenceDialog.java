...
*/
            ...
            dialog.create();
            PlatformUI.getWorkbench().getHelpSystem().setHelp(dialog.getShell(), IWorkbenchHelpContextIds.PREFERENCE_DIALOG);
        } else {
            /*
...
*/
    public  WorkbenchPreferenceDialog(Shell parentShell, PreferenceManager manager) {
        ...
        Assert.isTrue((instance == null), //$NON-NLS-1$
    ...
    public int open() {
        ...
        if ((initialPageId != null) && (selectedPage != null)) {
            ...
            if ((shell != null) && (!shell.isDisposed())) {
                // make the dialog visible to properly set the focus
                shell.open();
