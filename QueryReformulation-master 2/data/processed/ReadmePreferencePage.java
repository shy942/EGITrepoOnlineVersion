...
*/
    ...
    protected Control createContents(Composite parent) {
        ...
        //$NON-NLS-1$
        createLabel(composite_textField, MessageUtil.getString("Text_Field"));
        textField = createTextField(composite_textField);
        //$NON-NLS-1$
        createPushButton(composite_textField, MessageUtil.getString("Change"));
        //composite_tab << parent
        Composite composite_tab = createComposite(parent, 2);
        createLabel(composite_tab, MessageUtil.getString(//$NON-NLS-1$
        "Radio_Button_Options"));
        //
        tabForward(composite_tab);
        //radio button composite << tab composite
        Composite composite_radioButton = createComposite(composite_tab, 1);
        radioButton1 = createRadioButton(composite_radioButton, MessageUtil.getString(//$NON-NLS-1$
        "Radio_button_1"));
        radioButton2 = createRadioButton(composite_radioButton, MessageUtil.getString(//$NON-NLS-1$
        "Radio_button_2"));
        radioButton3 = createRadioButton(composite_radioButton, MessageUtil.getString(//$NON-NLS-1$
        "Radio_button_3"));
        //composite_tab2 << parent
        Composite composite_tab2 = createComposite(parent, 2);
        //$NON-NLS-1$
        createLabel(composite_tab2, MessageUtil.getString("Check_Box_Options"));
        //
        tabForward(composite_tab2);
        //composite_checkBox << composite_tab2
        Composite composite_checkBox = createComposite(composite_tab2, 1);
        checkBox1 = createCheckBox(composite_checkBox, MessageUtil.getString(//$NON-NLS-1$
        "Check_box_1"));
        checkBox2 = createCheckBox(composite_checkBox, MessageUtil.getString(//$NON-NLS-1$
        "Check_box_2"));
        checkBox3 = createCheckBox(composite_checkBox, MessageUtil.getString(//$NON-NLS-1$
        "Check_box_3"));
        initializeValues();
        //font = null;
