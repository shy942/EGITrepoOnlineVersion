...
*/
    ...
    public void testExpansion() {
        ...
        assertEqualsArray("element expansion", new Object[] { element_1, element_2_1 }, getTreeViewer().getExpandedElements());
        assertEqualsArray("path expansion", new Object[] { treePath_1, treePath_1_21 }, getTreeViewer().getExpandedTreePaths());
        getTreeViewer().setExpandedTreePaths(new TreePath[] { treePath_1, treePath_1_2, treePath_1_2_21, treePath_2, treePath_2_21 });
