...
public class DetailObservableValueTest extends AbstractDefaultRealmTestCase {
    ...
    public void testSetValue() throws Exception {
        ...
        IObservableValue detailObservable = MasterDetailObservables.detailValue(outerObservable, factory, null);
...
*/
    public void testGetValueTypeNullValueType() throws Exception {
        WritableValueFactory factory = new WritableValueFactory();
        DetailObservableValue detailObservable = new DetailObservableValue(outerObservable, factory, null);
...
*/
    ...
    public void testDisposeWhileFiringEvents() {
        ...
        detailObservable[0] = MasterDetailObservables.detailValue(master, factory, null);
...
*/
    static class WritableValueFactory implements IObservableFactory {
        ...
        public IObservable createObservable(Object target) {
            return innerObservable = new WritableValue(realm == null ? Realm.getDefault() : realm, target, type);
        }
    }
    ...
    private static class Delegate extends AbstractObservableValueContractDelegate {
        ...
        public IObservableValue createObservableValue(Realm realm) {
            ...
            return new DetailObservableValueStub(masterObservableValue, valueFactory, valueType);
        }
