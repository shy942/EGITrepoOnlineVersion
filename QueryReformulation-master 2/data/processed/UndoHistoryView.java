...
*/
    private IUndoContext selectContext() {
        ...
        IUndoableOperation[] operations = history.getUndoHistory(IOperationHistory.GLOBAL_UNDO_CONTEXT);
        ...
        ElementListSelectionDialog dialog = new ElementListSelectionDialog(getSite().getShell(), labelProvider);
...
*/
    private void fillContextMenu(IMenuManager manager) {
        ...
        if (!selection.isEmpty()) {
            IUndoableOperation operation = (IUndoableOperation) ((IStructuredSelection) selection).getFirstElement();
...
*/
    private void makeActions() {
        ...
        selectiveUndoAction.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_UNDO));
...
*/
    private void showMessage(String message) {
        MessageDialog.openInformation(viewer.getControl().getShell(), UndoExampleMessages.UndoHistoryView_InfoDialogTitle, message);
    }
