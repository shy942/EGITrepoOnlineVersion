...
public class Snippet035PostSelectionProvider {
    ...
    private void createFieldSection(Composite parent) {
        ...
        IViewerObservableValue selectionObservable = ViewerProperties.singleSelection().observe(listViewer);
        ...
        IViewerObservableValue postSelectionObservable = ViewerProperties.singlePostSelection().observe(listViewer);
