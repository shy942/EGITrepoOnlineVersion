...
public class Form extends Composite {
    ...
    private class FormLayout extends Layout implements ILayoutExtension {
        ...
        public Point computeSize(Composite composite, int wHint, int hHint, boolean flushCache) {
            ...
            int width = 0;
            int height = 0;
            Point hsize = headCache.computeSize(FormUtil.getWidthHint(wHint, head), SWT.DEFAULT);
            ...
            if (ignoreBody)
                ...
                bsize = bodyCache.computeSize(FormUtil.getWidthHint(wHint, body), SWT.DEFAULT);
