...
*/
    private Composite createInfoArea(Composite parent) {
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            label.setImage(PlatformUI.getWorkbench().getSharedImages().getImage(IDEInternalWorkbenchImages.IMG_OBJS_WELCOME_ITEM));
        ...
        if (wrapped && (imageLabel != null)) {
            ...
            infoArea.addListener(SWT.Resize,  event -> {
                ...
                Point p2 = infoArea.computeSize(SWT.DEFAULT, SWT.DEFAULT, true);
...
*/
    ...
    public void createPartControl(Composite parent) {
        ...
        getSite().getWorkbenchWindow().getWorkbench().getHelpSystem().setHelp(editorComposite, IIDEHelpContextIds.WELCOME_EDITOR);
...
*/
    private Composite createTitleArea(Composite parent) {
        ...
        titleImage.setImage(PlatformUI.getWorkbench().getSharedImages().getImage(IDEInternalWorkbenchImages.IMG_OBJS_WELCOME_BANNER));
        gd = new GridData();
...
*/
    ...
    public void init(IEditorSite site, IEditorInput input) throws PartInitException {
        if (!(input instanceof WelcomeEditorInput)) {
            ...
            "Invalid Input: Must be WelcomeEditorInput");
        }
        setSite(site);
        setInput(input);
    }
...
*/
    public void readFile() {
        ...
        try {
            ...
            IStatus status = new Status(IStatus.ERROR, IDEWorkbenchPlugin.IDE_WORKBENCH, 1, IDEWorkbenchMessages.WelcomeEditor_accessException, e);
