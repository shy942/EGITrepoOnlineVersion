...
*/
        ...
        if (iconURI != null && iconURI.length() > 0) {
            ...
            if (iconDescriptor != null) {
                try {
                    ...
                    image = resourceManager.createImage(iconDescriptor);
                    Activator.trace(Policy.DEBUG_MENUS, "failed to create image " + iconURI, e);
                }
            }
        }
        return image;
    ...
    protected void updateIcons() {
        ...
        //$NON-NLS-1$
        String iconURI = modelItem.getIconURI() != null ? modelItem.getIconURI() : "";
            ...
            updateRunner = new ISafeRunnable() {
                ...
                public void handleException(Throwable exception) {
                    if (!logged) {
                        logged = true;
                        if (logger != null) {
                            logger.error(exception, //$NON-NLS-1$
