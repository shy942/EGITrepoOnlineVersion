...
*/
    ...
    protected void run(IPerspectiveDescriptor desc) {
        ...
        if (pageInput == null) {
            ...
            WorkbenchMessages.OpenNewWindowMenu_dialogTitle + ": " + WorkbenchMessages.OpenNewWindowMenu_unknownInput, StatusManager.SHOW);
            return;
        }
        // Open the page.
        try {
            ...
            StatusUtil.handleStatus(WorkbenchMessages.OpenNewWindowMenu_dialogTitle + ": " + e.getMessage(), e, StatusManager.SHOW);
        }
    }
