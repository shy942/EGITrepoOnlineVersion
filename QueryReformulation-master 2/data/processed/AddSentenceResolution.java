    ...
    public void run(IMarker marker) {
        ...
        if (editorPart == null) {
            ...
            try {
                ...
                MessageDialog.openError(w.getShell(), MessageUtil.getString("Resolution_Error"), MessageUtil.getString("Unable_to_open_file_editor"));
            }
        }
        ...
        //$NON-NLS-1$
        String s = MessageUtil.getString("Simple_sentence");
        try {
