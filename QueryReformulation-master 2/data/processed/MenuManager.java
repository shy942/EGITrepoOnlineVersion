...
*/
    ...
    public boolean isVisible() {
        if (!visible) {
            // short circuit calculations in this case
            return false;
        }
        if (removeAllWhenShown) {
...
*/
    ...
    public String toString() {
        ...
        "MenuManager [" + (menuText != null ? "text=" + menuText + ", " : "") + (id != null ? "id=" + id + ", " : "") + "visible=" + visible + //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
        "]";
    }
}
