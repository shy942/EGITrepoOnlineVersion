...
public class SizeSection extends AbstractPropertySection {
    ...
    private ModifyListener listener = new ModifyListener() {
        ...
        public void modifyText(ModifyEvent arg0) {
            ...
            SizePropertySource sizePropertySource = (SizePropertySource) properties.getPropertyValue(ButtonElementProperties.PROPERTY_SIZE);
            sizePropertySource.setPropertyValue(SizePropertySource.ID_HEIGHT, heightText.getText());
            sizePropertySource.setPropertyValue(SizePropertySource.ID_WIDTH, widthText.getText());
        }
    };
...
*/
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        FormData data;
        CLabel widthLabel = getWidgetFactory().createCLabel(composite, //$NON-NLS-1$
        "Width:");
        //$NON-NLS-1$
        widthText = getWidgetFactory().createText(composite, "");
        CLabel heightLabel = getWidgetFactory().createCLabel(composite, //$NON-NLS-1$
        "Height:");
        //$NON-NLS-1$
        heightText = getWidgetFactory().createText(composite, "");
        data = new FormData();
        ...
        data.right = new FormAttachment(heightLabel, -ITabbedPropertyConstants.HSPACE);
        data.top = new FormAttachment(0, 0);
