...
*/
    public final void testHandlerChangeCausesUpdate() {
        final PubliclyRetargettableAction retargetAction = new PubliclyRetargettableAction("actionID", "text");
        ...
        retargetAction.changeHandler(new PubliclyRetargettableAction("actionID", "text"));
