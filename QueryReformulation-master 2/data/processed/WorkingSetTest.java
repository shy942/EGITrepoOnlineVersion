...
public class WorkingSetTest extends NavigatorTestBase {
    ...
    public void testEmptyWindowWorkingSet() throws Exception {
        ...
        WorkingSetActionProvider provider = (WorkingSetActionProvider) TestAccessHelper.getActionProvider(_contentService, _actionService, WorkingSetActionProvider.class);
        ...
        PropertyChangeEvent event = new PropertyChangeEvent(this, WorkingSetFilterActionGroup.CHANGE_WORKING_SET, null, workingSet);
    ...
    public void testMissingProjectsInWorkingSet() throws Exception {
        ...
        IPropertyChangeListener l = provider.getFilterChangeListener();
        PropertyChangeEvent event = new PropertyChangeEvent(this, WorkingSetFilterActionGroup.CHANGE_WORKING_SET, null, agWorkingSet);
        l.propertyChange(event);
    ...
    public void testTopLevelWorkingSet() throws Exception {
        WorkingSetActionProvider provider = (WorkingSetActionProvider) TestAccessHelper.getActionProvider(_contentService, _actionService, WorkingSetActionProvider.class);
        IExtensionStateModel extensionStateModel = _contentService.findStateModel(WorkingSetsContentProvider.EXTENSION_ID);
    ...
    public void testTopLevelChange() throws Exception {
        ...
        // working set events
        INavigatorContentExtension ce = _contentService.getContentExtensionById(WorkingSetsContentProvider.EXTENSION_ID);
    ...
    public void testMultipleWorkingSets() throws Exception {
        ...
        PropertyChangeEvent event = new PropertyChangeEvent(this, WorkingSetFilterActionGroup.CHANGE_WORKING_SET, null, agWorkingSet);
        l.propertyChange(event);
        assertEquals(WorkbenchNavigatorMessages.WorkingSetActionProvider_multipleWorkingSets, _commonNavigator.getWorkingSetLabel());
    }
    ...
    public void testWorkingSetFilter() throws Exception {
        ...
        assertTrue(found);
        _contentService.getFilterService().activateFilterIdsAndUpdateViewer(new String[] { TEST_FILTER_P1, TEST_FILTER_P2 });
        vf = _viewer.getFilters();
        found = false;
        for (int i = 0; i < vf.length; i++) {
            if (vf[i] instanceof ResourceWorkingSetFilter)
    ...
    public void testDeletedAndRecreated() throws Exception {
        ...
        IPropertyChangeListener l = provider.getFilterChangeListener();
        PropertyChangeEvent event = new PropertyChangeEvent(this, WorkingSetFilterActionGroup.CHANGE_WORKING_SET, null, ws2);
        l.propertyChange(event);
        DisplayHelper.runEventLoop(Display.getCurrent(), 100);
        TreeItem[] items = _viewer.getTree().getItems();
