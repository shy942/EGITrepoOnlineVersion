...
*/
    ...
    private void logMissingExtension(Object parent, Object object) {
        NavigatorPlugin.logError(0, NLS.bind(CommonNavigatorMessages.CommonViewerSorter_NoContentExtensionForObject, object != null ? object.toString() : "<null>", parent != null ? parent.toString() : "<null>"), //$NON-NLS-1$ //$NON-NLS-2$
        null);
    }
        ...
        if (sourceOfLvalue == sourceOfRvalue) {
            ...
            switch(whoknows) {
                case BOTH_UNDERSTAND:
                    sorter = sourceOfLvalue.getSequenceNumber() < sourceOfRvalue.getSequenceNumber() ? sorterService.findSorter(sourceOfLvalue, parent, e1, e2) : sorterService.findSorter(sourceOfRvalue, parent, e1, e2);
                    break;
    ...
    private INavigatorContentDescriptor getSource(Object o) {
        ...
        if (ncd != null) {
            if (Policy.DEBUG_SORT)
                //$NON-NLS-1$//$NON-NLS-2$
                System.out.println("sort: " + ncd + " object: " + o);
            return ncd;
        }
        ...
        if (Policy.DEBUG_SORT)
            //$NON-NLS-1$
            System.out.println("sort: NULL object: " + o);
        return null;
    }
}
