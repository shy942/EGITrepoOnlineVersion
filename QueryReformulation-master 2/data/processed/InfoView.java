...
public class InfoView extends ViewPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        IPersonService service = getSite().getService(IPersonService.class);
    ...
    private void createHandlers() {
        ...
        countHandler = new AbstractHandler() {
            ...
            public Object execute(ExecutionEvent event) {
                ...
                MessageDialog.openInformation(getSite().getShell(), ContributionMessages.SampleHandler_plugin_name, NLS.bind(ContributionMessages.InfoView_countElements, elements.size()));
                return null;
            }
        };
