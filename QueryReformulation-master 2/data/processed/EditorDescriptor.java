...
*/
    public IEditorActionBarContributor createActionBarContributor() {
        ...
        try {
            contributor = (IEditorActionBarContributor) WorkbenchPlugin.createExtension(configurationElement, IWorkbenchRegistryConstants.ATT_CONTRIBUTOR_CLASS);
        } catch (CoreException e) {
            WorkbenchPlugin.log("Unable to create editor contributor: " + id, e.getStatus());
        }
        return contributor;
    }
    ...
    public ImageDescriptor getImageDescriptor() {
        ...
        synchronized (imageDescLock) {
            ...
            if (tempDescriptor == null) {
                // still null? return default image
        ...
        if (// @issue what should be the default image?
        img == null)
...
*/
    protected boolean loadValues(IMemento memento) {
        ...
        if (openMode != OPEN_EXTERNAL && openMode != OPEN_INTERNAL && openMode != OPEN_INPLACE) {
            ...
            "Ignoring editor descriptor with invalid openMode: " + this);
            return false;
        }
...
*/
    ...
    public String toString() {
        ...
        return "EditorDescriptor(id=" + getId() + ", label=" + getLabel() + ")";
    }
            ...
            if (program == null && configurationElement != null) {
                if (configurationElement.getAttribute(IWorkbenchRegistryConstants.ATT_MATCHING_STRATEGY) != null) {
                    try {
                        ...
                        WorkbenchPlugin.log("Error creating editor management policy for editor id " + getId(), e);
                    }
                }
            }
        }
