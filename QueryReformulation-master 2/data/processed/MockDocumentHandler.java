...
public class MockDocumentHandler implements org.w3c.css.sac.DocumentHandler {
    ...
    public void endDocument(InputSource source) throws CSSException {
        System.out.println("[MockDocumentHandler#endDocument], source= " + source);
    }
    ...
    public void endPage(String name, String pseudo_page) throws CSSException {
        System.out.println("[MockDocumentHandler#endPage], name=" + name + ", pseudo_page=" + pseudo_page);
    }
    ...
    public void property(String name, LexicalUnit value, boolean important) throws CSSException {
        System.out.println("[MockDocumentHandler#property], name=" + name + ", value=" + value);
    }
