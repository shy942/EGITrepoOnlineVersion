...
public class NewTableScenarios extends ScenariosTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        images = new Image[] { getShell().getDisplay().getSystemImage(SWT.ICON_ERROR), getShell().getDisplay().getSystemImage(SWT.ICON_WARNING), getShell().getDisplay().getSystemImage(SWT.ICON_INFORMATION) };
    }
