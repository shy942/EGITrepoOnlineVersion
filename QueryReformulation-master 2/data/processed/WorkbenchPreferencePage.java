...
*/
    protected void createShowUserDialogPref(Composite composite) {
        ...
        showUserDialogButton.setSelection(WorkbenchPlugin.getDefault().getPreferenceStore().getBoolean(IPreferenceConstants.RUN_IN_BACKGROUND));
    }
...
*/
    protected void createHeapStatusPref(Composite composite) {
        ...
        showHeapStatusButton.setSelection(PrefUtil.getAPIPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.SHOW_MEMORY_MONITOR));
    }
...
*/
    private void createSaveIntervalGroup(Composite composite) {
        ...
        saveInterval = new IntegerFieldEditor(IPreferenceConstants.WORKBENCH_SAVE_INTERVAL, WorkbenchMessages.WorkbenchPreference_workbenchSaveInterval, groupComposite);
        ...
        saveInterval.setErrorMessage(NLS.bind(WorkbenchMessages.WorkbenchPreference_workbenchSaveIntervalError, Integer.valueOf(MAX_SAVE_INTERVAL)));
    ...
    protected void createOpenModeGroup(Composite composite) {
        ...
        createNoteComposite(font, buttonComposite, WorkbenchMessages.Preference_note, WorkbenchMessages.WorkbenchPreference_noEffectOnAllViews);
    }
...
*/
    ...
    protected void performDefaults() {
        ...
        showHeapStatusButton.setSelection(PrefUtil.getAPIPreferenceStore().getDefaultBoolean(IWorkbenchPreferenceConstants.SHOW_MEMORY_MONITOR));
