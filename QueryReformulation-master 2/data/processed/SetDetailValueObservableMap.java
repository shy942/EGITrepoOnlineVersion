...
public class SetDetailValueObservableMap<M, E> extends ComputedObservableMap<M, E> implements IObserving {
    ...
    private IStaleListener detailStaleListener = new IStaleListener() {
        ...
        public void handleStale(StaleEvent staleEvent) {
            addStaleDetailObservable((IObservableValue<?>) staleEvent.getObservable());
        }
    };
...
*/
    ...
    public E remove(Object key) {
        ...
        @SuppressWarnings("unchecked") IObservableValue<E> detailValue = getDetailObservableValue((M) key);
        E oldValue = detailValue.getValue();
        keySet().remove(key);
        return oldValue;
    }
    ...
    public boolean isStale() {
        return super.isStale() || staleDetailObservables != null && !staleDetailObservables.isEmpty();
    }
