...
public class TestLabelProviderBlue extends TestStyledLabelProvider {
    ...
    protected void initSubclass() {
        backgroundColor = Display.getCurrent().getSystemColor(SWT.COLOR_BLUE);
        backgroundColorName = "Blue";
        font = new Font(Display.getDefault(), boldFontData);
        image = PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_ETOOL_SAVE_EDIT);
        instance = this;
    }
}
