...
public class CSSPropertyThemeElementDefinitionHandler implements ICSSPropertyHandler {
    ...
    public boolean applyCSSProperty(Object element, String property, CSSValue value, String pseudo, CSSEngine engine) throws Exception {
        ...
        IThemeElementDefinitionOverridable<?> definition = (IThemeElementDefinitionOverridable<?>) ((ThemeDefinitionElement<?>) element).getNativeWidget();
    ...
    private BundleLocalization getBundleLocalization(Bundle bundle) {
        ServiceReference<BundleLocalization> ref = bundle.getBundleContext().getServiceReference(BundleLocalization.class);
    ...
    private boolean hasResourceBundleUrl(CSSValue value) {
        return value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE && ((CSSPrimitiveValue) value).getPrimitiveType() == CSSPrimitiveValue.CSS_URI;
    }
}
