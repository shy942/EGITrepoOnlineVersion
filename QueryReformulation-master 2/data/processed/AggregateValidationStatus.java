...
*/
    public  AggregateValidationStatus(final IObservableCollection validationStatusProviders, int strategy) {
...
* @since 1.1
*/
    public  AggregateValidationStatus(final Realm realm, final IObservableCollection validationStatusProviders, int strategy) {
...
*/
    public static IStatus getStatusMerged(Collection validationStatusProviders) {
        ...
        if (!statuses.isEmpty()) {
            MultiStatus result = new MultiStatus(Policy.JFACE_DATABINDING, 0, BindingMessages.getString(BindingMessages.MULTIPLE_PROBLEMS), null);
