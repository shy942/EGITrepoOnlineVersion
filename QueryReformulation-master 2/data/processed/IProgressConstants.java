...
* </p>
*/
    public static final QualifiedName KEEP_PROPERTY = new QualifiedName(PROPERTY_PREFIX, //$NON-NLS-1$
    "keep");
...
* </p>
**/
    public static final QualifiedName KEEPONE_PROPERTY = new QualifiedName(PROPERTY_PREFIX, //$NON-NLS-1$
    "keepone");
...
**/
    public static final QualifiedName ACTION_PROPERTY = new QualifiedName(PROPERTY_PREFIX, //$NON-NLS-1$
    "action");
...
**/
    public static final QualifiedName ICON_PROPERTY = new QualifiedName(PROPERTY_PREFIX, //$NON-NLS-1$
    "icon");
...
*/
    //$NON-NLS-1$
    public static String PROGRESS_VIEW_ID = "org.eclipse.ui.views.ProgressView";
...
*/
    public static final QualifiedName PROPERTY_IN_DIALOG = new QualifiedName(IProgressConstants.PROPERTY_PREFIX, //$NON-NLS-1$
    "inDialog");
...
* @since 3.1
*/
    public static final QualifiedName NO_IMMEDIATE_ERROR_PROMPT_PROPERTY = new QualifiedName(PROPERTY_PREFIX, //$NON-NLS-1$
    "delayErrorPrompt");
}
