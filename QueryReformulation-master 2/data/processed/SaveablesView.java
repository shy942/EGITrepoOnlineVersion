...
*/
    class ViewContentProvider implements IStructuredContentProvider {
        ...
        public Object[] getElements(Object parent) {
            return ((SaveablesList) getSite().getService(ISaveablesLifecycleListener.class)).getOpenModels();
        }
    }
    ...
    class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
        ...
        public Image getImage(Object obj) {
            ImageDescriptor descriptor = ((Saveable) obj).getImageDescriptor();
...
*/
    ...
    @Override
    public void dispose() {
        ((SaveablesList) getSite().getService(ISaveablesLifecycleListener.class)).removeModelLifecycleListener(saveablesLifecycleListener);
...
*/
    ...
    public void createPartControl(Composite parent) {
        ...
        ((SaveablesList) getSite().getService(ISaveablesLifecycleListener.class)).addModelLifecycleListener(saveablesLifecycleListener);
        makeActions();
        hookContextMenu();
    }
    ...
    private void makeActions() {
        ...
        printSourcesAction.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_OBJS_INFO_TSK));
    }
