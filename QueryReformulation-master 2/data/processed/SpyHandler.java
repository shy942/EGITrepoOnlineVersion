        ...
        while (control != null) {
            if (control instanceof Table) {
                ...
                if (table.getSelectionCount() == 1) {
                    ...
                    contributionInfo = getContributionInfo(tableItem.getData(), ContributionInfoMessages.ContributionInfo_TableItem);
                ...
                if (tree.getSelectionCount() == 1) {
                    ...
                    contributionInfo = getContributionInfo(treeItem.getData(), ContributionInfoMessages.ContributionInfo_TreeItem);
                    if (contributionInfo != null) {
    ...
    protected void doShowTooltip(Control control, Point offset, final ContributionInfo contributionInfo) {
        ToolTip toolTip = new ToolTip(control, ToolTip.NO_RECREATE, true) {
            ...
            protected Composite createToolTipContentArea(Event event, Composite parent) {
                ...
                String info = NLS.bind(ContributionInfoMessages.ContributionInfo_ContributedBy, contributionInfo.getElementType(), contributionInfo.getBundleId());
                text.setText(info);
