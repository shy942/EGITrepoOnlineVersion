...
final class Activity implements IActivity {
    ...
    public int compareTo(Object object) {
        ...
        int compareTo = Util.compare(activityRequirementBindingsAsArray, castedObject.activityRequirementBindingsAsArray);
        if (compareTo == 0) {
    ...
    public boolean isMatch(String string) {
        if (isDefined()) {
            for (Iterator iterator = activityPatternBindings.iterator(); iterator.hasNext(); ) {
