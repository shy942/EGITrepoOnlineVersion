    ...
    private class ToggleWorkingSetAction extends Action {
        ...
        public void runWithEvent(Event event) {
            ...
            if (isChecked()) {
                ...
                // additive.
                boolean modified = (event.stateMask & KeyLookupFactory.getDefault().formalModifierLookup(IKeyLookup.M1_NAME)) != 0;
                if (modified)
                    newList.clear();
                newList.add(set);
            } else {
            ...
            getWindow().getActivePage().setWorkingSets((IWorkingSet[]) newList.toArray(new IWorkingSet[newList.size()]));
        }
    }
