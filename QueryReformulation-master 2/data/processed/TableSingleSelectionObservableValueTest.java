...
public class TableSingleSelectionObservableValueTest extends ObservableDelegateTest {
    ...
    protected IObservable doCreateObservable() {
        ...
        return delegate.createObservableValue(DisplayRealm.getRealm(Display.getDefault()));
    }
    ...
    public void testGetValue() throws Exception {
        ...
        assertEquals("observable value", Integer.valueOf(value), observable.getValue());
    }
    ...
    static class Delegate extends AbstractObservableValueContractDelegate {
        ...
        public void change(IObservable observable) {
            int index = createIntegerValue((IObservableValue) observable).intValue();
            table.select(index);
