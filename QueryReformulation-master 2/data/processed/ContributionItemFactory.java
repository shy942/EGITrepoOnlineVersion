...
*/
    public static final ContributionItemFactory PIN_EDITOR = new ContributionItemFactory(//$NON-NLS-1$
    "pinEditor") {
        ...
        public IContributionItem create(final IWorkbenchWindow window) {
            ...
            CommandContributionItemParameter parameter = new CommandContributionItemParameter(window, COMMAND_ID, COMMAND_ID, null, WorkbenchImages.getImageDescriptor(IWorkbenchGraphicConstants.IMG_ETOOL_PIN_EDITOR), WorkbenchImages.getImageDescriptor(IWorkbenchGraphicConstants.IMG_ETOOL_PIN_EDITOR_DISABLED), // Local workaround for http://bugs.eclipse.org/387583
            null, // Local workaround for http://bugs.eclipse.org/387583
            null, // Local workaround for http://bugs.eclipse.org/387583
            null, // Local workaround for http://bugs.eclipse.org/387583
            WorkbenchMessages.PinEditorAction_toolTip, CommandContributionItem.STYLE_CHECK, null, false);
            final CommandContributionItem action = new CommandContributionItem(parameter);
            action.setVisible(WorkbenchPlugin.getDefault().getPreferenceStore().getBoolean(IPreferenceConstants.REUSE_EDITORS_BOOLEAN));
            return action;
        }
    };
...
*/
    public static final ContributionItemFactory OPEN_WINDOWS = new ContributionItemFactory(//$NON-NLS-1$
    "openWindows") {
...
*/
    public static final ContributionItemFactory VIEWS_SHORTLIST = new ContributionItemFactory(//$NON-NLS-1$
    "viewsShortlist") {
...
*/
    public static final ContributionItemFactory VIEWS_SHOW_IN = new ContributionItemFactory(//$NON-NLS-1$
    "viewsShowIn") {
...
*/
    public static final ContributionItemFactory REOPEN_EDITORS = new ContributionItemFactory(//$NON-NLS-1$
    "reopenEditors") {
...
*/
    public static final ContributionItemFactory PERSPECTIVES_SHORTLIST = new ContributionItemFactory(//$NON-NLS-1$
    "perspectivesShortlist") {
...
* @since 3.1
*/
    public static final ContributionItemFactory NEW_WIZARD_SHORTLIST = new ContributionItemFactory(//$NON-NLS-1$
    "newWizardShortlist") {
...
* @since 3.1
*/
    public static final ContributionItemFactory HELP_SEARCH = new ContributionItemFactory(//$NON-NLS-1$
    "helpSearch") {
