...
*/
    ...
    private IObservableFactory /* <IObservableCollection> */
    collectionFactory;

    private Map /* <Object element, TreeNode node> */
    elementNodes;
...
*/
    protected  ObservableCollectionTreeContentProvider(IObservableFactory collectionFactory, TreeStructureAdvisor structureAdvisor) {
        ...
        elementSetFactory = new IObservableFactory() {
            ...
            public IObservable createObservable(Object target) {
                return ObservableViewerElementSet.withComparer(realm, null, getElementComparer((Viewer) target));
            }
        };
        ...
        Assert.isNotNull(collectionFactory, //$NON-NLS-1$
        "Collection factory cannot be null");
    ...
    public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
        if (elementNodes != null && !elementNodes.isEmpty()) {
            ...
            for (int i = 0; i < oldNodes.length; i++) oldNodes[i].dispose();
            elementNodes.clear();
            elementNodes = null;
        }
        setViewer(viewer);
    ...
    private void setViewer(Viewer viewer) {
        ...
        // (clears knownElements)
        viewerObservable.setValue(viewer);
    }
    ...
    private static TreeViewerUpdater createViewerUpdater(Viewer viewer) {
        ...
        "This content provider only works with AbstractTreeViewer");
    }
    ...
    private Object[] getChildren(Object element, boolean input) {
        ...
        for (int i = 0; i < children.length; i++) getOrCreateNode(children[i], false).addParent(element);
...
*/
    public IObservableSet getRealizedElements() {
        if (realizedElements == null) {
            ...
            unmodifiableRealizedElements = Observables.unmodifiableObservableSet(realizedElements);
            asyncUpdateRealizedElements();
        }
...
*/
    ...
    private void accumulatePendingRemovals(Set removals, Set parents, Collection elementsToRemove) {
...
*/
    protected abstract IObservablesListener createCollectionChangeListener(Object parentElement);
...
*/
    protected abstract void addCollectionChangeListener(IObservableCollection collection, IObservablesListener listener);
...
*/
    protected abstract void removeCollectionChangeListener(IObservableCollection collection, IObservablesListener listener);
    ...
    protected final class TreeNode {
        ...
        private void initChildren() {
            if (children == null) {
                children = (IObservableCollection) collectionFactory.createObservable(element);
                if (children == null) {
                    listener = null;
                    children = Observables.emptyObservableSet(realm);
                } else {
                    Assert.isTrue(Util.equals(realm, children.getRealm()), //$NON-NLS-1$
