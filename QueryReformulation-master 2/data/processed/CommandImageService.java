...
*/
    public  CommandImageService(final CommandImageManager commandImageManager, final ICommandService commandService) {
        if (commandImageManager == null) {
            ...
            "Cannot create a command image service with a null manager");
        }
        if (commandService == null) {
            throw new NullPointerException(//$NON-NLS-1$
            "Cannot create a command image service with a null command service");
        }
...
*/
    public final void bind(final String commandId, final int type, final String style, final ImageDescriptor descriptor) {
...
*/
    public final void bind(final String commandId, final int type, final String style, final URL url) {
...
*/
    ...
    @Override
    public final ImageDescriptor getImageDescriptor(final String commandId, final int type) {
        return commandImageManager.getImageDescriptor(commandId, type);
    }

    @Override
    public final ImageDescriptor getImageDescriptor(final String commandId, final int type, final String style) {
        return commandImageManager.getImageDescriptor(commandId, type, style);
    }

    @Override
    public final ImageDescriptor getImageDescriptor(final String commandId, final String style) {
