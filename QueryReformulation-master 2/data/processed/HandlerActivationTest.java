...
public class HandlerActivationTest extends UITestCase {
    ...
    static class OutlineOnlyHandler extends AbstractHandler {
        ...
        public Object execute(ExecutionEvent event) throws ExecutionException {
            ...
            if (!(part instanceof ContentOutline)) {
                throw new ExecutionException("bogus part " + part.getSite().getId());
            }
            return null;
        }
        ...
        public void setEnabled(Object evaluationContext) {
            IWorkbenchPart part = (IWorkbenchPart) HandlerUtil.getVariable(evaluationContext, ISources.ACTIVE_PART_NAME);
    ...
    public static final String C2_ID = C_PREFIX + ISources.ACTIVE_ACTION_SETS_NAME;

    public static final String C3_ID = C_PREFIX + ISources.ACTIVE_SHELL_NAME;

    public static final String C4_ID = C_PREFIX + ISources.ACTIVE_WORKBENCH_WINDOW_SHELL_NAME;
...
*/
    private void assertHandlerIsExecuted(Command cmd, String handlerId) throws ExecutionException, NotDefinedException, NotEnabledException, NotHandledException {
        ...
        assertEquals("The handler count should be incremented", count + 1, handler.executionCount);
    }
...
*/
    private void createHandlerActivation(String contextId, String handlerId, String[] expressionInfo) {
...
*/
    ...
    public void testForBreak123() throws Exception {
        createHandlerActivation(C1_ID, H1, new String[] { ISources.ACTIVE_CONTEXT_NAME });
        createHandlerActivation(C2_ID, H2, new String[] { ISources.ACTIVE_CONTEXT_NAME, ISources.ACTIVE_ACTION_SETS_NAME });
        createHandlerActivation(C3_ID, H3, new String[] { ISources.ACTIVE_CONTEXT_NAME, ISources.ACTIVE_SHELL_NAME });
        doTestForBreak();
    }
    ...
    public void testForNegativeNumber() throws Exception {
        ...
        createHandlerActivation(c5_id, h5, new String[] { ISources.ACTIVE_CONTEXT_NAME, ISources.ACTIVE_MENU_NAME });
        createHandlerActivation(C1_ID, H1, new String[] { ISources.ACTIVE_CONTEXT_NAME });
        Command cmd = commandService.getCommand(CMD_ID);
    ...
    public void testLocalContext() throws Exception {
        ...
        IEvaluationContext oldContext = handlerService.createContextSnapshot(false);
