...
*/
    ...
    private void makeActions() {
        ...
        action3 = new Action() {
            ...
            public void run() {
                if (currentActivation == null) {
                    currentActivation = contextService.activateContext(MenuContributionHarness.CONTEXT_TEST1_ID);
        ...
        action3.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(ISharedImages.IMG_TOOL_REDO));
