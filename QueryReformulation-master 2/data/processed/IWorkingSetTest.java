...
public class IWorkingSetTest extends UITestCase {
    ...
    public void testSetName() throws Throwable {
        ...
        assertFalse("Failed to setName when new name is same as old name", exceptionThrown);
        fWorkingSet.setName("");
...
*/
        assertTrue(ArrayUtil.equals(new IWorkingSet[] { fWorkingSet }, workingSetManager.getWorkingSets()));
        IWorkingSet wSet = workingSetManager.createWorkingSet(WORKING_SET_NAME_2, new IAdaptable[] {});
        workingSetManager.addWorkingSet(wSet);
        /* check that workingSetManager contains "fWorkingSet" and wSet */
        assertTrue(ArrayUtil.equals(new IWorkingSet[] { fWorkingSet, wSet }, workingSetManager.getWorkingSets()) || ArrayUtil.equals(new IWorkingSet[] { wSet, fWorkingSet }, workingSetManager.getWorkingSets()));
...
*/
        assertTrue(ArrayUtil.equals(new IWorkingSet[] { fWorkingSet }, workingSetManager.getWorkingSets()));
        String sameName = fWorkingSet.getName();
        IWorkingSet wSet = workingSetManager.createWorkingSet(sameName, new IAdaptable[] {});
...
*/
    ...
    public void testApplicableTo_ResourceWorkingSet() {
        ...
        assertEquals("org.eclipse.ui.resourceWorkingSetPage", fWorkingSet.getId());
        IAdaptable[] adapted = fWorkingSet.adaptElements(new IAdaptable[] { ResourcesPlugin.getWorkspace().getRoot() });
...
*/
    public void testBadFactory_Restore() {
        fWorkingSet.setElements(new IAdaptable[] { new BadElementFactory.BadElementInstance() });
