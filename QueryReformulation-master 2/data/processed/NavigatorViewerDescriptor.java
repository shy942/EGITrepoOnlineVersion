...
*/
    public void setCustomInsertionPoints(MenuInsertionPoint[] newCustomInsertionPoints) {
        if (customInsertionPoints != null) {
            NavigatorPlugin.logError(0, "Attempt to override custom insertion points denied. Verify there are no colliding org.eclipse.ui.navigator.viewer extension points.", //$NON-NLS-1$
            null);
            // do not let them override the insertion points.
            return;
        }
...
*/
    ...
    public String toString() {
        //$NON-NLS-1$ //$NON-NLS-2$
        return "ViewerDescriptor[" + viewerId + "]";
    }
...
*/
    ...
    void setPopupMenuId(String newPopupMenuId) {
        if (newPopupMenuId != null) {
            if (popupMenuId != null) {
                NavigatorPlugin.log(IStatus.WARNING, 0, NLS.bind(CommonNavigatorMessages.NavigatorViewerDescriptor_Popup_Menu_Overridden, new Object[] { getViewerId(), popupMenuId, newPopupMenuId }), null);
            }
...
*/
    ...
    private void consumeBinding(IConfigurationElement element, boolean isContent) {
        ...
        if (includesElement.length == 1) {
            ...
            NavigatorPlugin.logError(0, NLS.bind(CommonNavigatorMessages.Too_many_elements_Warning, new Object[] { TAG_INCLUDES, element.getDeclaringExtension().getUniqueIdentifier(), element.getDeclaringExtension().getNamespaceIdentifier() }), null);
        }
        ...
        if (excludesElement.length == 1) {
            ...
            NavigatorPlugin.logError(0, NLS.bind(CommonNavigatorMessages.Too_many_elements_Warning, new Object[] { TAG_EXCLUDES, element.getDeclaringExtension().getUniqueIdentifier(), element.getDeclaringExtension().getNamespaceIdentifier() }), null);
        }
    }
