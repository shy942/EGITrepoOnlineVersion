...
*/
    public void testGetEditors() throws Throwable {
        ...
        String[][] maps = { { "a.mock1", MockEditorPart.ID1 }, { "b.mock2", MockEditorPart.ID2 } };
        ...
        for (String[] map : maps) {
            ...
            editors2 = fReg.getEditors(FileUtil.createFile(map[0], proj).getName());
...
*/
    public void testGetImageDescriptor() throws Throwable {
        ...
        if (image1 instanceof ExternalProgramImageDescriptor || image2 instanceof ExternalProgramImageDescriptor) {
            //If they are external we can't compare them
            return;
        }
        assertEquals(image1, image2);
...
*/
    ...
    public void testSwitchDefaultToExternalBug236104() {
        ...
        EditorDescriptor replacementDescriptor = EditorDescriptor.createForProgram("notepad.exe");
        try {
            ...
            PrefUtil.savePrefs();
            IEditorDescriptor newDescriptor = fReg.getDefaultEditor("a.mock1");
            assertEquals("Parameter replaceDescriptor should be the same as parameter new Descriptor", replacementDescriptor, newDescriptor);
            assertFalse("Parameter replaceDescriptor should not be equals to a.mock1 Descriptor", replacementDescriptor.equals(editor));
        } finally {
            ...
            assertNotNull("Parameter map should not be null before setting the default editor", map);
