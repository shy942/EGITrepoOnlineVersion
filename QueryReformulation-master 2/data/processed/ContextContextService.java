...
public class ContextContextService implements EContextService {
    ...
    public void activateContext(String id) {
        ...
        @SuppressWarnings("unchecked") LinkedList<String> locals = (LinkedList<String>) eclipseContext.getLocal(LOCAL_CONTEXTS);
        if (locals == null) {
...
*/
    ...
    private void deferActivateContext(String id) {
        @SuppressWarnings("unchecked") LinkedList<String> locals = (LinkedList<String>) eclipseContext.getLocal(DEFERED_ACTIVATES);
        if (locals == null) {
            locals = new LinkedList<String>();
    ...
    private void setEventCaching(boolean cache) {
        ...
        @SuppressWarnings("unchecked") LinkedList<String> activates = (LinkedList<String>) eclipseContext.getLocal(DEFERED_ACTIVATES);
        if (activates != null) {
    ...
    private void deferDeactivateContext(String id) {
        @SuppressWarnings("unchecked") LinkedList<String> locals = (LinkedList<String>) eclipseContext.getLocal(DEFERED_DEACTIVATES);
        if (locals == null) {
    ...
    public Collection<String> getActiveContextIds() {
        @SuppressWarnings("unchecked") Set<String> set = (Set<String>) eclipseContext.get(IServiceConstants.ACTIVE_CONTEXTS);
        if (set != null) {
