...
public class BundleSigningInfo {
    ...
    public Control createContents(Composite parent) {
        ...
        // start the jobs that will prime the content
        startJobs();
        return composite;
    }
...
*/
    private void startJobs() {
        ...
        if (factoryRef == null) {
            StatusManager.getManager().handle(new Status(IStatus.WARNING, WorkbenchPlugin.PI_WORKBENCH, WorkbenchMessages.BundleSigningTray_Cant_Find_Service), StatusManager.LOG);
            return;
        }
        ...
        final Job signerJob = Job.create(NLS.bind(WorkbenchMessages.BundleSigningTray_Determine_Signer_For, myData.getId()), new IJobFunction() {
            ...
            public IStatus run(IProgressMonitor monitor) {
                try {
                    ...
                    return new Status(IStatus.ERROR, WorkbenchPlugin.PI_WORKBENCH, e.getMessage(), e);
