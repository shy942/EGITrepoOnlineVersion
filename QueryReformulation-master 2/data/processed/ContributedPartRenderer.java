...
*/
    public static void setDescription(MPart part, String description) {
        ...
        if (c.getChildren().length == 3) {
            ...
            //$NON-NLS-1$
            boolean hasText = !description.equals("");
            ...
            c.setLayout(new Layout() {
                ...
                protected void layout(Composite composite, boolean flushCache) {
                    ...
                    if (composite.getChildren().length == 1) {
                        ...
                        int labelHeight = !label.getText().isEmpty() ? label.computeSize(bounds.width, SWT.DEFAULT).y : 0;
                        label.setBounds(0, 0, bounds.width, labelHeight);
                        int separatorHeight = labelHeight > 0 ? separator.computeSize(bounds.width, SWT.DEFAULT).y : 0;
