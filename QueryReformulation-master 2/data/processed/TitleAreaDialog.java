    ...
    private Control createTitleArea(Composite parent) {
        ...
        messageLabel.getAccessible().addAccessibleAttributeListener(new AccessibleAttributeAdapter() {
            ...
            public void getAttributes(AccessibleAttributeEvent e) {
                e.attributes = new String[] { //$NON-NLS-1$
                "container-live", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
                "polite", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
                "live", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
                "polite", "container-live-role", //$NON-NLS-1$ //$NON-NLS-2$
                "status" };
            }
        });
...
*/
    public void setErrorMessage(String newErrorMessage) {
        ...
        if (errorMessage == null) {
            ...
            if (// this should probably never happen since
            message == null)
...
*/
    private void showMessage(String newMessage, Image newImage) {
        ...
        //$NON-NLS-1$
        String shownMessage = (newImage == null) ? message : " " + message;
...
*/
    private void updateMessage(String newMessage) {
        ...
        messageLabel.getAccessible().sendEvent(ACC.EVENT_TEXT_CHANGED, new Object[] { Integer.valueOf(ACC.TEXT_DELETE), Integer.valueOf(0), Integer.valueOf(oldMessage.length()), oldMessage });
        messageLabel.getAccessible().sendEvent(ACC.EVENT_TEXT_CHANGED, new Object[] { Integer.valueOf(ACC.TEXT_INSERT), Integer.valueOf(0), Integer.valueOf(newMessage.length()), newMessage });
    }
