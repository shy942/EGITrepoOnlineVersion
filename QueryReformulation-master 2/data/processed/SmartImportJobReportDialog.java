            ...
            public void projectCreated(IProject project) {
                ...
                nestedProjectsTable.getControl().getDisplay().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        nestedProjectsLabel.setText(NLS.bind(DataTransferMessages.SmartImportReport_importedProjects, job.getConfiguredProjects().size()));
                    }
                });
            }
            ...
            public void errorHappened(IPath location, Exception error) {
                ...
                errorsTable.getControl().getDisplay().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        errorsLabel.setText(NLS.bind(DataTransferMessages.SmartImportReport_importErrors, job.getErrors().size()));
                        res.layout(true);
                    }
                });
            }
