...
*/
    protected static final void addElementToIndexedArray(final IMemento elementToAdd, final IMemento[][] indexedArray, final int index, final int currentCount) {
...
*            <code>null</code>.
*/
    protected static final void addWarning(final List warningsToLog, final String message, final String id, final String extraAttributeName, final String extraAttributeValue) {
...
*/
    protected static final boolean readBoolean(final IMemento memento, final String attribute, final boolean defaultValue) {
...
*/
    protected static final ParameterizedCommand readParameterizedCommand(final IMemento memento, final ICommandService commandService, final List warningsToLog, final String message, final String id) {
...
*/
    protected static final ParameterizedCommand readParameters(final IMemento memento, final List warningsToLog, final Command command) {
        ...
        for (int i = 0; i < parameterMementos.length; i++) {
            ...
            if ((id == null) || (id.length() == 0)) {
                ...
                //$NON-NLS-1$
                addWarning(warningsToLog, "Parameters need a name");
                continue;
            }
            ...
            if ((value == null) || (value.length() == 0)) {
                // The name should never be null. This is invalid.
                //$NON-NLS-1$
                addWarning(warningsToLog, "Parameters need a value", id);
                continue;
            }
...
*/
    protected static final String readRequired(final IMemento memento, final String attribute, final List warningsToLog, final String message) {
...
* @return The required attribute; may be <code>null</code> if missing.
*/
    protected static final String readRequired(final IMemento memento, final String attribute, final List warningsToLog, final String message, final String id) {
        final String value = memento.getString(attribute);
        if ((value == null) || (value.length() == 0)) {
