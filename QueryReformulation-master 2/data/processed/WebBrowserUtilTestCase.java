...
public class WebBrowserUtilTestCase extends TestCase {
    ...
    public void testCreateParameterArray() {
        ...
        assertArrayEquals(new String[] { "parameters", "url" }, createParameterArray("parameters", "url"));
        assertArrayEquals(new String[] { "param1", "param2" }, createParameterArray("param1 " + URL_PARAMETER + " param2", null));
        assertArrayEquals(new String[] { "param1", "url", "param2" }, createParameterArray("param1 " + URL_PARAMETER + " param2", "url"));
        assertArrayEquals(new String[] { "param1", "url", "param2", "url" }, createParameterArray("param1 " + URL_PARAMETER + " param2 " + URL_PARAMETER, "url"));
    }

    public void testCreateParameterArrayForMozilla() {
        assertArrayEquals(new String[] { "-remote", "openURL(url)" }, createParameterArray(" -remote openURL(" + URL_PARAMETER + ")", "url"));
        assertArrayEquals(new String[] { "parameters", "-remote", "openURL(url)" }, createParameterArray("parameters -remote openURL(" + URL_PARAMETER + ")", "url"));
    }
}
