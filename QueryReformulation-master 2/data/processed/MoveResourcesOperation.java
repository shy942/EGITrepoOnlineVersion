...
*/
    protected void move(IProgressMonitor monitor, IAdaptable uiInfo) throws CoreException {
        ...
        for (int i = 0; i < resources.length; i++) {
            ...
            overwrites = WorkspaceUndoUtil.move(new IResource[] { resources[i] }, getDestinationPath(resources[i], i), resourcesAtDestination, undoDestinationPaths, subMonitor.split(1), uiInfo, true);
        ...
        destinationPaths = (IPath[]) undoDestinationPaths.toArray(new IPath[undoDestinationPaths.size()]);
        destination = null;
    }
