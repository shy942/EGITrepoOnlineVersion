...
*/
    ...
    public Object clone() {
        try {
            ...
            clone.declaredDefaultEditors = (List<IEditorDescriptor>) ((ArrayList<IEditorDescriptor>) declaredDefaultEditors).clone();
            return clone;
...
*/
    ...
    public String getLabel() {
        //$NON-NLS-1$
        return TextProcessor.process(name + (extension.length() == 0 ? "" : DOT + extension), STAR + DOT);
    }
...
*/
    public IEditorDescriptor[] getDeclaredDefaultEditors() {
        Collection<IEditorDescriptor> descs = WorkbenchActivityHelper.restrictCollection(declaredDefaultEditors, new ArrayList());
        return descs.toArray(new IEditorDescriptor[descs.size()]);
    }
