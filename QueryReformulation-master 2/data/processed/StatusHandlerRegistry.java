...
*/
    private  StatusHandlerRegistry() {
        ...
        IExtensionPoint productsPoint = Platform.getExtensionRegistry().getExtensionPoint(Platform.PI_RUNTIME, Platform.PT_PRODUCT);
    ...
    public void addExtension(IExtensionTracker tracker, IExtension extension) {
        ...
        for (int j = 0; j < configElements.length; j++) {
            if (configElements[j].getName().equals(TAG_STATUSHANDLER)) {
                StatusHandlerDescriptor descriptor = new StatusHandlerDescriptor(configElements[j]);
                ...
                StatusHandlerProductBindingDescriptor descriptor = new StatusHandlerProductBindingDescriptor(configElements[j]);
                tracker.registerObject(extension, descriptor, IExtensionTracker.REF_STRONG);
