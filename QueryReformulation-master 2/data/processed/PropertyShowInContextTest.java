...
*/
    public final void testHashCode2() {
        ShowInContext psc1 = new PropertyShowInContext(null, StructuredSelection.EMPTY);
        ShowInContext psc2 = new PropertyShowInContext(null, StructuredSelection.EMPTY);
        assertEquals(psc1.hashCode(), psc2.hashCode());
    }
...
*/
    public final void testHashCode3() throws PartInitException {
        ...
        ShowInContext psc1 = new PropertyShowInContext(showView, StructuredSelection.EMPTY);
        ShowInContext psc2 = new PropertyShowInContext(showView, StructuredSelection.EMPTY);
        assertEquals(psc1.hashCode(), psc2.hashCode());
...
*/
    public final void testHashCode4() throws PartInitException {
        IViewPart showView = activePage.showView(IPageLayout.ID_PROP_SHEET);
        ShowInContext psc1 = new PropertyShowInContext(showView, new ShowInContext(null, null));
        PropertyShowInContext psc2 = new PropertyShowInContext(showView, new ShowInContext(null, null));
        assertEquals(psc1.hashCode(), psc2.hashCode());
        psc2.setPart(null);
        assertFalse(psc1.hashCode() == psc2.hashCode());
    }
...
*/
    public final void testHashCode6() throws PartInitException {
        IViewPart showView = activePage.showView(IPageLayout.ID_PROP_SHEET);
        ShowInContext psc1 = new PropertyShowInContext(showView, new ShowInContext(new Object(), null));
        ShowInContext psc2 = new PropertyShowInContext(showView, new ShowInContext(null, null));
        assertFalse(psc1.hashCode() == psc2.hashCode());
    }
...
*/
    public final void testHashCode7() throws PartInitException {
        IViewPart showView = activePage.showView(IPageLayout.ID_PROP_SHEET);
        ShowInContext psc1 = new PropertyShowInContext(showView, new ShowInContext(null, null));
        ShowInContext psc2 = new PropertyShowInContext(showView, new ShowInContext(null, StructuredSelection.EMPTY));
        assertFalse(psc1.hashCode() == psc2.hashCode());
    }
...
*/
    public final void testEqualsNonNullInput() throws PartInitException {
        IViewPart showView = activePage.showView(IPageLayout.ID_PROP_SHEET);
        ShowInContext psc1 = new PropertyShowInContext(showView, new ShowInContext(new Object(), null));
        ShowInContext psc2 = new PropertyShowInContext(showView, new ShowInContext(new Object(), null));
        assertFalse(psc1.equals(psc2));
