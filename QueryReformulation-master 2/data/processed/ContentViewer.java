        ...
        public void labelProviderChanged(LabelProviderChangedEvent event) {
            ...
            if (control == null || control.isDisposed()) {
                if (logWhenDisposed) {
                    ...
                    "Ignored labelProviderChanged notification because control is diposed." + //$NON-NLS-1$
                    ...
                    if (!InternalPolicy.DEBUG_LOG_LABEL_PROVIDER_NOTIFICATIONS_WHEN_DISPOSED) {
                        ...
                        message += //$NON-NLS-1$
                        " This is only logged once per viewer instance," + //$NON-NLS-1$
                        " but similar calls will still be ignored.";
                    }
    ...
    protected void handleDispose(DisposeEvent event) {
        if (contentProvider != null) {
            try {
                ...
                String message = "Exception while calling ContentProvider.inputChanged from ContentViewer.handleDispose";
                message += " (" + contentProvider.getClass().getName() + ")";
...
*/
    ...
    public void setInput(Object input) {
        ...
        Assert.isTrue(getContentProvider() != null, //$NON-NLS-1$
        "Instances of ContentViewer must have a content provider assigned before the setInput method is called.");
