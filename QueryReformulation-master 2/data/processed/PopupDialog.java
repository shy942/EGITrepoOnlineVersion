...
*/
    ...
    DIALOG_USE_PERSISTED_BOUNDS = "DIALOG_USE_PERSISTED_BOUNDS";
...
*/
    @Deprecated
    private static final String //$NON-NLS-1$
    DIALOG_VALUE_MIGRATED_TO_34 = "hasBeenMigratedTo34";
...
*/
    private class MoveAction extends Action {
         ...
         MoveAction() {
            super(//$NON-NLS-1$
            JFaceResources.getString("PopupDialog.move"), IAction.AS_PUSH_BUTTON);
        }
...
*/
    private class ResizeAction extends Action {
         ...
         ResizeAction() {
            //$NON-NLS-1$
            super(JFaceResources.getString("PopupDialog.resize"), IAction.AS_PUSH_BUTTON);
        }
...
*/
    private class PersistBoundsAction extends Action {
         ...
         PersistBoundsAction() {
            //$NON-NLS-1$
            super(JFaceResources.getString("PopupDialog.persistBounds"), IAction.AS_CHECK_BOX);
...
*/
    private class PersistSizeAction extends Action {
         ...
         PersistSizeAction() {
            //$NON-NLS-1$
            super(JFaceResources.getString("PopupDialog.persistSize"), IAction.AS_CHECK_BOX);
...
*/
    private class PersistLocationAction extends Action {
         ...
         PersistLocationAction() {
            //$NON-NLS-1$
            super(JFaceResources.getString("PopupDialog.persistLocation"), IAction.AS_CHECK_BOX);
...
*/
    ...
    private static GridLayoutFactory getPopupLayout() {
        if (popupLayoutFactory == null) {
            popupLayoutFactory = GridLayoutFactory.fillDefaults().margins(POPUP_MARGINWIDTH, POPUP_MARGINHEIGHT).spacing(POPUP_HORIZONTALSPACING, POPUP_VERTICALSPACING);
        }
...
*/
    protected Control createTitleControl(Composite parent) {
        ...
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER).grab(true, false).span(showDialogMenu ? 1 : 2, 1).applyTo(titleLabel);
        if (titleText != null) {
...
*/
    protected Control createInfoTextArea(Composite parent) {
        ...
        infoColor = new Color(display, blend(display.getSystemColor(SWT.COLOR_INFO_BACKGROUND).getRGB(), display.getSystemColor(SWT.COLOR_INFO_FOREGROUND).getRGB(), 0.56f));
