...
*/
    private void selectAndUpdateMenu(ExtendedTextEditor editor, String str, MenuManager mgr) throws Throwable {
        editor.setText(str);
...
*/
    private void testAction(MenuManager mgr, String action, boolean expected) throws Throwable {
