...
public class CSSValueSWTFontConverterImpl extends CSSValueSWTFontDataConverterImpl {
    ...
    public String convert(Object value, CSSEngine engine, Object context, ICSSValueConverterConfig config) throws Exception {
        ...
        return super.convert(CSSSWTFontHelper.getFirstFontData(font), engine, context, config);
    }
}
