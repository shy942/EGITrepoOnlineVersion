...
public class ObservableValueEditingSupportTest extends AbstractSWTTestCase {
    ...
    public void testInitializeCellEditorValue_OrderOfOperations() throws Exception {
        ...
        assertEquals("createCellEditorObservable createElementObservable createBinding", editingSupport.events.toString());
    }
...
*/
    ...
    private static class ObservableValueEditingSupportStub extends ObservableValueEditingSupport {
...
*/
        ...
        protected IObservableValue doCreateCellEditorObservable(CellEditor cellEditor) {
            ...
            return target = SWTObservables.observeText(cellEditor.getControl(), SWT.NONE);
        }
