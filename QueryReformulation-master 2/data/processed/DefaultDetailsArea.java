    ...
    private void setStatusAdapter(StatusAdapter adapter) {
        ...
        if (!isMulti()) {
            ...
            if (timestamp != null) {
                ...
                text.append(NLS.bind(ProgressMessages.JobInfo_Error, //$NON-NLS-1$
                (new Object[] { "", date })));
            }
        }
...
*/
    ...
    private void createCopyAction(final Composite parent) {
        ...
        //$NON-NLS-1$
        copyAction.setText(JFaceResources.getString("copy"));
    ...
    private void copyToClipboard() {
        ...
        try {
            ...
            clipboard.setContents(new Object[] { text.getSelectionText() }, new Transfer[] { TextTransfer.getInstance() });
        } finally {
            if (clipboard != null) {
                clipboard.dispose();
            }
