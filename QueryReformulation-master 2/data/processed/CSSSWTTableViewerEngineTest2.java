...
public class CSSSWTTableViewerEngineTest2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            engine.parseStyleSheet(new StringReader("TableItem:odd {font:Roman 12 italic normal; background-color: #2BAFFA; color:white; background-image: url(./images/icons/type/class.gif);}" + "TableItem:even {background-color:#edb5f4, 100%; color:black;}"));
