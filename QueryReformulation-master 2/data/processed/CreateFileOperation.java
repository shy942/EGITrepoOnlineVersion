...
*/
    public  CreateFileOperation(IFile fileHandle, URI linkLocation, InputStream contents, String label) {
        ...
        if (fileHandle.getParent().exists()) {
            resourceDescription = new FileDescription(fileHandle, linkLocation, createFileContentDescription(fileHandle, contents));
        } else {
            ...
            containerDescription.getFirstLeafFolder().addMember(new FileDescription(fileHandle, linkLocation, createFileContentDescription(fileHandle, contents)));
