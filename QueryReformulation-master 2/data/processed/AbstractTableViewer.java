...
*/
    ...
    protected void doUpdateItem(Widget widget, Object element, boolean fullMap) {
        ...
        try {
            if (widget instanceof Item) {
                ...
                if (columnCount == 0)
                    // If there are no columns do the first one
                    columnCount = 1;
    ...
    protected Widget getColumnViewerOwner(int columnIndex) {
        ...
        if (// Hang it off the table if it
        columnCount == 0)
            return getControl();
...
*/
    ...
    protected Object[] getRawChildren(Object parent) {
        Assert.isTrue(!(getContentProvider() instanceof ILazyContentProvider), //$NON-NLS-1$
        "Cannot get raw children with an ILazyContentProvider");
