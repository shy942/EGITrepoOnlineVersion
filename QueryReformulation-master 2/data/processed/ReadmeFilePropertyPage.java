...
*/
    ...
    public Control createContents(Composite parent) {
        ...
        if (resource.getType() == IResource.FILE) {
            //$NON-NLS-1$
            Label label = createLabel(panel, MessageUtil.getString("File_name"));
            label = createLabel(panel, resource.getName());
            grabExcessSpace(label);
            //
            //$NON-NLS-1$
            createLabel(panel, MessageUtil.getString("Path"));
            label = createLabel(panel, resource.getFullPath().setDevice(null).toString());
            grabExcessSpace(label);
            //
            //$NON-NLS-1$
            createLabel(panel, MessageUtil.getString("Size"));
            ...
            try {
                ...
                if (message == null)
                    label = createLabel(panel, MessageUtil.getString("<Unknown>"));
                else
            ...
            grabExcessSpace(label);
            //$NON-NLS-1$
            createLabel(panel, MessageUtil.getString("Number_of_sections"));
        ...
        //
        Label label = createLabel(panel, MessageUtil.getString(//$NON-NLS-1$
