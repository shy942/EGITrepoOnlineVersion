...
public class TableComparator extends ViewerComparator implements Comparator {
    ...
    public  TableComparator(IField[] properties, final int[] defaultPriorities, final int[] defaultDirections) {
        ...
        if (properties == null || defaultPriorities == null || defaultDirections == null || !(properties.length == defaultPriorities.length && properties.length == defaultDirections.length) || !verifyPriorities(defaultPriorities) || !verifyDirections(defaultDirections)) {
