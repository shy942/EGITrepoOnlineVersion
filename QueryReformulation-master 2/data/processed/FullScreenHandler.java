...
public class FullScreenHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) {
        ...
        showInfoPopup = !WorkbenchPlugin.getDefault().getPreferenceStore().getBoolean(FULL_SCREEN_COMMAND_DO_NOT_SHOW_INFO_AGAIN_PREF_ID);
        Optional<TriggerSequence> sequence = getKeybindingSequence(bindingService, commandService, bindingTableManager, bindingContextService, FULL_SCREEN_COMMAND_ID);
        //$NON-NLS-1$
        ...
        if (shell.getFullScreen()) {
            ...
            if (showInfoPopup) {
                FullScreenInfoPopup fullScreenInfoPopup = new FullScreenInfoPopup(shell, PopupDialog.HOVER_SHELLSTYLE, true, false, false, false, false, null, null, message);
    ...
    private static class FullScreenInfoPopup extends PopupDialog {
        ...
        protected Control createDialogArea(Composite parent) {
            ...
            btnDoNotShow.setSelection(WorkbenchPlugin.getDefault().getPreferenceStore().getBoolean(FULL_SCREEN_COMMAND_DO_NOT_SHOW_INFO_AGAIN_PREF_ID));
            ...
            link.addSelectionListener(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent e) {
                    WorkbenchPlugin.getDefault().getPreferenceStore().setValue(FULL_SCREEN_COMMAND_DO_NOT_SHOW_INFO_AGAIN_PREF_ID, btnDoNotShow.getSelection());
                    close();
                }
            });
            return composite;
