...
*/
    public final void define(final String name, final String description, final String parentId) {
        if (name == null) {
            ...
            "The name of a scheme cannot be null");
        }
        ...
        fireSchemeChanged(new SchemeEvent(this, definedChanged, nameChanged, descriptionChanged, parentIdChanged));
    }
...
*/
    private final void fireSchemeChanged(final SchemeEvent event) {
        ...
        while (listenerItr.hasNext()) {
            final ISchemeListener listener = (ISchemeListener) listenerItr.next();
...
*/
    public final String getParentId() throws NotDefinedException {
        if (!defined) {
            ...
            "Cannot get the parent identifier from an undefined scheme. " + id);
        }
        return parentId;
    }
