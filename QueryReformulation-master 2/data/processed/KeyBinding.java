...
*            or <code>USER</code>.
*/
    public  KeyBinding(final KeySequence keySequence, final ParameterizedCommand command, final String schemeId, final String contextId, final String locale, final String platform, final String windowManager, final int type) {
        ...
        if (!keySequence.isComplete()) {
            ...
            "Cannot bind to an incomplete key sequence");
        }
