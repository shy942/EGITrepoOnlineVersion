...
* @since 3.1
*/
        public  CommandCallback(final BindingManager bindingManager, final CommandManager commandManager) {
...
* @since 3.1
*/
        public  CommandCallback(final BindingManager bindingManager, final CommandManager commandManager, final IActiveChecker activeChecker) {
...
* @since 3.4
*/
        public  CommandCallback(final BindingManager bindingManager, final CommandManager commandManager, final IActiveChecker activeChecker, final IExecuteApplicable checker) {
            if (bindingManager == null) {
                throw new NullPointerException(//$NON-NLS-1$
                "The callback needs a binding manager");
            }
            if (commandManager == null) {
                throw new NullPointerException(//$NON-NLS-1$
                "The callback needs a command manager");
            }
            if (activeChecker == null) {
                throw new NullPointerException(//$NON-NLS-1$
                "The callback needs an active callback");
            }
            if (checker == null) {
                throw new NullPointerException(//$NON-NLS-1$
                "The callback needs an applicable callback");
            }
...
*/
        @Override
        public final void addPropertyChangeListener(final String commandId, final IPropertyChangeListener listener) {
        ...
        public final void bindingManagerChanged(final BindingManagerEvent event) {
            if (event.isActiveBindingsChanged()) {
                final Iterator<Entry<String, Object>> listenerItr = registeredListeners.entrySet().iterator();
                while (listenerItr.hasNext()) {
                    ...
                    if (event.isActiveBindingsChangedFor(parameterizedCommand)) {
                        ...
                        PropertyChangeEvent propertyChangeEvent = new PropertyChangeEvent(event.getManager(), IAction.TEXT, null, null);
...
*/
        ...
        public final Integer getAccelerator(final String commandId) {
            final TriggerSequence triggerSequence = bindingManager.getBestActiveBindingFor(commandId);
            if (triggerSequence != null) {
                ...
                if (triggers.length == 1) {
                    ...
                    if (trigger instanceof KeyStroke) {
                        ...
                        final int accelerator = SWTKeySupport.convertKeyStrokeToAccelerator(keyStroke);
...
*/
        ...
        public final boolean isAcceleratorInUse(final int accelerator) {
            final KeySequence keySequence = KeySequence.getInstance(SWTKeySupport.convertAcceleratorToKeyStroke(accelerator));
        ...
        public final boolean isActive(final String commandId) {
            if (commandId != null) {
                ...
                if (!command.isDefined() && (!loggedCommandIds.contains(commandId))) {
                    ...
                    final String message = MessageFormat.format(Util.translateString(RESOURCE_BUNDLE, "undefinedCommand.WarningMessage", //$NON-NLS-1$
                    null), command.getId());
                    IStatus status = new Status(IStatus.ERROR, //$NON-NLS-1$
                    "org.eclipse.jface", 0, message, new Exception());
...
*/
        @Override
        public final void removePropertyChangeListener(final String commandId, final IPropertyChangeListener listener) {
            Object existing = registeredListeners.get(commandId);
...
*/
        ...
        public void preExecute(IAction action, Event event) {
            ...
            if (actionDefinitionId == null || !applicabilityChecker.isApplicable(action)) {
                return;
            }
