...
public class CSSDocumentHandlerImpl implements ExtendedDocumentHandler {
    ...
    public void ignorableAtRule(String atRule) throws CSSException {
        ...
        CSSUnknownRuleImpl ir = new CSSUnknownRuleImpl(parentStyleSheet, null, atRule);
        if (!getNodeStack().empty()) {
    ...
    public void importStyle(String uri, SACMediaList media, String defaultNamespaceURI) throws CSSException {
        ...
        CSSImportRuleImpl ir = new CSSImportRuleImpl(parentStyleSheet, null, uri, new MediaListImpl(media));
        if (!getNodeStack().empty()) {
            ((CSSRuleListImpl) getNodeStack().peek()).add(ir);
        } else {
            // _getNodeStack().push(ir);
    ...
    public void startPage(String name, String pseudo_page) throws CSSException {
        ...
        CSSPageRuleImpl pageRule = new CSSPageRuleImpl(parentStyleSheet, null, name, pseudo_page);
        if (!getNodeStack().empty()) {
    ...
    public void startSelector(SelectorList selectors) throws CSSException {
        ...
        CSSStyleRuleImpl rule = new CSSStyleRuleImpl(parentStyleSheet, null, selectors);
        if (!getNodeStack().empty()) {
