    ...
    private void createProgressBar(Composite parent, MToolControl toolControl) {
        ...
        if (parent.getDisplay() != null && parent.getDisplay().getSystemTaskBar() != null) {
            ...
            if (taskItem != null) {
                ...
                //$NON-NLS-1$
                String taskBarProgressManagerKey = TaskBarProgressManager.class.getName() + ".instance";
...
*/
    private void createStatusLine(Composite parent, MToolControl toolControl) {
        ...
        if (wbw == null) {
            ...
            wb.createWorkbenchWindow(wb.getDefaultPageInput(), null, modelService.getTopLevelWindowFor(toolControl), false);
