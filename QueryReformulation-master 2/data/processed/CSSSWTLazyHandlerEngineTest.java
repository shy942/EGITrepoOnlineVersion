...
public class CSSSWTLazyHandlerEngineTest {
    ...
    public static void main(String[] args) {
        ...
        CSSSWTLazyHandlerEngineImpl engine = new CSSSWTLazyHandlerEngineImpl(display);
        // CSSEngine Print stack trace when Exception is thrown
        engine.setErrorHandler(CSSErrorHandlerImpl.INSTANCE);
        try {
            engine.parseStyleSheet(new StringReader("Label:hover {color:red;border:solid green 2px;font:30px Arial italic normal;background: url(./images/icons/type/class.gif) yellow;} " + "Text {cursor:wait;background-color:white red 100%;} "));
