...
public class PartServiceSaveHandler implements ISaveHandler {
    ...
    public boolean save(MPart dirtyPart, boolean confirm) {
        ...
        try {
            ...
            log("Failed to persist contents of part", "Failed to persist contents of part ({0})", dirtyPart.getElementId(), e);
            return false;
        } catch (RuntimeException e) {
            log("Failed to persist contents of part via DI", "Failed to persist contents of part ({0}) via DI", dirtyPart.getElementId(), e);
            return false;
        }
        return true;
    }
