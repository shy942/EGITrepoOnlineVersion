...
public class Snippet018TableViewerAddRemoveColumnsWithEditing {
    ...
    private class MyEditingSupport extends EditingSupport {
        ...
        protected void setValue(Object element, Object value) {
            ((Person) element).setValue(property, value.toString());
    ...
    private List<Person> createModel() {
        return Arrays.asList(new Person("Tom", "Schindl", "tom.schindl@bestsolution.at"), new Person("Boris", "Bokowski", "boris_bokowski@ca.ibm.com"), new Person("Tod", "Creasey", "tod_creasey@ca.ibm.com"), new Person("Jeanderson", "Candido", "jeandersonbc@gmail.com"), new Person("Lars", "Vogel", "lars.vogel@vogella.com"), new Person("Hendrik", "Still", "hendrik.still@vogella.com"), new Person("Simon", "Scholz", "simon.scholz@vogella.com"));
    }
