...
*/
    public  MultiPageEditorSite(MultiPageEditorPart multiPageEditor, IEditorPart editor) {
        ...
        //$NON-NLS-1$
        context = site.getModel().getContext().createChild("MultiPageEditorSite");
        serviceLocator = (ServiceLocator) slc.createServiceLocator(multiPageEditor.getSite(), null, new IDisposable() {
...
*/
    private void initializeDefaultServices() {
        serviceLocator.registerService(IWorkbenchLocationService.class, new WorkbenchLocationService(IServiceScopes.MPESITE_SCOPE, getWorkbenchWindow().getWorkbench(), getWorkbenchWindow(), getMultiPageEditor().getSite(), this, null, 3));
...
*/
                ...
                "MultiPageEditorSite.getKeyBindingService()   Parent key binding service was not an instance of INestableKeyBindingService.  It was an instance of " + service.getClass().getName() + " instead.");
            }
        }
        return service;
    }
