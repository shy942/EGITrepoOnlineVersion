...
public class GlobalizationPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    protected Control createContents(Composite parent) {
        PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, IWorkbenchHelpContextIds.GLOBALIZATION_PREFERENCE_PAGE);
...
*/
    ...
    private void createNlsExtensionsGroup(Composite parent) {
        nlExtensionsField = new StringFieldEditor(IPreferenceConstants.NL_EXTENSIONS, WorkbenchMessages.GlobalizationPreference_nlExtensions, parent);
    ...
    private void createBidiPreferencesGroup(Composite composite) {
        ...
        textDirectionCombo = addComboBox(composite, WorkbenchMessages.GlobalizationPreference_textDirection, LayoutConstants.getIndent());
        ...
        Composite note = createNoteComposite(font, composite, WorkbenchMessages.Preference_note, WorkbenchMessages.GlobalizationPreference_restartWidget);
