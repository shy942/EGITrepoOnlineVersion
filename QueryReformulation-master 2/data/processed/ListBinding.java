...
public class ListBinding extends Binding {
    ...
    private IListChangeListener targetChangeListener = new IListChangeListener() {
        ...
        public void handleListChange(ListChangeEvent event) {
            if (!updatingTarget) {
                doUpdate((IObservableList) getTarget(), (IObservableList) getModel(), event.diff, targetToModel, false, false);
            }
        }
    };
    ...
    private IListChangeListener modelChangeListener = new IListChangeListener() {
        ...
        public void handleListChange(ListChangeEvent event) {
            if (!updatingModel) {
                doUpdate((IObservableList) getModel(), (IObservableList) getTarget(), event.diff, modelToTarget, false, false);
            }
        }
    };
