...
*/
    public static final OverridePolicy InvokeOnlyIfSuppressedExtAlsoVisibleAndActive = new OverridePolicy(InvokeOnlyIfSuppressedExtAlsoVisibleAndActive_VALUE, InvokeOnlyIfSuppressedExtAlsoVisibleAndActive_LITERAL);

    /**
* Indicates InvokeAlwaysRegardlessOfSuppressedExt OverridePolicy as a
* OverridePolicy enumeration.
*/
    public static final OverridePolicy InvokeAlwaysRegardlessOfSuppressedExt = new OverridePolicy(InvokeAlwaysRegardlessOfSuppressedExt_VALUE, InvokeAlwaysRegardlessOfSuppressedExt_LITERAL);

    /**
* The ordered array of possible enumeration values.
*/
    public static final OverridePolicy[] ENUM_ARRAY = new OverridePolicy[] { InvokeOnlyIfSuppressedExtAlsoVisibleAndActive, InvokeAlwaysRegardlessOfSuppressedExt };
