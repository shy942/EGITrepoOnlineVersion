...
*/
    public void testOpenEditor() throws Throwable {
        ...
        TitleTestEditor editor = (TitleTestEditor) page.openEditor(new FileEditorInput(file), EDITOR_ID);
    ...
    public void testSecondOpening() throws Throwable {
        ...
        for (IEditorReference ref : editors) {
            if (ref.getEditorInput().getName().equals("state.txt")) {
                assertNull("The editor should not be instantiated", ref.getPart(false));
...
*/
    public void testPartInstantiation() throws Throwable {
        ...
        TitleTestEditor editor = (TitleTestEditor) page.openEditor(input, EDITOR_ID);
