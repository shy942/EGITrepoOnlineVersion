    ...
    public void testPageComplete() {
        IWizardPage page = new WizardPage("Page") {
            ...
            public void createControl(Composite parent) {
                setControl(parent);
                IObservableValue validation = new WritableValue(ValidationStatus.ok(), IStatus.class);
                DataBindingContext dbc = new DataBindingContext();
                ValidationProvider validationProvider = new ValidationProvider(validation);
    ...
    public void testPageCompleteOnValidationStaleness() {
        IWizardPage page = new WizardPage("Page") {
            ...
            public void createControl(Composite parent) {
                ...
                DataBindingContext dbc = new DataBindingContext();
                dbc.addValidationStatusProvider(new ValidationProvider(validation));
                WizardPageSupport.create(this, dbc);
                assertTrue(isPageComplete());
    ...
    public void testValidationMessageProvider() {
        IWizardPage page = new WizardPage("Page") {
            ...
            public void createControl(Composite parent) {
                ...
                DataBindingContext dbc = new DataBindingContext();
                dbc.addValidationStatusProvider(new ValidationProvider(validation));
                WizardPageSupport wizardPageSupport = WizardPageSupport.create(this, dbc);
