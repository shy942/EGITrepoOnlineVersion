        ...
        if (toolBarContributionItem != null) {
            ...
            if (coolBarManager instanceof SubContributionManager) {
                ...
                if (manager instanceof CoolBarToTrimManager) {
                    ...
                    boolean succeeded = ((ContributionManager) manager).replaceItem(replacementItem.getId(), replacementItem);
                    if (!succeeded && DEBUG_TOOLBAR_DISPOSAL) {
                        ...
                        "Could not replace " + replacementItem.getId() + " in the contribution manager.");
                    }
