...
*/
    ...
    public void decrementBusy() {
        synchronized (busyLock) {
            Assert.isTrue(busyCount > 0, //$NON-NLS-1$
            "Ignoring unexpected call to IWorkbenchSiteProgressService.decrementBusy().  This might be due to an earlier call to this method.");
            this.busyCount--;
            if (busyCount != 0) {
                return;
            }
