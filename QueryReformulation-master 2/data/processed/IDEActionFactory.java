...
*/
    public static final ActionFactory ADD_TASK = new //$NON-NLS-1$
    ActionFactory(//$NON-NLS-1$
    "addTask", IWorkbenchCommandConstants.EDIT_ADD_TASK) {
...
* This action is a {@link RetargetAction}. This action maintains its enablement state.
*/
    public static final ActionFactory BOOKMARK = new //$NON-NLS-1$
    ActionFactory(//$NON-NLS-1$
    "bookmark", IWorkbenchCommandConstants.EDIT_ADD_BOOKMARK) {
...
*/
    public static final ActionFactory BUILD = new //$NON-NLS-1$
    ActionFactory(//$NON-NLS-1$
    "build", IWorkbenchCommandConstants.PROJECT_BUILD_ALL) {
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            action.setImageDescriptor(IDEInternalWorkbenchImages.getImageDescriptor(IDEInternalWorkbenchImages.IMG_ETOOL_BUILD_EXEC));
            action.setDisabledImageDescriptor(IDEInternalWorkbenchImages.getImageDescriptor(IDEInternalWorkbenchImages.IMG_ETOOL_BUILD_EXEC_DISABLED));
            return action;
        }
    };
...
* @since 3.0
*/
    public static final ActionFactory BUILD_CLEAN = new ActionFactory(//$NON-NLS-1$
    "buildClean") {
...
* @since 3.0
*/
    public static final ActionFactory BUILD_AUTOMATICALLY = new //$NON-NLS-1$
    ActionFactory(//$NON-NLS-1$
    "buildAutomatically") {
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            action.setId(getId());
            //$NON-NLS-1$
            action.setActionDefinitionId("org.eclipse.ui.project.buildAutomatically");
            return action;
        }
    };
...
*/
    public static final ActionFactory BUILD_PROJECT = new ActionFactory(//$NON-NLS-1$
    ...
    IWorkbenchCommandConstants.PROJECT_BUILD_PROJECT) {
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            RetargetAction action = new RetargetActionWithDefault(getId(), IDEWorkbenchMessages.Workbench_buildProject);
...
*/
    public static final ActionFactory CLOSE_PROJECT = new //$NON-NLS-1$
    ActionFactory(//$NON-NLS-1$
    "closeProject", IWorkbenchCommandConstants.PROJECT_CLOSE_PROJECT) {
...
* @since 3.2
*/
    public static final ActionFactory CLOSE_UNRELATED_PROJECTS = new ActionFactory(//$NON-NLS-1$
    "closeUnrelatedProjects", //$NON-NLS-1$
    IWorkbenchCommandConstants.PROJECT_CLOSE_UNRELATED_PROJECTS) {
...
*/
    public static final ActionFactory OPEN_PROJECT = new ActionFactory(//$NON-NLS-1$
...
* This action maintains its enablement state.
*/
    public static final ActionFactory OPEN_WORKSPACE = new ActionFactory(//$NON-NLS-1$
    "openWorkspace") {
...
* This action maintains its enablement state.
*/
    public static final ActionFactory OPEN_PROJECT_PROPERTIES = new ActionFactory(//$NON-NLS-1$
    "projectProperties") {
...
*/
    @Deprecated
    public static final ActionFactory QUICK_START = new ActionFactory(//$NON-NLS-1$
    "quickStart") {
...
*/
    @Deprecated
    public static final ActionFactory REBUILD_ALL = new ActionFactory(//$NON-NLS-1$
    "rebuildAll") {
...
*/
    @Deprecated
    public static final ActionFactory REBUILD_PROJECT = new ActionFactory(//$NON-NLS-1$
    "rebuildProject") {
        ...
        public IWorkbenchAction create(IWorkbenchWindow window) {
            ...
            window.getPartService().addPartListener(action);
            action.setActionDefinitionId(//$NON-NLS-1$
            "org.eclipse.ui.project.rebuildProject");
            return action;
        }
    };
...
*/
    public static final ActionFactory TIPS_AND_TRICKS = new ActionFactory(//$NON-NLS-1$
    "tipsAndTricks", //$NON-NLS-1$
    IWorkbenchCommandConstants.HELP_TIPS_AND_TRICKS) {
