...
*/
    ...
    protected static int checkContribClasses(IContributionItem[] items, Class[] classes) {
        ...
        for (int i = 0; i < classes.length; i++) {
            ...
            if (!classes[i].isInstance(items[i]) && !(classes[i] == CommandContributionItem.class && HandledContributionItem.class.isInstance(items[i]))) {
                return i;
            }
        }
        return ALL_OK;
    ...
    protected static int checkMenuItemLabels(MenuItem[] menuItems, String[] expectedLabels) {
        // safety's sake...
