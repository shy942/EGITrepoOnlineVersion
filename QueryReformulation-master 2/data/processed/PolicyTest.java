...
public class PolicyTest extends TestCase {
    ...
    public void testDummyLog() {
        ...
        try {
            ...
            System.setErr(ps);
            IStatus status = new Status(IStatus.CANCEL, "somePluginId", "someMessage", new RuntimeException());
            ...
            assertTrue("expecting plugin id", message.indexOf("somePluginId") != -1);
            assertTrue("expecting message", message.indexOf("someMessage") != -1);
            assertTrue("expecting RuntimeException", message.indexOf("RuntimeException") != -1);
        } finally {
