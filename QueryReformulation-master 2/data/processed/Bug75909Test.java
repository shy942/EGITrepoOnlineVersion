...
*/
    public void testBasicFilter() throws Throwable {
        ...
        assertTrue("There should be more than 4 types in the system", num_types > 4);
...
*/
    public void testSaveState() throws Throwable {
        ...
        assertEquals(filter.getSelectedTypes().size(), f2.getSelectedTypes().size());
        assertFalse(f2.getSelectedTypes().contains(removed));
    }

    private void loadSettings(IDialogSettings settings, String resource) throws UnsupportedEncodingException, IOException {
        InputStream io = null;
        try {
