...
*/
    public static boolean asBoolean(String value) throws DataFormatException {
        ...
        throw new DataFormatException(//$NON-NLS-2$//$NON-NLS-1$
        "Value " + value + "doesn't represent a boolean");
    }
...
*/
    public static FontData asFontData(String value) throws DataFormatException {
        if (value == null) {
            throw new DataFormatException(//$NON-NLS-1$
            "Null doesn't represent a valid font data");
        }
        String name = null;
        int height = 0;
        int style = 0;
        try {
            ...
            if (heightIndex == -1) {
                throw new DataFormatException(//$NON-NLS-2$//$NON-NLS-1$
                "No correct font data format \"" + value + "\"");
            }
...
*/
    public static Point asPoint(String value) throws DataFormatException {
        if (value == null) {
            throw new DataFormatException(//$NON-NLS-1$
            "Null doesn't represent a valid point");
        }
        //$NON-NLS-1$
        StringTokenizer stok = new StringTokenizer(value, ",");
...
*/
    public static Rectangle asRectangle(String value) throws DataFormatException {
        if (value == null) {
            throw new DataFormatException(//$NON-NLS-1$
            "Null doesn't represent a valid rectangle");
        }
        //$NON-NLS-1$
        StringTokenizer stok = new StringTokenizer(value, ",");
        String x = stok.nextToken();
