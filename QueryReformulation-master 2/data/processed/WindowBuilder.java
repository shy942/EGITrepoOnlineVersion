...
public class WindowBuilder {
    ...
    private void createTrimBars(MPerspective perspective) {
        ...
        List<MUIElement> minimizedElements = modelService.findElements(perspective, null, MUIElement.class, Arrays.asList(IPresentationEngine.MINIMIZED));
    ...
    private void createTrim(MUIElement element, MPerspective perspective) {
        ...
        //$NON-NLS-1$
        String trimStr = perspective.getPersistedState().get("trims");
