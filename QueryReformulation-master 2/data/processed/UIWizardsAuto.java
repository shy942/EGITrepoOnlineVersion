...
*/
    ...
    public void testNewFolder() {
        ...
        WorkbenchHelp.setHelp(dialog.getShell(), IIDEHelpContextIds.NEW_FOLDER_WIZARD);
        DialogCheck.assertDialogTexts(dialog, this);
    }
    ...
    public void testNewProjectPage1() {
        ...
        dialog.getShell().setText("CreateFileAction_title");
        WorkbenchHelp.setHelp(dialog.getShell(), IIDEHelpContextIds.NEW_PROJECT_WIZARD);
        DialogCheck.assertDialogTexts(dialog, this);
    }
    ...
    public void testWizardWindowTitle() {
        ...
        //$NON-NLS-1$
        checkWizardWindowTitle("My New Wizard");
    }
