            ...
            if (TAG_NAVIGATOR_CONTENT.equals(element.getName())) {
                ...
                if (id != null) {
                    ...
                    if (contentDescriptor != null) {
                        ...
                        NavigatorPlugin.logError(0, NLS.bind(CommonNavigatorMessages.CommonSorterDescriptorManager_A_navigatorContent_extension_does_n_, new Object[] { id, element.getDeclaringExtension().getNamespaceIdentifier() }), null);
                    }
                } else {
                    NavigatorPlugin.logError(0, NLS.bind(CommonNavigatorMessages.CommonSorterDescriptorManager_A_navigatorContent_extension_in_0_, element.getNamespaceIdentifier()), null);
                }
            }
