...
*/
    ...
    public void testToTypeIsPrimitive() throws Exception {
        ...
        assertEquals("to type was not of the correct type", toType, doGetToPrimitiveValidator(Integer.class).getToType());
    ...
    public void testToTypeIsBoxedType() throws Exception {
        ...
        assertEquals(toType, doGetToBoxedTypeValidator(Integer.class).getToType());
        assertFalse(toType.isPrimitive());
    }

    public void testValidConversion() throws Exception {
        Integer value = Integer.valueOf(1);
        Number result = (Number) doGetToBoxedTypeValidator(Integer.class).convert(value);
