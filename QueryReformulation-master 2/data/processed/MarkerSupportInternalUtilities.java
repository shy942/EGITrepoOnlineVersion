...
*/
    ...
    static final CollationKey EMPTY_COLLATION_KEY = Collator.getInstance().getCollationKey(MarkerSupportInternalUtilities.EMPTY_STRING);
...
*/
    //$NON-NLS-1$
    public static final String IMG_MARKERS_HELP_DECORATION_PATH = "markers/help_small.png";

    /**
* The markers quick fix decoration.
*/
    //$NON-NLS-1$
    public static final String IMG_MARKERS_QUICK_FIX_DECORATION_PATH = "markers/contassist_ovr.png";
...
*/
    public static final String MIGRATE_BOOKMARK_FILTERS = IDEInternalPreferences.BOOKMARKS_FILTERS + MIGRATE_PREFERENCE_CONSTANT;

    /**
* Constant for the problem filters migration.
*/
    public static final String MIGRATE_PROBLEM_FILTERS = IDEInternalPreferences.PROBLEMS_FILTERS + MIGRATE_PREFERENCE_CONSTANT;

    /**
* Constant for the task filters migration.
*/
    public static final String MIGRATE_TASK_FILTERS = IDEInternalPreferences.TASKS_FILTERS + MIGRATE_PREFERENCE_CONSTANT;
...
*/
    public static void handleViewError(Exception exception, int handlingMethod) {
        if (exception instanceof CoreException) {
            ...
            if (status == null)
                StatusManager.getManager().handle(StatusUtil.newStatus(IStatus.ERROR, exception.getLocalizedMessage(), exception), handlingMethod);
            else
