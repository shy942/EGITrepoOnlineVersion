...
public class StyledTextThemedScrollBarAdapter extends AbstractThemedScrollBarAdapter {
    ...
    private  StyledTextThemedScrollBarAdapter(StyledText styledText, IScrollBarSettings scrollBarSettings) {
        super(styledText, new StyledTextHorizontalScrollHandler(styledText, scrollBarSettings), new StyledTextVerticalScrollHandler(styledText, scrollBarSettings), scrollBarSettings);
    ...
    protected IScrollBarPainter createPaintListener() {
        return new StyledTextPaintListener(fHorizontalScrollHandler, fVerticalScrollHandler, fScrollBarSettings, fInitialBottomMargin, fInitialRightMargin);
    }
...
*/
    abstract static class AbstractStyledTextScrollHandler extends AbstractScrollHandler implements ModifyListener, TextChangeListener {
...
*/
    static class StyledTextVerticalScrollHandler extends AbstractStyledTextScrollHandler {
        ...
        public void doPaintControl(GC gc, Rectangle currClientArea, Scrollable scrollable) {
            if (fHandleDrawnRect != null) {
                ...
                gc.fillRoundRectangle(fHandleDrawnRect.x, fHandleDrawnRect.y, fHandleDrawnRect.width, fHandleDrawnRect.height, borderRadius, borderRadius);
    ...
    static class StyledTextHorizontalScrollHandler extends AbstractStyledTextScrollHandler {
        ...
        public boolean computePositions(Rectangle currClientArea, Scrollable scrollable) {
            ...
            int h = currClientArea.height;
            fScrollBarPositions = new ScrollBarPositions.ScrollBarPositionsHorizontal(this.fScrollBar.getMinimum(), this.fScrollBar.getMaximum(), styledText.getHorizontalPixel(), h, w);
            fHandleDrawnRect = fScrollBarPositions.getHandleDrawRect(lineWidth);
    ...
    public static class StyledTextPaintListener implements IScrollBarPainter {
        ...
        public void paintControl(PaintEvent e) {
            ...
            try {
                ...
                if (fCurrClientArea == null || fCurrClientArea.width < fVerticalScrollHandler.getMouseNearScrollScrollBarWidth() || fCurrClientArea.height < fHorizontalScrollHandler.getMouseNearScrollScrollBarWidth()) {
                    return;
                }
        ...
        private boolean fixMargins(boolean drawHorizontal, boolean drawVertical) {
            ...
            if (fStyledText.getRightMargin() != rightMargin || fStyledText.getBottomMargin() != bottomMargin) {
                ...
                Display.getDefault().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        if (fStyledText != null && !fStyledText.isDisposed()) {
                            fStyledText.setMargins(fStyledText.getLeftMargin(), fStyledText.getTopMargin(), applyRightMargin, applyBottomMargin);
                        }
                    }
                });
                return true;
