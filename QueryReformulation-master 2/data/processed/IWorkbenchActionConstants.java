...
*/
    @Deprecated
    public static final String //$NON-NLS-1$
    M_WORKBENCH = MENU_PREFIX + "workbench";
...
*/
    //$NON-NLS-1$
    public static final String M_PERSPECTIVE = MENU_PREFIX + "perspective";

    /**
* Name of standard Navigate menu (value <code>"navigate"</code>).
*/
    //$NON-NLS-1$
    public static final String M_NAVIGATE = MENU_PREFIX + "navigate";

    /**
* Name of standard Project menu (value <code>"project"</code>).
*/
    //$NON-NLS-1$
    public static final String M_PROJECT = MENU_PREFIX + "project";
...
*/
    @Deprecated
    public static final String // Global action. //$NON-NLS-1$
    PRINT = "print";
...
*/
    // Group.
    public static final String VIEW_EXT = MB_ADDITIONS;
...
*/
    // Group.
    public static final String WINDOW_EXT = MB_ADDITIONS;
...
*/
    // Group.
    public static final String LAUNCH_EXT = MB_ADDITIONS;
...
*/
    // Group. //$NON-NLS-1$
    public static final String PERSPECTIVE_START = "perspectiveStart";
...
*/
    // Group. //$NON-NLS-1$
    public static final String PERSPECTIVE_END = "perspectiveStartEnd";
...
*/
    @Deprecated
    public static final String // Global action. //$NON-NLS-1$
    REBUILD_PROJECT = "rebuildProject";
