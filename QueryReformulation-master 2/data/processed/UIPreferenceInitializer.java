...
public class UIPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        node.put(IWorkbenchPreferenceConstants.PROJECT_OPEN_NEW_PERSPECTIVE, IWorkbenchPreferenceConstants.OPEN_PERSPECTIVE_REPLACE);
        ...
        node.putBoolean(IWorkbenchPreferenceConstants.SHOW_TEXT_ON_PERSPECTIVE_BAR, false);
...
*/
    private void migrateInternalPreferences() {
        ...
        if (internalStore.contains(IWorkbenchPreferenceConstants.VIEW_TAB_POSITION)) {
            apiStore.setValue(IWorkbenchPreferenceConstants.VIEW_TAB_POSITION, internalStore.getInt(IWorkbenchPreferenceConstants.VIEW_TAB_POSITION));
        ...
        if (internalStore.contains(IWorkbenchPreferenceConstants.EDITOR_TAB_POSITION)) {
            apiStore.setValue(IWorkbenchPreferenceConstants.EDITOR_TAB_POSITION, internalStore.getInt(IWorkbenchPreferenceConstants.EDITOR_TAB_POSITION));
        ...
        if (internalStore.contains(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS)) {
            apiStore.setValue(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS, internalStore.getBoolean(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS));
