...
*/
    ...
    public void testBasicContribution() throws Exception {
        ...
        final Expression activeContextExpr = new ActiveContextExpression(MenuContributionHarness.CONTEXT_TEST1_ID, new String[] { ISources.ACTIVE_CONTEXT_NAME });
        ...
        for (IConfigurationElement ma : mas) {
            ...
            for (IConfigurationElement item : items) {
                ...
                if (id != null && id.equals("org.eclipse.ui.tests.menus.itemX1")) {
                    ...
                    activeContextExpr[0] = ExpressionConverter.getDefault().perform(visibleWhenElement.getChildren()[0]);
                }
            }
        }
    ...
    public void testVisibilityTracksEnablement() throws Exception {
        final MenuManager manager = new MenuManager();
        final CommandContributionItemParameter parm = new CommandContributionItemParameter(window, null, COMMAND_ID, Collections.EMPTY_MAP, null, null, null, null, null, null, CommandContributionItem.STYLE_PUSH, null, true);
