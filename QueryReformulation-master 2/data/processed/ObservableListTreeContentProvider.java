    ...
    private static class Impl extends ObservableCollectionTreeContentProvider {
        ...
        private class ListChangeListener implements IListChangeListener {
            ...
            public void handleListChange(ListChangeEvent event) {
                ...
                final Set localKnownElementAdditions = ViewerElementSet.withComparer(comparer);
                final Set localKnownElementRemovals = ViewerElementSet.withComparer(comparer);
                ...
                Set knownElementAdditions = ViewerElementSet.withComparer(comparer);
                ...
                for (Iterator it = localKnownElementAdditions.iterator(); it.hasNext(); ) {
                ...
                for (Iterator it = localKnownElementRemovals.iterator(); it.hasNext(); ) {
