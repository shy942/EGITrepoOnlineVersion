...
public class GenTopic implements IApplication {
    ...
    private void processLiterals(Class<?> literals) throws IllegalArgumentException, IllegalAccessException {
    ...
    private void processEClass(EClass eClass) {
        ...
        System.out.print(String.format(deprecatedTopicDeclaration, pkgName, className));
        System.out.print(String.format(topicAllDeclaration, pkgName, className));
        Set<String> names = new TreeSet<String>();
        for (EStructuralFeature feature : features) {
            names.add(feature.getName());
        }
        for (String name : names) {
            System.out.print(String.format(topicAttributeDeclaration, name, pkgName, className, name));
        }
        //$NON-NLS-1$
        System.out.print("\n");
