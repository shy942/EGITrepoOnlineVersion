...
public class BundleActivatorImpl implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        themeListenerRegistration = context.registerService(EventHandler.class, themeListener, properties);
    }
    ...
    private void themeChanged(Event event) {
        ...
        System.out.println("  Theme: " + event.getProperty(IThemeEngine.Events.THEME));
        System.out.println("  Theme Engine: " + event.getProperty(IThemeEngine.Events.THEME_ENGINE));
        System.out.println("  Device: " + event.getProperty(IThemeEngine.Events.DEVICE));
    }
}
