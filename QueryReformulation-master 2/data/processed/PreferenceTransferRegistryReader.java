        ...
        for (int i = 0; i < entries.length; i++) {
            ...
            if (keys.length > 0) {
                ...
                for (int j = 0; j < keys.length; j++) {
                    ...
                    prefFilters[j] = new PreferenceFilterEntry(keyElement.getAttribute(IWorkbenchRegistryConstants.ATT_NAME), keyElement.getAttribute(IWorkbenchRegistryConstants.ATT_MATCH_TYPE));
                }
            }
