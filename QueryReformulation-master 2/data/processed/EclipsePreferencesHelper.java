...
public class EclipsePreferencesHelper {
    ...
    public static void appendOverriddenPropertyName(IEclipsePreferences preferences, String name) {
        ...
        if (value.equals(SEPARATOR)) {
            preferences.addPreferenceChangeListener(getPreferenceChangeListener());
        }
    ...
    public static void removeOverriddenPropertyNames(IEclipsePreferences preferences) {
        ...
        preferences.removePreferenceChangeListener(getPreferenceChangeListener());
    }
    ...
    public static class PreferenceOverriddenByCssChangeListener implements IPreferenceChangeListener {
        ...
        private boolean isRelatedToOverriddenByCss(PreferenceChangeEvent event) {
            return isOverriddenByCSS(event.getNode().get(PROPS_OVERRIDDEN_BY_CSS_PROP, SEPARATOR), event.getKey());
        }
