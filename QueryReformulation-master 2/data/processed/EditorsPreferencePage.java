...
public class EditorsPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void setHelpContext(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, IWorkbenchHelpContextIds.WORKBENCH_EDITOR_PREFERENCE_PAGE);
    }
    ...
    protected void createShowMultipleEditorTabsPref(Composite composite) {
        ...
        showMultipleEditorTabs.setSelection(getAPIPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS));
    ...
    protected void createAllowInplaceEditorPref(Composite composite) {
        ...
        allowInplaceEditor.setSelection(!getAPIPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.DISABLE_OPEN_EDITOR_IN_PLACE));
    ...
    protected void createUseIPersistablePref(Composite composite) {
        ...
        useIPersistableEditor.setSelection(getPreferenceStore().getBoolean(IPreferenceConstants.USE_IPERSISTABLE_EDITORS));
    ...
    protected void createPromptWhenStillOpenPref(Composite composite) {
        ...
        promptWhenStillOpenEditor.setSelection(getAPIPreferenceStore().getBoolean(IWorkbenchPreferenceConstants.PROMPT_WHEN_SAVEABLE_STILL_OPEN));
    ...
    protected void performDefaults() {
        ...
        showMultipleEditorTabs.setSelection(getAPIPreferenceStore().getDefaultBoolean(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS));
        allowInplaceEditor.setSelection(!getAPIPreferenceStore().getDefaultBoolean(IWorkbenchPreferenceConstants.DISABLE_OPEN_EDITOR_IN_PLACE));
        useIPersistableEditor.setSelection(store.getDefaultBoolean(IPreferenceConstants.USE_IPERSISTABLE_EDITORS));
        promptWhenStillOpenEditor.setSelection(getAPIPreferenceStore().getDefaultBoolean(IWorkbenchPreferenceConstants.PROMPT_WHEN_SAVEABLE_STILL_OPEN));
    ...
    public boolean performOk() {
        IPreferenceStore store = getPreferenceStore();
        getAPIPreferenceStore().setValue(IWorkbenchPreferenceConstants.SHOW_MULTIPLE_EDITOR_TABS, showMultipleEditorTabs.getSelection());
        getAPIPreferenceStore().setValue(IWorkbenchPreferenceConstants.DISABLE_OPEN_EDITOR_IN_PLACE, !allowInplaceEditor.getSelection());
        store.setValue(IPreferenceConstants.USE_IPERSISTABLE_EDITORS, useIPersistableEditor.getSelection());
        getAPIPreferenceStore().setValue(IWorkbenchPreferenceConstants.PROMPT_WHEN_SAVEABLE_STILL_OPEN, promptWhenStillOpenEditor.getSelection());
...
*/
    protected void createEditorReuseGroup(Composite composite) {
        ...
        reuseEditorsThreshold = new IntegerFieldEditor(IPreferenceConstants.REUSE_EDITORS, WorkbenchMessages.WorkbenchPreference_reuseEditorsThreshold, editorReuseThresholdGroup);
...
*/
    protected void createEditorHistoryGroup(Composite composite) {
        ...
        recentFilesEditor = new IntegerFieldEditor(IPreferenceConstants.RECENT_FILES, WorkbenchMessages.WorkbenchPreference_recentFiles, groupComposite);
        ...
        recentFilesEditor.setErrorMessage(NLS.bind(WorkbenchMessages.WorkbenchPreference_recentFilesError, Integer.valueOf(EditorHistory.MAX_SIZE)));
