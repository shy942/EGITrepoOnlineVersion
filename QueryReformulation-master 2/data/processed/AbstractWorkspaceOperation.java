...
*/
    ...
    public IStatus computeExecutionStatus(IProgressMonitor monitor) {
        ...
        if (updateResourceChangeDescriptionFactory(factory, EXECUTE)) {
            boolean proceed = IDE.promptToConfirm(getShell(null), UndoMessages.AbstractWorkspaceOperation_SideEffectsWarningTitle, NLS.bind(UndoMessages.AbstractWorkspaceOperation_ExecuteSideEffectsWarningMessage, getLabel()), factory.getDelta(), modelProviderIds, true);
            if (!proceed) {
...
*/
    ...
    public IStatus computeUndoableStatus(IProgressMonitor monitor) {
        ...
        if (updateResourceChangeDescriptionFactory(factory, UNDO)) {
            boolean proceed = IDE.promptToConfirm(getShell(null), UndoMessages.AbstractWorkspaceOperation_SideEffectsWarningTitle, NLS.bind(UndoMessages.AbstractWorkspaceOperation_UndoSideEffectsWarningMessage, getLabel()), factory.getDelta(), modelProviderIds, true);
            if (!proceed) {
                status = Status.CANCEL_STATUS;
            }
        }
...
*/
    ...
    public IStatus computeRedoableStatus(IProgressMonitor monitor) {
        ...
        if (updateResourceChangeDescriptionFactory(factory, REDO)) {
            boolean proceed = IDE.promptToConfirm(getShell(null), UndoMessages.AbstractWorkspaceOperation_SideEffectsWarningTitle, NLS.bind(UndoMessages.AbstractWorkspaceOperation_RedoSideEffectsWarningMessage, getLabel()), factory.getDelta(), modelProviderIds, true);
            if (!proceed) {
                status = Status.CANCEL_STATUS;
            }
        }
...
*/
    protected IStatus getErrorStatus(String message) {
        ...
        if (statusMessage == null) {
            statusMessage = NLS.bind(UndoMessages.AbstractWorkspaceOperation_ErrorInvalidMessage, getLabel());
        }
        return new Status(IStatus.ERROR, IDEWorkbenchPlugin.IDE_WORKBENCH, OperationStatus.OPERATION_INVALID, statusMessage, null);
    }
...
*/
    protected IStatus getWarningStatus(String message, int code) {
        String statusMessage = message;
        if (statusMessage == null) {
            statusMessage = NLS.bind(UndoMessages.AbstractWorkspaceOperation_GenericWarningMessage, getLabel());
        }
        return new Status(IStatus.WARNING, IDEWorkbenchPlugin.IDE_WORKBENCH, code, statusMessage, null);
    }
