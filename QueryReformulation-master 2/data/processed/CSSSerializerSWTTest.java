...
public class CSSSerializerSWTTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("***************** CSS SWT Selector *****************");
            CSSSerializer serializer = new CSSSerializer();
            StringWriter writer = new StringWriter();
            serializer.serialize(writer, engine, shell, true, CSSSWTSerializerConfiguration.INSTANCE);
            System.out.println(writer.toString());
            // HTML Selector
            engine = new CSSSWTHTMLEngineImpl(display);
            System.out.println("***************** CSS SWT-HTML Selector *****************");
            writer = new StringWriter();
            serializer.serialize(writer, engine, shell, true, CSSHTMLSerializerConfiguration.INSTANCE);
            System.out.println(writer.toString());
            shell.pack();
            shell.open();
