...
*/
    public  EvaluationValueReference(T referrent, EvaluationReference<?> key, ReferenceQueue<? super T> queue) {
...
*/
    ...
    public String toString() {
        Object myRef = get();
        //$NON-NLS-1$ //$NON-NLS-2$
        return "EvaluationValueReference[" + (myRef == null ? "(collected)" : toStringArrayAware(myRef)) + ']';
    }
}
